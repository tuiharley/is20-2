          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td valign="top"><table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="3" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>บริษัทฯในเครือ</strong></font></div></td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      ...
                      <td width="10%"> <div align="center"> 
                          <input name="Edit" type="button" id="Edit" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','100px','300px','sub_custmain_edit2.asp?cgcode=<%=RsS("CG_CODE")%>&scid=<%=RsS("SCID")%>');">
                    ...
                    <tr> 
                      <td colspan="3" valign="top"><div align="right"> 
                          <input name="add" type="button" id="add" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','100px','300px','sub_custmain_add2.asp?cgcode=<%=Rs("CG_CODE")%>');">
                        </div></td>
                    </tr>
                  </table></td>
              </tr>
