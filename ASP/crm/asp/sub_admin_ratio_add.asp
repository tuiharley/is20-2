...
<form name="form1" method="post" action="">
  <table width="300" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="80%">&nbsp;&nbsp;<input name="rationame" type="text" class="text" id="rationame" size="30" maxlength="50"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		{
		top.RunWindow('Temp1','add_ratio_name.asp?rationame=' + document.form1.rationame.value+'');
