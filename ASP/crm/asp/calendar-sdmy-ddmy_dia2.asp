      ...
      <td><table width="250" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <td colspan="17"><div align="center"> 
                <select name="month" id="month" onchange="top.RunWindow('Dialog2','calendar-sdmy-ddmy_dia2.asp?input1=<%=input1%>&input2=<%=input2%>&dmonth='+document.form1.month.value+'&dyear='+document.form1.year.value)">
                ...
                <select name="year" id="year" onchange="top.RunWindow('Dialog2','calendar-sdmy-ddmy_dia2.asp?input1=<%=input1%>&input2=<%=input2%>&dmonth='+document.form1.month.value+'&dyear='+document.form1.year.value)">
<%
	Dim i
	i=year(Date)+5
	do while i >= 2535-543
...
%>
  ...
  <script language=javascript>
	...
	function doclick(ddate1, ddate2){
		...
		<%=input1%>.value=ddate1;
		<%=input2%>.value= newdate.getDate()+'  '+m[newdate.getMonth()]+'  '+(parseInt(ddate2.substr(ddate2.length-4,4))+543);
