...
%>
<%
	Dim iname, side, post,  Rs, Sql, cgcode, maxempid, maxid, sur, decide, tel, fax, mail
...
%>
	<script language=javascript>
		top.Desktop2.document.form1.empname.value='<%=maxempid%>';
		top.Desktop2.document.form1.check.onchange();
	</script>
</BODY>
</HTML>