  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="10%">&nbsp;</td>
            <td><b><font color="#4B0097" size="4" face="JasmineUPC">เพิ่มรหัสลูกค้า</font></b></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td><table width="69%" height="36" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" id="AutoNumber21" style="border-collapse: collapse">
          <tr> 
...
<script language="JavaScript">
	function dosend(){
		...
		if(confirm('ยืนยันการบันทึกข้อมูล')){
			...
			top.RunWindow('Temp1','temp_save_maincomp_add.asp');
		}
	}
</script>
</body>
