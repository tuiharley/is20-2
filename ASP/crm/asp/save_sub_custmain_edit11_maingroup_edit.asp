...
%>
<%
	Dim cus_id, cbus, cmcode, cgname, prov, band, home, soi, street, tumbol, dis, provname, postcode, maxnumber, cgid, cgcode, oldiframe, iframe
...
<script language=javascript>
	...
	top.RunWindow('<%=oldiframe%>','sub_custmain_edit11.asp?cus_id=<%=cus_id%>&cbus=<%=cbus%>&cmcode=<%=cmcode%>&cgcode=<%=cgcode%>');
