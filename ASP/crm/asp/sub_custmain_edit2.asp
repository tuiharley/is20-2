...
<%
			...
			SQL = "SELECT COMP_NAME FROM SUB_COMPANY WHERE (CG_CODE = '" & cgcode &"') AND (SCID = " & scid &") "
...
<form name="form1" method="post" action="">
  <table width="300" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="80%">&nbsp;&nbsp;
        <input name="compname" type="text" class="text" id="compname" value="<%=Rs("COMP_NAME")%>" size="30" maxlength="50">
...
<script language="JavaScript">
	function dosend () {
		...
		top.RunWindow('Temp1','temp_save_sub_custmain_edit2.asp');
