...
%>	
    ...
    <tr> 
      ...
      <td width="80%">&nbsp;&nbsp;<input name="showsdate" type="text" class="text" id="showsdate" size="18" readonly value="<%=left(FormatDateTime(Rs("SDATE"),1),len(FormatDateTime(Rs("SDATE"),1))-4)&right(FormatDateTime(Rs("SDATE"),1),4)+543%>">
      </td>
    </tr>
    <tr> 
      <td colspan="2" height="15"><img src="../images/blank.gif" width="1" height="1"></td>
...
function dosend(){
	if(confirm('ยืนยันการลบข้อมูล')){
		top.RunWindow('Temp1','temp_save_sub_custmain_delete10_cust.asp');
	}
}
</script>
</body>
