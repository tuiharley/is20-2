...
<form name="form1" method="post" action="">
  <table width="300" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="20%"><div align="right"><font color="#4B0097" size="2"><strong>ชื่อบริการ</strong></font></div></td>
      <td width="80%">&nbsp;&nbsp;<input name="servicename" type="text" class="text" id="servicename" size="30" maxlength="50"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		if(document.form1.servicename.value==""){
			alert('กรุณาใส่ชื่อบริการ');
			document.form1.servicename.focus();
			return;
		}
		if(confirm('ยืนยันการบันทึกข้อมูล'))
		{
		top.RunWindow('Temp1','add_service_name.asp?servicename=' + document.form1.servicename.value + '&opt=<%=opt%>');
