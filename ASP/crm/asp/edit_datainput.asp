...
<form name="form1" method="post" action="">
  <table width="363" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td colspan="2" height="15"><img src="../images/blank.gif" width="1" height="1"></td>
    </tr>
    <tr> 
      <td width="37%"><div align="right"><font color="#4B0097" size="2"><strong>แหล่งที่มาของข้อมูล</strong></font></div></td>
      <td width="63%">&nbsp;&nbsp;<input name="dataioname" type="text" class="text" id="dataioname" size="30" maxlength="50" value="<%=DINAME%>"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		{
		top.RunWindow('Temp1','edit_datainput_name.asp?DINAME=' + document.form1.dataioname.value + '&DIID=<%=DIID%>');
