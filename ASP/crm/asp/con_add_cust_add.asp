...
<form name="form1" method="post" action="">
  <table width="350" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td colspan="2" height="15"><p><img src="../images/blank.gif" width="1" height="1"> 
          <input name="cgcode" type="hidden" id="cgcode" value="<%=cgcode%>">
          <input name="empid" type="hidden" id="empid" value="<%=empid%>">
		  <input name="cust_no" type="hidden" value="<%=cust_no%>">
        </td>
    </tr>
    <tr> 
...
function dosend(){
	...
	if(confirm('ยืนยันการบันทึกข้อมูล')){
		top.RunWindow('Temp1','temp_save_con_add_cust_add.asp');
