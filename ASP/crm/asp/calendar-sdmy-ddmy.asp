      ...
      <td><table width="250" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <td colspan="17"><div align="center"> 
                <select name="month" id="month" onchange="top.RunWindow('Dialog1','calendar-sdmy-ddmy.asp?input1=<%=input1%>&input2=<%=input2%>&dmonth='+document.form1.month.value+'&dyear='+document.form1.year.value)">
                ...
                <select name="year" id="year" onchange="top.RunWindow('Dialog1','calendar-sdmy-ddmy.asp?input1=<%=input1%>&input2=<%=input2%>&dmonth='+document.form1.month.value+'&dyear='+document.form1.year.value)">
<%
	Dim i
	i=year(Date)+5
	do while i >= 2535-543
