...
%>
<%
	Dim selectdate, app_id, opendate1, h1, m1, opendate2, h2, m2, app_obj, app_count, remark, oid, i, emp1, emp2
...
<script language=javascript>
	...
	top.Desktop1.document.form2.submit();
	top.RunWindow('Desktop2','appoint2.asp?cgcode=<%=cgcode%>&selectdate=<%=selectdate%>');
