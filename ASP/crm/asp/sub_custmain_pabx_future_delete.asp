...
%>
<%
	Dim cgcode, pabxid, dateef, showdate
...
%>
    ...
    <tr> 
      ...
      <td>&nbsp; <input name="textfield2" type="text" class="text" value="<%=Rs2("SPEC")%>" size="30" readonly=""></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font color="#4B0097" size="2">จำนวนเลขหมาย</font></strong></font></div></td>
      <td>&nbsp;&nbsp;<input name="num" type="text" class="text" id="num2" onChange="Calaverage();" onkeyPress="if(window.event.keyCode==13){document.form1.total.focus();}" value="<%=Rs2("LINEIN")%>" size="10" maxlength="10" readonly=""></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font color="#4B0097" size="2">รายได้รวม</font></strong></font></div></td>
      <td>&nbsp;&nbsp;<input name="total" type="text" class="text" id="total2" onChange="Calaverage();" onkeyPress="if(window.event.keyCode==13){document.form1.send.focus();}" value="<%=Rs2("LINEOUT")%>" size="10" maxlength="10" readonly=""></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097" size="2"><strong>ภายในวันที่</strong></font><font color="#4B0097"><strong></strong></font></div></td>
      <td>&nbsp;&nbsp;<input name="showdate" type="text" class="text" id="showdate" size="18" readonly value="<%=left(FormatDateTime(Rs2("DATEEF"),1),len(FormatDateTime(Rs2("DATEEF"),1))-4)&right(FormatDateTime(Rs2("DATEEF"),1),4)+543%>">
      </td>
    </tr>
    <tr> 
      <td colspan="2" height="15"><img src="../images/blank.gif" width="1" height="1"></td>
...
function dosend(){
	if(confirm('ยืนยันการลบข้อมูล')){
		top.RunWindow('Temp1','temp_save_sub_custmain_pabx_future_delete.asp');
	}
}
</script>
</body>
