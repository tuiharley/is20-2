              ...
              <tr> 
                ...
                <td valign="top"><table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    ...
                    <tr> 
                      ...
                      <td width="16%"><div align="center"><strong><font color="#4B0097" size="2">เลขที่ผู้เช่า</font></strong></div></td>
...
%>
                    <tr> 
                      ...
                      <td> <div align="center"> 
                          <input name="Delete" type="button" id="Delete" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','160px','400px','sub_custmain_delete11.asp?cgcode=<%=cgcode%>&customer_id=<%=Rs("CUSTOMER_ID")%>');" <%if Cint(Session("User_Level"))<>Cint(4) and Cint(Session("User_Area"))<>Cint(Session("Temp")) then%>disabled<%end if%>>
                          <input type="button" name="Button" value="เปลี่ยน" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','300px','600px','sub_custmain_edit11.asp?cgcode=<%=cgcode%>&cus_id=<%=Rs("CUSTOMER_ID")%>&iframe='+self.name);" <%if Cint(Session("User_Level"))<>Cint(4) and Cint(Session("User_Area"))<>Cint(Session("Temp")) then%>disabled<%end if%>>
                        </div></td>
                    </tr>
<%
		i=i+1
