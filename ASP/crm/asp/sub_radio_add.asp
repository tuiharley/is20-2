...
<form name="form1" method="post" action="">
  <table width="321" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="26%"><div align="right"><font color="#4B0097" size="2"><strong>รายการวิทยุ</strong></font></div></td>
      <td width="74%">&nbsp;&nbsp;<input name="radioname" type="text" class="text" id="radioname" size="30" maxlength="50"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		{
		top.RunWindow('Temp1','add_radio_name.asp?radioname=' + document.form1.radioname.value+'');
