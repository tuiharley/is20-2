...
<%Rs.Close%>
              <tr> 
                ...
                <td valign="top"><table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="6" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>ปัญหาสาเหตุเกิดจาก 
                          TT&amp;T</strong></font></div></td>
                    </tr>
                    <tr> 
                      <td width="5%"><div align="center"><strong><font color="#4B0097" size="2">ลำดับ</font></strong></div></td>
                      <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">ปัญหาที่เกิด</font></strong></div></td>
                      <td width="20%"><div align="center"><strong><font color="#4B0097" size="2">วันที่เกิดปัญหา</font></strong></div></td>
                      <td width="20%"><div align="center"><strong><font color="#4B0097" size="2">การแก้ไข</font></strong></div></td>
                      <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">วันที่แก้ไขปัญหาเสร็จ</font></strong></div></td>
                      <td width="10%">&nbsp;</td>
					</tr>
<%
	i=1
...
%>
                    <tr> 
                      ...
                      <td> <div align="center">
                          <input name="Edit" type="button" id="Edit" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','160px','450px','sub_custmain_edit10_ttt.asp?cgcode=<%=cgcode%>&prob_id=<%=Rs("PROB_ID")%>');">
...
%>
                    <tr> 
                      <td colspan="6" valign="top"><div align="right"> 
                          <input name="add" type="button" id="add" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','160px','450px','sub_custmain_add10_ttt.asp?cgcode=<%=cgcode%>');">
                        </div></td>
                    </tr>
				</table>
				  <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="6" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>ปัญหาสาเหตุเกิดจากลูกค้า</strong></font></div></td>
                    </tr>
                    <tr> 
                      <td width="5%"><div align="center"><strong><font color="#4B0097" size="2">ลำดับ</font></strong></div></td>
                      <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">ปัญหาที่เกิด</font></strong></div></td>
...
%>
             <tr> 
                      ...
                      <td> <div align="center">
                          <input name="Edit2" type="button" id="Edit2" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','160px','450px','sub_custmain_edit10_cust.asp?cgcode=<%=cgcode%>&prob_id=<%=Rs("PROB_ID")%>');">
...
%>
                    <tr> 
                      <td colspan="6" valign="top"><div align="right"> 
                          <input name="add" type="button" id="add" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','160px','450px','sub_custmain_add10_cust.asp?cgcode=<%=cgcode%>');">
                        </div></td>
                    </tr>
				</table>
