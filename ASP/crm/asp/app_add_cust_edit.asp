...
<form name="form1" method="post" action="">
  <table width="350" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="65%">&nbsp;&nbsp;
        <input name="name" type="text" class="text" id="name" value="<%=Rs("EMP_NAME")%>" size="30" maxlength="50"> 
        <input name="cgcode" type="hidden" id="cgcode" value="<%=cgcode%>"> <input name="empid" type="hidden" id="empid" value="<%=empid%>"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097" size="2"><strong>นามสกุล</strong></font></div></td>
      <td>&nbsp;&nbsp;
        <input name="sur" type="text" class="text" id="sur" value="<%=Rs("EMP_SUR")%>" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097" size="2"><strong>หน่วยงาน</strong></font></div></td>
      <td>&nbsp;&nbsp;
        <input name="side" type="text" class="text" id="side" value="<%=Rs("EMP_SIDE")%>" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font size="2">ตำแหน่ง</font></strong></font></div></td>
      <td>&nbsp;&nbsp;
        <input name="post" type="text" class="text" id="post" value="<%=Rs("EMP_POS")%>" size="30" maxlength="50"></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td>&nbsp;&nbsp;
        <input name="tel" type="text" class="text" id="tel" value="<%=Rs("EMP_TEL")%>" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font size="2">fax</font></strong></font></div></td>
      <td>&nbsp;&nbsp;
        <input name="fax" type="text" class="text" id="fax" value="<%=Rs("EMP_FAX")%>" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font size="2">e-mail</font></strong></font></div></td>
      <td>&nbsp;&nbsp;
        <input name="mail" type="text" class="text" id="mail" value="<%=Rs("EMP_MAIL")%>" size="30" maxlength="50"></td>
    </tr>
    <tr> 
...
<script language="JavaScript">
	...
	if(confirm('ยืนยันการบันทึกข้อมูล')){
		top.RunWindow('Temp1','temp_save_app_add_cust_edit.asp');
