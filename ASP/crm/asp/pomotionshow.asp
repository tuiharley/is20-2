...
<%
	Dim pomoid
	pomoid = Request.QueryString("pomoid")
%>
<form name="form1" method="post" action="">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="1" colspan="5" bgcolor="#FFFFFF"><img src="../images/blank.gif" width="1" height="1"></td>
    </tr>
    <tr> 
      <td width="1" bgcolor="#FFFFFF"><img src="../images/blank.gif" width="1" height="1"></td>
      <td width="50%"><div align="center"><font color="#4B0097"><strong><font size="2">ชื่อโปรโมชั่น</font></strong></font></div></td>
      <td width="1" bgcolor="#FFFFFF"><img src="../images/blank.gif" width="1" height="1"></td>
      <td width="50%"><div align="center"><font color="#4B0097"><strong><font size="2">รายละเอียดโปรโมชั่น</font></strong></font></div></td>
      <td width="1" bgcolor="#FFFFFF"><img src="../images/blank.gif" width="1" height="1"></td>
    </tr>
    <tr> 
      <td height="1" colspan="5" bgcolor="#FFFFFF"><img src="../images/blank.gif" width="1" height="1"></td>
    ...
    <%
	Sql = "SELECT POMOID, POMONAME FROM POMOTION WHERE (POMOID = " & pomoid & ") "
...
%>
    <tr> 
      <td height="1" colspan="5"> <div align="center"> 
