          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td> <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="6" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>สินค้าและบริการของลูกค้าในอนาคต 
                    ...
                    <td width="12%"><div align="center"><strong><font color="#4B0097" size="2">ภายในวันที่</font></strong></div></td>
                    <%
	i=1
...
%>
                  ...
                  <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    ...
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ผู้ให้บริการ</font></strong></div></td>
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ประเภทบริการ</font></strong></div></td>
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ความเร็ว</font></strong></div></td>
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">โปรโมชั่น</font></strong></div></td>
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">จำนวน</font></strong></div></td>
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ภายในวันที่</font></strong></div></td>
                    <%
	i=1
...
%>
                    <tr> 
                      <td colspan="8" valign="top"><div align="right"> </div></td>
                    </tr>
                  </table>
                  <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
...
%>
                    <tr> 
                      <td colspan="7" valign="top"><div align="right"> </div></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
