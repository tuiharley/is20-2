...
<form name="form1" method="post" action="">
 ...
 %>
          <tr> 
            ...
            <td ><input name="search" type="button" id="search" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.RunWindow('Temp1','delete_search_specialist1.asp?app_id=<%=app_id%>&cgcode=<%=cgcode%>&empcode=<%=Rs("empcode")%>&empcodetmp=<%=empcode%>' ); "></td>
          </tr>
<%
		  		Rs.Movenext
		  loop
