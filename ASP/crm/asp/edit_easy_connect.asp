...
<%
	...
	dim ECNAME , ECID
	ECNAME = Request.QueryString("ECNAME")
	ECID = Request.QueryString("ECID")
	%>
<form name="form1" method="post" action="">
  <table width="349" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td colspan="2" height="15"><img src="../images/blank.gif" width="1" height="1"></td>
    </tr>
    <tr> 
      <td width="35%"><div align="right"><font color="#4B0097" size="2"><strong>วิธีการติดต่อที่สะดวก</strong></font></div></td>
      <td width="65%">&nbsp;&nbsp;<input name="easyname" type="text" class="text" id="easyname" size="30" maxlength="50" value="<%=ECNAME%>"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		{
		top.RunWindow('Temp1','edit_easy_connect_name.asp?ECNAME=' + document.form1.easyname.value + '&ECID=<%=ECID%>');
