...
<%
	...
	Sql = "SELECT APPOINT.APP_EMPAPP, MONTH(APPOINT.APP_DATECT) AS Month, COUNT(APPOINT.APP_DATECT) AS No FROM  APPOINT INNER JOIN EMPLOYEE ON APPOINT.APP_EMPAPP = EMPLOYEE.EMP_ID INNER JOIN PROVINCE ON EMPLOYEE.WORKING_PROVINCE = PROVINCE.P_LOC WHERE (PROVINCE.AREA = '" & Session("User_Area") & "') GROUP BY MONTH(APPOINT.APP_DATECT), APPOINT.APP_EMPAPP"
			...
			if not  Rs.Eof and not Isnull(Rs("APP_EMPAPP")) then
...
%>			
			...
			' Sql = " SELECT TITLE_THAI, NAME_THAI, SURNAME_THAI  FROM  EMPLOYEE WHERE (EMP_ID = '" & Rs("APP_EMPAPP") & "')"
			 Sql = " SELECT EMPLOYEE.TITLE_THAI, EMPLOYEE.NAME_THAI, EMPLOYEE.SURNAME_THAI, PROVINCE.PROVINCE FROM  EMPLOYEE INNER JOIN PROVINCE ON EMPLOYEE.WORKING_PROVINCE = PROVINCE.P_LOC WHERE (EMPLOYEE.EMP_ID = '" & Rs("APP_EMPAPP") & "')"
			 ...
			 %>  
              ...
              <td><div align="left"><font color="#4B0097" size="1"><%= Rs2("PROVINCE")%></font></div></td>
			    <%Rs2.Close%>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,1) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=1&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,1)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,2) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=2&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center" ><font color="#4B0097" size="1"><%=m(i,2)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,3) > 0 then %> style="cursor:hand"  onClick="top.ShowRunWindow('Desktop3','report_appoint_per.asp?monthapp=3&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,3)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,4) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=4&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,4)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,5) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=5&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,5)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,6) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=6&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,6)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,7) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=7&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,7)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,8) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=8&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,8)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,9) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=9&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,9)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,10) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=10&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,10)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,11) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=11&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,11)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
              <td <%if m(i,12) > 0 then %> style="cursor:hand"onClick="top.ShowRunWindow('Desktop2','report_appoint_per.asp?monthapp=12&emp_id=<%=Rs("APP_EMPAPP")%>');" <%end if%>><div align="center"><font color="#4B0097" size="1"><%=m(i,12)%></font></div></td>
              <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
