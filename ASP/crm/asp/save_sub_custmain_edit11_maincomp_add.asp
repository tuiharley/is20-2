...
%>
<%
	Dim cus_id, cbus, cmname, maxnumber, oldiframe, iframe
...
<script language=javascript>
	...
	top.RunWindow('<%=oldiframe%>','sub_custmain_edit11.asp?cus_id=<%=cus_id%>&cbus=<%=cbus%>&cmcode=<%=cbus&Right("00"&maxnumber,3)%>');
