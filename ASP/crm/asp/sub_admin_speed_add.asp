...
<form name="form1" method="post" action="">
  <table width="300" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="80%">&nbsp;&nbsp;<input name="speedname" type="text" class="text" id="speedname" size="30" maxlength="50"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		if(document.form1.speedname.value==""){
			alert('กรุณาใส่ความเร็ว');
			document.form1.speedname.focus();
			return;
		}
		if(confirm('ยืนยันการบันทึกข้อมูล'))
		{
		top.RunWindow('Temp1','add_speed_name.asp?speedname=' + document.form1.speedname.value+'');
