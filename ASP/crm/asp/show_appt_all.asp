...
<%
	...
	Rs.MoveFirst
				Redim 	amount(2,totalno,12)  
			
				for l = 1 to totalno
						amount(Tel,l,1) = Rs("TELNO")
						Rs.MoveNext
					next
	Rs.Close
				for l = 1 to totalno
	...
	if cgcode="" then
		'Sql = "SELECT DISTINCT TELNO, MC_CUSTOMER_ID AS CUSTOMER_D, NDOS FROM  VIEW_TELNO WHERE (CM_CODE = N'" & cmcode & "')"
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,1) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
						'-------------------------------------------------------------------------------------MONTH 02----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,2) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 03----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,3) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 04----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,4) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 05----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,5) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 06----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,6) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 07----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,7) = Rs("MNT_HT_FACT")
						Rs.Movenext
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,8) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 09----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,9) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			'Sql = "SELECT     MNT_HT_FACT, TELNO FROM  VIEW_TELDETAIL01 WHERE (CM_CODE = N'" & cmcode & "') AND (BILLING_YEAR = '" & tmpyear-543 & "') ORDER BY TELNO"
			Rs.Close
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,10) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 11----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,11) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
			'-------------------------------------------------------------------------------------MONTH 12----------------------------------------------------------------------------------------------------------------------------
			...
			k =  Rs.RecordCount
					for  l = 1 to k 
						amount(Money,l,12) = Rs("MNT_HT_FACT")
						Rs.Movenext
					next
			Rs.Close
	else
...
%>
              <tr> 
                <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
                <td><div align="center"><font size="1"><font color="#4B0097"><%=amount(Tel,i,1) %></font></font></div></td>
	...
	'Rs3.Open Sql,Session("Conn1"),1,3
				Response.Write(formatNumber(amount(Money,i,1),2))
				totala = totala + CDbl(amount(Money,i,1))
				total1 = total1 + CDbl(amount(Money,i,1))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
				...
				Response.Write(formatNumber(amount(Money,i,2),2))
				totala = totala + CDbl(amount(Money,i,2))
				total2 = total2 + CDbl(amount(Money,i,2))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,3),2))
				totala = totala + CDbl(amount(Money,i,3))
				total3 = total3 + CDbl(amount(Money,i,3))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,4),2))
				totala = totala + CDbl(amount(Money,i,4))
				total4 = total4 + CDbl(amount(Money,i,4))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,5),2))
				totala = totala + CDbl(amount(Money,i,5))
				total5 = total5 + CDbl(amount(Money,i,5))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,6),2))
				totala = totala + CDbl(amount(Money,i,6))
				total6 = total6 + CDbl(amount(Money,i,6))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,7),2))
				totala = totala + CDbl(amount(Money,i,7))
				total7 = total7 + CDbl(amount(Money,i,7))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,8),2))
				totala = totala + CDbl(amount(Money,i,8))
				total8 = total8+ CDbl(amount(Money,i,8))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,9),2))
				totala = totala + CDbl(amount(Money,i,9))
				total9 = total9 + CDbl(amount(Money,i,9))
...
<%
				...
				Response.Write(formatNumber(amount(Money,i,10),2))
				totala = totala + CDbl(amount(Money,i,10))
				total10 = total10 + CDbl(amount(Money,i,10))
...
%>
                ...
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,11),2))
				totala = totala + CDbl(amount(Money,i,11))
				total11 = total11 + CDbl(amount(Money,i,11))
%>
                    </font></div></td>
                <td width="1" bgcolor="#3399FF"><div align="center"><font color="#4B0097" size="2"><img src="../images/blank.gif" width="1" height="1"></font></div></td>
                <td><div align="right"><font color="#4B0097" size="1"> 
<%
	Response.Write(formatNumber(amount(Money,i,12),2))
				totala = totala + CDbl(amount(Money,i,12))
				total12 = total12 + CDbl(amount(Money,i,12))
