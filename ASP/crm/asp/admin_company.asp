      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="8%">&nbsp;</td>
                <td><b><font color="#4B0097" size="5">บริษัทผู้ให้บริการ</font></b></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td><table width="50%" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" style="border-collapse: collapse">
              <tr> 
                ...
                <td width="60%"><div align="center"><strong><font color="#4B0097" size="3">บริษัทผู้ให้บริการ</font></strong></div></td>
...
%>
              <tr> 
                ...
                <td align="center"><input name="edit" type="button" id="edit" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onclick="top.ShowRunCenterSizeWindow('Dialog1',130,300,'edit_company.asp?COMPNAME=<%=Rs("COMPNAME")%>&COMPID=<%=Rs("COMPID")%>');">
                  <input name="del" type="button" id="del" value="  ลบ  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onclick=" if(confirm('ยืนยันการลบ')==true){top.RunWindow('Temp1','delete_company.asp?COMPID=<%=Rs("COMPID")%> ') } "> </td>
              </tr>
              <%         
		i=i+1
		Rs.Movenext
...
%>
              <tr> 
                <td colspan="3"><div align="right">
                    <input name="add" type="button" id="add" value=" เพิ่ม " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onclick="top.ShowRunCenterSizeWindow('Dialog1',130,300,'sub_admin_company_add.asp'); ">
                  </div></td>
              </tr>
            </table>
          </td>
