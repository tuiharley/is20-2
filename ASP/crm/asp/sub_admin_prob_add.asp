...
<form name="form1" method="post" action="">
  <table width="300" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="20%"><div align="right"><font color="#4B0097" size="2"><strong>ปัญหา</strong></font></div></td>
      <td width="80%">&nbsp;&nbsp;<input name="probname" type="text" class="text" id="probname" size="30" maxlength="50"></td>
    </tr>
     <tr> 
...
<script languange=JavaScript>
	...
	function dosend () 
	{
		...
		if(document.form1.probname.value==""){
			alert('กรุณาใส่ชื่อปัญหา');
			document.form1.probname.focus();
			return;
		}
		if(confirm('ยืนยันการบันทึกข้อมูล'))
		{
		top.RunWindow('Temp1','add_prob_name.asp?probname=' + document.form1.probname.value + '&opt=<%=opt%>');
