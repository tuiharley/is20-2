          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td> <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="7" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>สินค้าและบริการของลูกค้าในอนาคต 
                    ...
                    <td width="30%"><div align="center"><strong><font color="#4B0097" size="2">โปรโมชั่น</font></strong></div></td>
                    <td width="8%"><div align="center"><strong><font color="#4B0097" size="2">จำนวน</font></strong></div></td>
                    <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">ภายในวันที่</font></strong></div></td>
                    <td width="12%">&nbsp;</td>
                    <%
	i=1
	Sql = "SELECT VOICE_FUTURE.PROMOID, VOICE_FUTURE.VCID, VOICE_FUTURE.COMPID, COMPANY.COMPNAME, VOICE_FUTURE.VOICEID, VOICE_SERVICE.VOICENAME, VOICE_FUTURE.NUM, VOICE_FUTURE.DATEEF FROM VOICE_FUTURE INNER JOIN COMPANY ON VOICE_FUTURE.COMPID = COMPANY.COMPID INNER JOIN VOICE_SERVICE ON VOICE_FUTURE.VOICEID = VOICE_SERVICE.VOICEID WHERE (VOICE_FUTURE.CG_CODE = '" & cgcode & "') "
	Rs.Open SQL, Session("Conn1"),1,3	
...
%>
                      ...
                      <td><font color="#4B0097" size="2"><%=left(FormatDateTime(Rs("DATEEF"),1),len(FormatDateTime(Rs("DATEEF"),1))-4)&right(FormatDateTime(Rs("DATEEF"),1),4)+543%></font></td>
                      <td width="20%"> <div align="center"> 
                          <input name="Edit2" type="button" id="Edit" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','230px','500px','sub_custmain_voice_future_edit.asp?cgcode=<%=cgcode%>&vcid=<%=Rs("VCID")%>');">
                          <input name="Delete2" type="button" id="Delete22" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','230px','450px','sub_custmain_voice_future_delete.asp?cgcode=<%=cgcode%>&vcid=<%=Rs("VCID")%>');" <%if Cint(Session("User_Level"))<>Cint(4) and Cint(Session("User_Area"))<>Cint(Session("Temp")) then%>disabled<%end if%>>
                        </div></td>
                    </tr>
                    <%
		i=i+1
...
%>
                    <tr> 
                      <td height="27" colspan="8" valign="top"><div align="right"> 
                          <input name="add" type="button" id="add" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','230px','500px','sub_custmain_voice_future_add.asp?cgcode=<%=cgcode%>');">
                        </div></td>
                    </tr>
                  </table>
                  <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="8" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>สินค้าและบริการของลูกค้าในอนาคต 
                          NON-VOICE</strong></font></div></td>
                    </tr>
                    <td width="5%" height="19"><div align="center"><strong><font color="#4B0097" size="2">ลำดับ</font></strong></div></td>
                    <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">ผู้ให้บริการ</font></strong></div></td>
                    <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">ประเภทบริการ</font></strong></div></td>
                    <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ความเร็ว</font></strong></div></td>
                    <td width="20%"><div align="center"><strong><font color="#4B0097" size="2">โปรโมชั่น</font></strong></div></td>
                    <td width="8%"><div align="center"><strong><font color="#4B0097" size="2">จำนวน</font></strong></div></td>
                    <td width="15%"><div align="center"><strong><font color="#4B0097" size="2">ภายในวันที่</font></strong></div></td>
                    <td width="12%">&nbsp;</td>
                    <%
	i=1
	Sql = "SELECT NONVOICE_FUTURE.NVID, NONVOICE_FUTURE.PROMOID, COMPANY.COMPNAME, NONVOICE_SERVICE.NONNAME, SPEED.SPEEDNAME, NONVOICE_FUTURE.NUM, NONVOICE_FUTURE.DATEEF  FROM NONVOICE_FUTURE INNER JOIN COMPANY ON NONVOICE_FUTURE.COMPID = COMPANY.COMPID INNER JOIN NONVOICE_SERVICE ON NONVOICE_FUTURE.NONID = NONVOICE_SERVICE.NONID INNER JOIN SPEED ON NONVOICE_FUTURE.SPEED = SPEED.SPEEDID WHERE (NONVOICE_FUTURE.CG_CODE = '" & cgcode & "')"
	Rs.Open SQL, Session("Conn1"),1,3	
...
%>
                      ...
                      <td><font color="#4B0097" size="2"><%=left(FormatDateTime(Rs("DATEEF"),1),len(FormatDateTime(Rs("DATEEF"),1))-4)&right(FormatDateTime(Rs("DATEEF"),1),4)+543%></font></td>
                      <td width="20%"> <div align="center"> 
                          <input name="Edit" type="button" id="Edit4" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','260px','490px','sub_custmain_nonvoice_future_edit.asp?cgcode=<%=cgcode%>&nvid=<%=Rs("NVID")%>');">
                          <input name="Delete" type="button" id="Delete4" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','260px','490px','sub_custmain_nonvoice_future_delete.asp?cgcode=<%=cgcode%>&nvid=<%=Rs("NVID")%>');" <%if Cint(Session("User_Level"))<>Cint(4) and Cint(Session("User_Area"))<>Cint(Session("Temp")) then%>disabled<%end if%>>
                        </div></td>
                    </tr>
                    <%
		i=i+1
...
%>
                    <tr> 
                      <td colspan="9" valign="top"><div align="right"> 
                          <input name="add2" type="button" id="add22" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','275px','500px','sub_custmain_nonvoice_future_add.asp?cgcode=<%=cgcode%>');">
                        </div></td>
                    </tr>
                  </table>
                  <table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    ...
                    <tr> 
                      ...
                      <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">จำนวนสายใน</font></strong></div></td>
                      <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">จำนวนสายนอก</font></strong></div></td>
                      <td width="10%"><strong><font color="#4B0097" size="2">ภายในวันที่</font></strong></td>
                    </tr>
                    <%
	i=1
	Sql = "SELECT PABXID, PABXNAME, SPEC, LINEIN, LINEOUT, DATEEF FROM PABX_FUTURE WHERE (CG_CODE = '" & cgcode & "') "
	Rs.Open SQL, Session("Conn1"),1,3	
...
%>
                    <tr> 
                      ...
                      <td><font color="#4B0097" size="2"><%=left(FormatDateTime(Rs("DATEEF"),1),len(FormatDateTime(Rs("DATEEF"),1))-4)&right(FormatDateTime(Rs("DATEEF"),1),4)+543%></font></td>
                      <td> <div align="center"> 
                          <input name="Edit3" type="button" id="Edit3" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','180px','340px','sub_custmain_pabx_future_edit.asp?cgcode=<%=cgcode%>&pabxid=<%=Rs("PABXID")%>');">
                          <input name="Delete3" type="button" id="Delete3" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','180px','340px','sub_custmain_pabx_future_delete.asp?cgcode=<%=cgcode%>&pabxid=<%=Rs("PABXID")%>');" <%if Cint(Session("User_Level"))<>Cint(4) and Cint(Session("User_Area"))<>Cint(Session("Temp")) then%>disabled<%end if%>>
                        </div></td>
                    </tr>
                    <%
		i=i+1
...
%>
                    <tr> 
                      <td colspan="7" valign="top"><div align="right"> 
                          <input name="add3" type="button" id="add3" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','180px','340px','sub_custmain_pabx_future_add.asp?cgcode=<%=cgcode%>');">
                        </div></td>
                    </tr>
                  </table></td>
              </tr>
