        ...
        <tr> 
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="80%"><table width="100%" border="3" cellSpacing="0" borderColor="#ada2eb" bgColor="#ffffff">
                    <tr> 
              ...
              <tr> 
                ...
                <td valign="top"><table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="5" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>ผู้มีอำนาจในการตัดสินใจ</strong></font></div></td>
                    </tr>
                    <tr> 
                      <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ลำดับ</font></strong></div></td>
                      <td width="30%"><div align="center"><strong><font color="#4B0097" size="2">ชื่อ</font></strong></div></td>
                      <td width="25%"><div align="center"><strong><font color="#4B0097" size="2">หน่วยงาน</font></strong></div></td>
                      <td width="25%"><div align="center"><strong><font color="#4B0097" size="2">ตำแหน่ง</font></strong></div></td>
                      <td width="10%">&nbsp;</td>
                      <% 
						Dim SQLS, RsS
						set RsS = Server.CreateObject("Adodb.RecordSet")
						SQLS = "SELECT CG_CODE, HEADID, HEAD_NAME, HEAD_SIDE, HEAD_POS FROM HEAD WHERE (CG_CODE = '" & cgcode & "')"
                    ...
                    <tr> 
                      ...
                      <td><font color="#4B0097" size="2"><%=RsS("HEAD_NAME")%></font></td>
                      <td><font color="#4B0097" size="2"><%=RsS("HEAD_SIDE")%></font></td>
                      <td><font color="#4B0097" size="2"><%=RsS("HEAD_POS")%></font></td>
                      <td> <div align="center"> 
                          <input name="Edit" type="button" id="Edit2" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','170px','300px','sub_custmain_edit5.asp?cgcode=<%=RsS("CG_CODE")%>&headid=<%=RsS("HEADID")%>');">
                          &nbsp;&nbsp; 
                          <input name="Delete2" type="button" id="Delete2" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','150px','300px','sub_custmain_delete5.asp?cgcode=<%=RsS("CG_CODE")%>&headid=<%=RsS("HEADID")%>');">
                        </div></td>
                    </tr>
                    <%
						RsS.MoveNext
                    ...
                    <tr> 
                      <td colspan="5" valign="top"><div align="right"> 
                          <input name="add" type="button" id="add" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','150px','300px','sub_custmain_add5.asp?cgcode=<%=Rs("CG_CODE")%>');">
                        </div></td>
                    </tr>
                  </table></td>
              </tr>
