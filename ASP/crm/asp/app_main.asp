        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="68" rowspan="2"><table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="400" id="AutoNumber24" height="152">
                    <tr> 
                  ...
                  <td width="450" valign="bottom"><input name="showdate1" type="text" class="text" id="showdate1" size="18" readonly value="<%=showdate1%>"> 
                    ...
                    <tr> 
                      <td height="27" valign="bottom"><div align="right"><font color="#4B0097"size="2">จังหวัด</font></div></td>
                    ...
                    <tr> 
                      ...
                      <td valign="bottom"> <div align="left"><font color="#4B0097" size="2"> รหัส:
<input name="emp_id" type="text" class="text" id="emp_id" onkeypress="if(window.event.keyCode==13){document.form1.emp_name.focus();}" value="<%=emp_id%>" size="5" maxlength="4">ชื่อ:<input name="emp_name" type="text" class="text" id="emp_name" onkeypress="if(window.event.keyCode==13){document.form1.emp_lname.focus();}" value="<%=emp_name%>" size="15" maxlength="20">
                      สกุล:</font><input name="emp_lname" type="text" class="text" id="emp_lname" onkeypress="if(window.event.keyCode==13){document.form1.namecus.focus();}" value="<%=emp_lname%>" size="15" maxlength="20">
                    </div></td>
                    </tr>
                    <tr> 
              ...
              <tr> 
                <td valign="bottom"><div align="center"><b><font size="2" color="#4B0097"> 
                    <input name="commit" type="button" id="commit" value="บันทึกการนัดหมาย" valign="bottom" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunWindow('Desktop2','app_add.asp');">
                    </font></b></div></td>
              </tr>
            </table></td>
        </tr>
...
%> 
        <tr> 
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center">
                <font color="#4B0097" size="3" face="JasmineUPC">ข้อมูลภาค <% Response.Write(area) %> ตั้งแตวันที่ <% Response.Write(showdate1) %>
                  ถึงวันที่ <% Response.Write(showdate2) %></font>
              </div></td>
              </tr>
            </table></td>
        </tr>
...
<!--#include file = "finepage.asp"-->
		<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="10%">&nbsp;</td>
            <td width="65%"><font size="2"><img src="../images/PRINT3.ICO" style="cursor:hand" onClick="window.open('print_app_main.asp?showdate1=<%=showdate1%>&opendate1=<%=opendate1%>&showdate2=<%=showdate2%>&opendate2=<%=opendate2%>&area=<%=area%>&prov=<%=prov%>&namecus=<%=namecus%>&emp_id=<%=emp_id%>&emp_name=<%=emp_name%>&emp_lname=<%=emp_lname%>&pageno=<%=pageno%>','','');"></font></td>
...
%>
        ...
        <tr> 
          ...
          <tr> 
            ...
            <td><font size="2" color="#FF8000">กลุ่มลูกค้า P=Platinum, G=Gold, 
              S=Silver, B=Bronze&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dis=แสดงข้อมูล,&nbsp;E=แก้ไข/ยกเลิกข้อมูล</font></td>
          </tr>
        </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <tr> 
            ...
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="13%" rowspan="3"><div align="center"><font color="#4B0097" size="2"></font></div></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
          </tr>
          <tr> 
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
          ...
          <tr> 
            <td width="1"bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="14%"><div align="center"><font color="#4B0097"><strong><font size="2">ว 
                / ด / ป</font></strong></font><font color="#4B0097" size="2"></font></div></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="6%"><div align="center"><font color="#4B0097"><strong><font size="2">เวลา</font></strong></font></div></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
          ...
          <tr> 
            ...
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
            <td><div align="center"><font color="#4B0097" size="2"> 
                <input name="dis" type="button" id="dis" value="แสดง" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunWindow('Desktop2','app_detail.asp?cgcode=<%=Rs("cg_code")%>&app_id=<% =Rs("APP_ID") %>')">
                <input name="e" type="button" id="e" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunWindow('Desktop2','app_edit.asp?cgcode=<%=Rs("cg_code")%>&app_id=<% =Rs("APP_ID") %>')" <%if Rs("AS_STATUS_ID")>1 or (Cint(Session("User_Level"))=Cint(3) and Session("User_Id")<>Rs("APP_EMPAPP")) then%>disabled<%end if%>>
                </font></div></td>
            <td width="1" bgcolor="#3399FF"><img src="../images/blank.gif" width="1" height="1"></td>
          </tr>
          <tr> 
...
<form name="form5" method="post" action="">
  <input name="showdate1" type="hidden" id="showdate1" value="<%=showdate1%>">
  <input name="opendate1" type="hidden" id="opendate1" value="<%=opendate1%>">
  <input name="showdate2" type="hidden" id="showdate2" value="<%=showdate2%>">
  <input name="opendate2" type="hidden" id="opendate2" value="<%=opendate2%>">
  ...
  <input name="namecus" type="hidden" id="namecus" value="<%=namecus%>">
  <input name="emp_id" type="hidden" id="emp_id" value="<%=emp_id%>">
  <input name="emp_name" type="hidden" id="emp_name" value="<%=emp_name%>">  
  <input name="emp_lname" type="hidden" id="emp_lname" value="<%=emp_lname%>">
