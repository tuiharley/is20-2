...
function dosubmit(){
	...
	top.ShowRunWindow(self.name,'custgrouping_search_cgcode.asp?iframe=<%=iframe%>&cus_id=<%=cus_id%>&cbus=<%=cbus%>&cmcode=<%=cmcode%>&prov=<%=prov%>&cgname='+document.form1.cgname.value);
}
</script>
</body>
</html>
