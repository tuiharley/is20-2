...
%>
<%
	Dim input1, dmonth, dyear, begindate, enddate, nday, startdate
      ...
      <td><table width="250" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <td colspan="17"><div align="center"> 
                <select name="month" id="month" onchange="top.RunWindow('Dialog1','calendar.asp?input1=<%=input1%>&input2=<%=input2%>&dmonth='+document.form1.month.value+'&dyear='+document.form1.year.value)">
                ...
                <select name="year" id="year" onchange="top.RunWindow('Dialog1','calendar.asp?input1=<%=input1%>&input2=<%=input2%>&dmonth='+document.form1.month.value+'&dyear='+document.form1.year.value)">
<%
	Dim i
	i=year(Date)+5
	do while i >= 2535-543
...
%>
          ...
          <tr> 
            ...
            <td width="3"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td name="td<%=startdate%>" id="td<%=startdate%>" <%if startdate>0 and startdate<=nday then%>style="cursor:hand" onmouseover="document.all.f<%=startdate%>.color='#0000ff'; document.all.td<%=startdate%>.bgColor='#FFFFCC'" onmouseout="document.all.f<%=startdate%>.color='#ff0000'; document.all.td<%=startdate%>.bgColor='#ffffff'" onclick="doclick('<%=startdate&"/"&dmonth&"/"&dyear%>','<%=dmonth&"/"&startdate&"/"&dyear%>');"<%end if%>><div align="center"><strong><font name="f<%=startdate%>" id="f<%=startdate%>" color="#FF0000" size="3"><%if startdate>0 and startdate<=nday then%><%=startdate%><%end if%><%startdate=startdate+1%></font></strong></div></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="3"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td name="td<%=startdate%>" id="td<%=startdate%>" <%if startdate>0 and startdate<=nday then%>style="cursor:hand" onmouseover="document.all.f<%=startdate%>.color='#0000ff'; document.all.td<%=startdate%>.bgColor='#FFFFCC'" onmouseout="document.all.f<%=startdate%>.color='#000000'; document.all.td<%=startdate%>.bgColor='#ffffff'" onclick="doclick('<%=startdate&"/"&dmonth&"/"&dyear%>','<%=dmonth&"/"&startdate&"/"&dyear%>');"<%end if%>><div align="center"><strong><font name="f<%=startdate%>" id="f<%=startdate%>" size="3"><%if startdate>0 and startdate<=nday then%><%=startdate%><%end if%><%startdate=startdate+1%></font></strong></div></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="3"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td name="td<%=startdate%>" id="td<%=startdate%>" <%if startdate>0 and startdate<=nday then%>style="cursor:hand" onmouseover="document.all.f<%=startdate%>.color='#0000ff'; document.all.td<%=startdate%>.bgColor='#FFFFCC'" onmouseout="document.all.f<%=startdate%>.color='#000000'; document.all.td<%=startdate%>.bgColor='#ffffff'" onclick="doclick('<%=startdate&"/"&dmonth&"/"&dyear%>','<%=dmonth&"/"&startdate&"/"&dyear%>');"<%end if%>><div align="center"><strong><font name="f<%=startdate%>" id="f<%=startdate%>" size="3"><%if startdate>0 and startdate<=nday then%><%=startdate%><%end if%><%startdate=startdate+1%></font></strong></div></td>
            ...
            <td width="3"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td name="td<%=startdate%>" id="td<%=startdate%>" <%if startdate>0 and startdate<=nday then%>style="cursor:hand" onmouseover="document.all.f<%=startdate%>.color='#0000ff'; document.all.td<%=startdate%>.bgColor='#FFFFCC'" onmouseout="document.all.f<%=startdate%>.color='#ffaaaa'; document.all.td<%=startdate%>.bgColor='#ffffff'" onclick="doclick('<%=startdate&"/"&dmonth&"/"&dyear%>','<%=dmonth&"/"&startdate&"/"&dyear%>');"<%end if%>><div align="center"><strong><font name="f<%=startdate%>" id="f<%=startdate%>" color="#FFaaaa" size="3"><%if startdate>0 and startdate<=nday then%><%=startdate%><%end if%><%startdate=startdate+1%></font></strong></div></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="3"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="1" bgcolor="#009CE8"><img src="../images/blank.gif" width="1" height="1"></td>
          </tr>
