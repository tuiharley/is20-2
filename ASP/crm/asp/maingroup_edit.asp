...
<%
	...
	Dim cus_id, cbus, cmcode, cgcode, area, prov, prov_name, cgname, band, home, soi, street, tumbol, dis, postcode, cgid
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="10%">&nbsp;</td>
            <td><b><font color="#4B0097" size="4" face="JasmineUPC">เพิ่มรหัสสาขา</font></b></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="12%">&nbsp;</td>
            <td><font color="#FF00FF" size="4" face="JasmineUPC"><b>วิธีการป้อนข้อมูล</b></font></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td><table width="67%" height="104" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" id="AutoNumber21" style="border-collapse: collapse">
          <tr> 
...
<script language="JavaScript">
	function dosend(){
		...
		if(confirm('ยืนยันการบันทึกข้อมูล')){
			top.RunWindow('Temp1','temp_save_maingroup_edit.asp');
		}
	}
</script>
</body>
