...
top.ShowRunWindow('DialogS1','add_specialist1.asp?app_id=<%=app_id%>&cgcode=<%=cgcode%>&empcode='+document.form1.empcode.value+'&empname='+document.form1.empname.value);
}
</script>
