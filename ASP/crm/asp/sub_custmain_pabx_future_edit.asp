...
<%
	Sql = "SELECT PABXID, PABXNAME, SPEC, LINEIN, LINEOUT, DATEEF FROM PABX_FUTURE WHERE (CG_CODE = '" & cgcode & "') AND (PABXID = " & pabxid & ") "
...
%>
    ...
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font size="2">รุ่น</font></strong></font></div></td>
      <td>&nbsp; <input name="spec" type="text" class="text" id="spec" value="<%=Rs2("SPEC")%>" size="30" maxlength="100"  onkeyPress="if(window.event.keyCode==13){document.form1.linein.focus();}"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font color="#4B0097" size="2">จำนวนสายใน</font></strong></font></div></td>
      <td>&nbsp;&nbsp;<input name="linein" type="text" class="text" id="num2" onkeyPress="if(window.event.keyCode==13){document.form1.lineout.focus();}" value="<%=Rs2("LINEIN")%>" size="10" maxlength="10"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097"><strong><font size="2">จำนวนสายนอก</font></strong></font></div></td>
      <td>&nbsp;&nbsp;<input name="lineout" type="text" class="text" id="total2" onkeyPress="if(window.event.keyCode==13){document.form1.send.focus();}" value="<%=Rs2("LINEOUT")%>" size="10" maxlength="10"></td>
    </tr>
    <tr> 
      <td><div align="right"><font color="#4B0097" size="2"><strong>ภายในวันที่</strong></font><font color="#4B0097"><strong></strong></font></div></td>
      <td>&nbsp;&nbsp;<input name="showdate" type="text" class="text" id="showdate" size="18" readonly value="<%=left(FormatDateTime(Rs2("DATEEF"),1),len(FormatDateTime(Rs2("DATEEF"),1))-4)&right(FormatDateTime(Rs2("DATEEF"),1),4)+543%>"> <input name="dateef" type="hidden" id="dateef" value="<%=Rs2("DATEEF")%>">
...
function dosend(){
	...
	if(confirm('ยืนยันการบันทึกข้อมูล')){
		top.RunWindow('Temp1','temp_save_sub_custmain_pabx_future_edit.asp');
	}
}
</script>
</body>
