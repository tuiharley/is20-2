...
<%
	...
	Dim cus_id, cbus, cmcode, cmname, iframe
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td><table width="95%" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" style="border-collapse: collapse">
          <tr> 
            <td width="30%" valign="bottom"><div align="right"><font size="2" color="#4B0097">กลุ่มลูกค้าธุรกิจองค์กร</font></div></td>
            <td width="2%" valign="bottom" rowspan="4"><img src="../images/blank.gif" width="1" height="1"></td>
            <td width="68%" valign="bottom"><div align="left"> 
...
<script language="JavaScript">
	function dosend(){
		...
		if(confirm('ยืนยันการบันทึกข้อมูล')){
			...
			top.RunWindow('Temp1','temp_save_sub_custmain_edit11_maincomp_edit.asp?iframe='+self.name+'&oldiframe=<%=iframe%>');
		}
	}
</script>
</body>
