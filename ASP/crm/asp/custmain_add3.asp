          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td valign="top"><table border="3" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
                    <tr> 
                      <td colspan="4" valign="top"><div align="center"><font color="#4B0097" size="3"><strong>สมาชิกสมาคม</strong></font></div></td>
                    </tr>
                    <tr> 
                      <td width="10%"><div align="center"><strong><font color="#4B0097" size="2">ลำดับ</font></strong></div></td>
                      <td width="50%"><div align="center"><strong><font color="#4B0097" size="2">สมาคม</font></strong></div></td>
                      <td width="30%"><div align="center"><strong><font color="#4B0097" size="2">ตำแหน่ง</font></strong></div></td>
                      <td width="10%">&nbsp;</td>
                    </tr>
                    <% 
						Dim SQLS, RsS
						set RsS = Server.CreateObject("Adodb.RecordSet")
						SQLS = "SELECT MEMBER.MEMID, MEMBER.CG_CODE, SOCIAL.SOCIAL_NAME, SOCIAL.SOCIAL_ID, MEMBER.POSTION FROM MEMBER INNER JOIN SOCIAL ON MEMBER.SOCIAL_ID = SOCIAL.SOCIAL_ID WHERE (MEMBER.CG_CODE = '" & cgcode & "') "
                    ...
                    <tr> 
                      ...
                      <td><font color="#4B0097" size="2"><%=RsS("SOCIAL_NAME")%></font></td>
                      <td><font color="#4B0097" size="2"><%=RsS("POSTION")%></font></td>
                      <td><div align="center"> 
                          <input name="Edit" type="button" id="Edit2" value="แก้ไข" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','130px','300px','sub_custmain_edit3.asp?cgcode=<%=RsS("CG_CODE")%>&memid=<%=RsS("MEMID")%>');">
                          <input name="Delete2" type="button" id="Delete2" value="ลบ" class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','130px','300px','sub_custmain_delete3.asp?cgcode=<%=RsS("CG_CODE")%>&memid=<%=RsS("MEMID")%>');" <%if Cint(Session("User_Level"))<>Cint(4) and Cint(Session("User_Area"))<>Cint(Session("Temp")) then%>disabled<%end if%>>
                        </div></td>
                    </tr>
                    <%
						RsS.MoveNext
                    ...
                    <tr> 
                      <td colspan="4" valign="top"><div align="right"> 
                          <input name="add" type="button" id="add" value="  เพิ่ม  " class="button" onMouseOver="this.className='buttonover'" onMouseOut="this.className='button'" onClick="top.ShowRunCenterSizeWindow('Dialog1','130px','300px','sub_custmain_add3.asp?cgcode=<%=Rs("CG_CODE")%>');">
                        </div></td>
                    </tr>
                  </table></td>
              </tr>
