...
%>
<%
	Dim tpid, pdate, solid, sdate, Rs, Sql, cgcode, prob_id
...
<%
	...
	Sql = "UPDATE PROBLEM SET PID = '" & tpid & "', PDATE = CONVERT(DATETIME, '" & right(pdate,4) & "-" & mid(pdate,4,2) & "-" & left(pdate,2) & " 00:00:00', 102), SOLID = '"& solid &"', SDATE = CONVERT(DATETIME, '" & right(sdate,4) & "-" & mid(sdate,4,2) & "-" & left(sdate,2) & " 00:00:00', 102) WHERE CG_CODE = '"& cgcode &"' AND PROB_ID = '"& prob_id &"' AND TYPE='t'"
