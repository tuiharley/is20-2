...
%>
<%
	Dim cus_id, cbus, cmcode, cgname, prov, band, home, soi, street, tumbol, dis, provname, postcode, maxnumber, cg_id
...
<script language=javascript>
	...
	top.RunWindow('Desktop2','custgrouping.asp?cus_id=<%=cus_id%>&cbus=<%=cbus%>&cmcode=<%=cmcode%>&cgcode=<%=cmcode&ploc&Right("0000"&maxnumber,5)%>');
