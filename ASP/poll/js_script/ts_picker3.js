...
function show_calendar3(str_target, str_datetime) {
	...
	var str_buffer = new String (
		...
		"<tr>\n	<td bgcolor=\"#4682B4\"><a href=\"javascript:window.opener.show_calendar3('"+
		str_target+"', '"+ dt2dtstr3(dt_prev_month)+"'+document.cal.time.value);\">"+
		"<img src=\"prev.gif\" width=\"16\" height=\"16\" border=\"0\""+
		" alt=\"previous month\"></a></td>\n"+
		"	<td bgcolor=\"#4682B4\" colspan=\"5\">"+
		"<font color=\"white\" face=\"tahoma, verdana\" size=\"2\">"
		+arr_months[dt_datetime.getMonth()]+" "+dt_datetime.getFullYear()+"</font></td>\n"+
		"	<td bgcolor=\"#4682B4\" align=\"right\"><a href=\"javascript:window.opener.show_calendar3('"
		+str_target+"', '"+dt2dtstr3(dt_next_month)+"'+document.cal.time.value);\">"+
	...
	while (dt_current_day.getMonth() == dt_datetime.getMonth() ||
		...
		for (var n_current_wday=0; n_current_wday<7; n_current_wday++) {
				...
				if (dt_current_day.getMonth() == dt_datetime.getMonth())
					...
					".value='"+dt2dtstr3(dt_current_day)+"'+document.cal.time.value; window.close();\">"+
	...
	str_buffer +=
		...
		"<font color=\"White\" face=\"tahoma, verdana\" size=\"2\">"+
		"Time: <input type=\"text\" name=\"time\" value=\""+dt2tmstr3(dt_datetime)+
