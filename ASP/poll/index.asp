...
A=Request.QueryString("stockholder_id")
'response.write A
'sql = "Select * form  stockholder WHERE stockholder_id="&A
'response.write sql
'response.end
Set rs = conn.Execute("Select * from stockholder WHERE stockholder_id="&A)
'Set rs = conn.Execute("Select * from stockholder ")
...
<form method="POST" action="index.asp" webbot-action="--WEBBOT-SELF--">
  ...
  <span lang="th"><b><font color="#0000FF" face="MS Sans Serif">&#3619;&#3627;&#3633;&#3626;&#3612;&#3641;&#3657;&#3606;&#3639;&#3629;&#3627;&#3640;&#3657;&#3609;&nbsp;&nbsp;&nbsp;&nbsp;</font></b><font face="MS Sans Serif" color="#0000FF"><b><input type="text" name="stockholder_id" size="20" value="<%response.write A%>"></b></font></span><font face="MS Sans Serif" color="#0000FF"><b><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
