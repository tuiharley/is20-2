...
<table border="1" cellspacing="1" width="100%" id="AutoNumber1" bgcolor="#9900FF" height="26" bordercolor="#9900FF">
  <tr><td width="100%" bgcolor="#FF99FF" bordercolor="#FFFFFF">
    ...
    <span lang="th">แก้ไขรายชื่อผู้เข้าร่วมการประชุม</span></font></b></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="AutoNumber2" height="188">
    ...
    <tr>
      ...
      <span lang="th">กลุ่มผู้ถือหุ้น</span> :&nbsp;&nbsp;&nbsp;
      <span lang="th">&nbsp; </span></font></b></td>
      <td width="50%" height="20"><b><font face="MS Sans Serif" size="2" color="#0000FF"><span lang="th">
      <input type="radio" value="1"  name="R1" <%if rs(3) = "1" then response.write "checked" end if%>>&nbsp; กลุ่มนิติบุคคลไทย&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></font></b></td>
    </tr>
    <tr>
      <td width="50%" height="20" align="right">&nbsp;</td>
      <td width="50%" height="20"><b><font face="MS Sans Serif" size="2" color="#0000FF"><span lang="th">
      <input type="radio" value="2" name="R1" <%if rs(3) = "2" then response.write "checked" end if%>>&nbsp; กลุ่ม</span><span lang="en-us">Foreign 
      Juristic Person</span></font></b></td>
    </tr>
    <tr>
      <td width="50%" height="20" align="right">&nbsp;</td>
      <td width="50%" height="20"><b><font face="MS Sans Serif" size="2" color="#0000FF"><span lang="th">
      <input type="radio" value="3" name="R1" <%if rs(3) = "3" then response.write "checked" end if%>></span> <span lang="th">&nbsp;กลุ่มนามสกุล ก - ป</span></font></b></td>
    </tr>
    <tr>
      <td width="50%" height="20" align="right">&nbsp;</td>
      <td width="50%" height="20"><b><font face="MS Sans Serif" size="2" color="#0000FF"> <span lang="th">
      <input type="radio" value="4"  name="R1" <%if rs(3) = "4" then response.write "checked" end if%> >&nbsp; กลุ่มนามสกุล ผ - ฮ</span></font></b></td>
    </tr>
    <tr>
      <td width="50%" height="22" align="right"><b><font face="MS Sans Serif" size="2" color="#0000FF">
  ...
  <input type="reset" value="ยกเลิก" name="cancel" onClick="return window.confirm('คุณต้องการยกเลิกการบันทึกข้อมูล?')" style="font-family: MS Sans Serif; font-size: 10pt"></a></p>
      </td>
    </tr>
  </table>