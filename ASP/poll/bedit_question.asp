<%  	s_date=date()
	s_date= Day(s_date) & "/" & Month(s_date) & "/" & Year(s_date)+543 
...
<table border="1" cellspacing="1" width="100%" id="AutoNumber1" bgcolor="#9900FF" height="26" bordercolor="#9900FF">
  <tr>
    ...
    ปรับปรุงหัวข้อวาระการประชุม</font></font></b></td>
  </tr>
</table>
<p align="center">&nbsp;</p><form action="edit_question.asp" method="POST" name="q">
