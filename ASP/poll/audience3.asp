...
sql = "select distinct agent from committee where committee_date = #"&s_date&"# and  agent not in ( 'นายประจวบ ตันตินนท์','นายรุ่งโรจน์ ศรีประเสริฐสุข')  order by agent"

rs1.open sql,conn,1,3 
	  response.write "<select name='agent'>"
	  response.write "<option value='นายรักษ์ อุณหโภคา'>นายรักษ์ อุณหโภคา์</option>"
	   response.write "<option value='นางพรรณี วรวุฒิจงสถิต'>นางพรรณี วรวุฒิจงสถิต</option>"
	...
	'response.end
	   ...
	   do until rs1.eof
	   		if rs1(0) <> "นายรักษ์ อุณหโภคา" or rs1(0) <> "นางพรรณี วรวุฒิจงสถิต"  then
