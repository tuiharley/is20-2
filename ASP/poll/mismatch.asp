...
<p align="center">&nbsp;</p>
<form action="insert_mismatch.asp" method="post"> 
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="AutoNumber2" height="26">
    <tr>
      ...
      <input type="text" name="stockholder_name" size="42" value="<%= request("stockholder") %>"></font></b></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="150%" height="22" align="left"><b><font face="MS Sans Serif" size="2" color="#0000FF">
      <input type="text" name="agent" size="42"></font></b></td>
    </tr>
    <tr>
