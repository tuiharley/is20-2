Public Class print_moto_detail
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents driveSys As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        myCustNo = BikeDB.getBikeOwnerID(carid)
    ...
    Private Sub showInfo(ByVal myCar As Bike)
        Dim pri As String

        carBrand.Text = BrandDB.getBrandName(myCar.Brand) & " " & ModelDB.getModelName(myCar.Model)
        cate.Text = CarTypeDB.getStatusName(myCar.Type, 2)
        ...
        driveSys.Text = checkNullStr_Line(DriveDB.getDriveName(myCar.Drive))
