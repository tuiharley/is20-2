Public Class print_truck_detail
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents praoNum As System.Web.UI.WebControls.Label
    Protected WithEvents praoDrive As System.Web.UI.WebControls.Label
    Protected WithEvents truckLoad As System.Web.UI.WebControls.Label
    Protected WithEvents truckWg As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        myCustNo = TruckDB.getTruckOwnerID(carid)
    ...
    End Sub
    Private Sub showInfo(ByVal myCar As Truck)
        Dim pri As String

        carBrand.Text = BrandDB.getBrandName(myCar.Brand) & " " & myCar.Model
        cate.Text = CarTypeDB.getStatusName(myCar.Type, 3)
        ...
        praoNum.Text = checkNullStr_Line(myCar.NumPrao)
        praoDrive.Text = checkNullStr_Line(myCar.NumPraoDrive)
        truckLoad.Text = checkNullStr_Line(myCar.NumWeightLoad)
        truckWg.Text = checkNullStr_Line(myCar.NumWeight)
