Public Class search3_detail_truck00
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If myInfo.type = 0 Then
                Response.Redirect("search3_detail_truck_p00.aspx?carid=" & Request.QueryString("carid"))
                Response.End()
            End If
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(search3_detail_truck00))
    End Sub
    ...
    Private Sub setLink(ByVal carid As Integer)
        ...
        'delAds.Text = "<font id='delAd' class='Font_black_u' Style = 'CURSOR: hand' onmouseover = ""document.all.delAd.className='Font_black_u_over'"" onmouseout = ""document.all.delAd.className='Font_black_u'"" onClick='delAds(3," & carid & ");' >แจ้งลบประกาศ</font>"

        warnDel.Text = "แจ้งลบประกาศ"
        warnDel.Target = "_blank"
        warnDel.NavigateUrl = "../warn/warning.aspx?f=truck&detail_id=" & NoticeDetailDB.getNoticeDetailID2(carid, "3")
    End Sub
    ...
    <AjaxPro.AjaxMethod()> _
    Public Function sendNotice(ByVal cat As Integer, ByVal carid As Integer) As String
        Dim EQuestion As mailQuestion
