<%@ Page CodeBehind="search3_detail_truck_p00.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.search3_detail_truck_p00" %>
...
//-->
	...
	<body onload="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif')">
				...
				<tr>
					...
					<td width="693">
						<table cellSpacing="0" cellPadding="0" width="693" border="0">
							<tr>
								<td width="693">
									<table class="Font_black" cellSpacing="0" cellPadding="0" align="right" border="0">
										<tr>
											<td><IMG height="16" src="../../images/objects/sub_navi_blue_l.gif" width="10"></td>
											<td width="100" background="../../images/objects/sub_navi_blue_c.gif">
												<div align="center">
													<SCRIPT language="JavaScript" type="text/javascript">
        <!--
				...
				<tr>
					...
					<td vAlign="top" width="693">
						<table cellSpacing="0" cellPadding="0" width="693" border="0">
								...
								<td>
									<table class="Font_black" height="30" cellSpacing="0" cellPadding="0" width="693" background="../../images/table/g_693.gif"
										...
										<tr>
											...
											<td width="21" background="../../images/separator/g_21.gif"></td>
											<td width="66"><IMG height="10" src="../../images/objects/print.gif" width="15"><asp:hyperlink class="A_black_underline" id="printThis" runat="server"></asp:hyperlink></td>
											<td width="21" background="../../images/separator/g_21.gif"></td>
											<td width="85"><IMG height="10" src="../../images/objects/complaint.gif" width="15">
							...
							<tr>
								<td><IMG height="2" src="../../images/lines/dtl_693.gif" width="693"></td>
							</tr>
							<tr>
								<td height="10"></td>
							</tr>
														...
														<td>
															<table class="Font_black_LH_17px" cellSpacing="0" cellPadding="0" width="339" background="../../images/table/dtl_vehicle.gif"
																...
																<tr>
																	...
																	<td width="11"></td>
																	<td width="204"><asp:label id="praoDrive" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
																	<td width="5"></td>
																</tr>
																<tr>
																	<td colSpan="5"><IMG height="3" src="../../images/dividers/dtl_vehicle.gif" width="339"></td>
																...
																<tr>
																	...
																	<td width="11"></td>
																	<td width="204"><asp:label id="loadTruck" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
																	<td width="5"></td>
																</tr>
																<tr>
																	<td colSpan="5"><IMG height="3" src="../../images/dividers/dtl_vehicle.gif" width="339"></td>
								...
								<td>
									<table class="Font_black" cellSpacing="0" cellPadding="0" width="693" background="../../images/table/g_693.gif"
										...
										<tr>
											...
											<td width="10"></td>
											<td width="256"><asp:textbox id="name" tabIndex="1" runat="server" CssClass="Font_black" Width="95%" MaxLength="50"></asp:textbox></td>
											<td width="15"></td>
										...
										<tr>
											...
											<td></td>
											<td width="256"><asp:textbox id="email" tabIndex="3" runat="server" CssClass="Font_black" Width="95%" MaxLength="50"></asp:textbox></td>
											<td></td>
											<td></td>
											<td></td>
										</tr>
										...
										<tr>
											...
											<td></td>
											<td width="256"><asp:textbox id="phone1" tabIndex="4" runat="server" CssClass="Font_black" Width="95%" MaxLength="50"></asp:textbox></td>
											<td></td>
											<td></td>
											<td></td>
											<td width="256">
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.search3_detail_truck_p00.showMainPic(picNo,picUrl,UrlBack);
		}
		...
		function sendMail(name,email,phone1,question){
			autoonclick.search3_detail_truck_p00.sendQuestion(name,email,phone1,question,mailBack);
		}
