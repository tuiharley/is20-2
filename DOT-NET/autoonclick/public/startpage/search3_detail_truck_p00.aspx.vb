Public Class search3_detail_truck_p00
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(search3_detail_truck_p00))
    End Sub
    ...
    Private Sub showPictures(ByRef car As Truck, ByRef myinfo As A_Customer)
        ...
        End If
        image1.Text = "<img style=""CURSOR: hand"" src='" & IUrl & "' onclick='changeMainPic(1,this.src);'>"
