Public Class search3_detail_part00
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If myInfo.type = 0 Then
                Response.Redirect("search3_detail_part_p00.aspx?carid=" & Request.QueryString("carid"))
                Response.End()
            End If
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(search3_detail_part00))
