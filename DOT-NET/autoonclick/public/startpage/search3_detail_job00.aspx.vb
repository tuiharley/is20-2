Public Class search3_detail_job00
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        showHead(myCustNo, myjob)

        setTools(jobId)


        showCustInfo(myCustNo)
        showData(myjob)

        AjaxPro.Utility.RegisterTypeForAjax(GetType(search3_detail_job00))
    ...
    Private Sub setTools(ByVal carid As Integer)
        ...
        warnDel.NavigateUrl = "../warn/warning.aspx?f=job&detail_id=" & NoticeDetailDB.getNoticeDetailID2(carid, "6")
