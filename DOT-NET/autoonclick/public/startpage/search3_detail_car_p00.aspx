<%@ Page CodeBehind="search3_detail_car_p00.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.search3_detail_car_p00" %>
...
//-->
	...
	<body onload="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif')">
								...
								<td>
									<table class="Font_black" height="30" cellSpacing="0" cellPadding="0" width="693" background="../../images/table/g_693.gif"
										...
										<tr>
											...
											<td width="66"><IMG height="10" src="../../images/objects/mailto.gif" width="15"><asp:HyperLink id="sendFr" runat="server" class="A_black_underline"></asp:HyperLink></td>
											<td width="21" background="../../images/separator/g_21.gif"></td>
											...
											<td width="21" background="../../images/separator/g_21.gif"></td>
											<td width="95"><IMG height="10" src="../../images/objects/complaint.gif" width="15"><asp:HyperLink id="warnDel" runat="server" class="A_black_underline"></asp:HyperLink></td>
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.search3_detail_car_p00.showMainPic(picNo,picUrl,UrlBack);
		}
		...
		function sendMail(name,email,phone1,question){
			autoonclick.search3_detail_car_p00.sendQuestion(name,email,phone1,question,mailBack);
		}
