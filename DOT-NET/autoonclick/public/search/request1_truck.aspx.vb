...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(request1_truck))
    End Sub
    ...
    Function checkGear(ByVal gear_id As Integer) As String
        ...
        If gear_id <> 0 Then
            gear_condition = " And (TRUCK_Gears = " & gear_id & ") "
    ...
    Function checkAcc() As String
        ...
        For i = 0 To accessory1.Items.Count - 1
            If accessory1.Items(i).Selected Then
                ...
                'Session("SearchCond") = Session("SearchCond") & AccesoryDB.getTRUCKAccessName(accessory1.Items(i).Value, 1) & "; "
                v_count = v_count + 1
        ...
        For i = 0 To accessory2.Items.Count - 1
            If accessory2.Items(i).Selected Then
                ...
                'Session("SearchCond") = Session("SearchCond") & AccesoryDB.getTRUCKAccessName(accessory2.Items(i).Value, 2) & "; "
                v_count = v_count + 1
        ...
        For i = 0 To accessory3.Items.Count - 1
            If accessory3.Items(i).Selected Then
                ...
                'Session("SearchCond") = Session("SearchCond") & AccesoryDB.getTRUCKAccessName(accessory3.Items(i).Value, 3) & "; "
                v_count = v_count + 1
        ...
        If acc1 <> "" Then
            ...
            accessory = "  AND (TRUCK.TRUCK_Id in (SELECT   TAccessory_TRUCKID FROM TAccessory WHERE (CAccessory_AccID in (" & accessory & "))group by CAccessory_TRUCKID having count(*) >= " & v_count & "))"
        Else
            accessory = ""
        End If
    ...
    Private Sub doSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles doSearch.Click
        ...
        Response.Redirect("request2_response_saved.aspx?cat=3")
        'Response.Write(sql)
    End Sub
