...
<%@ Page CodeBehind="parking3_example_detail_truck_01_p.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.parking3_example_detail_truck_01_p" %>
...
//-->
	...
	<body onLoad="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif')">
								...
								<td width="693"><table border="0" cellpadding="0" cellspacing="0" class="Font_black">
										<tr>
											...
											<td background="../../images/objects/sub_navi_blue_c.gif">
												<asp:hyperlink id="searchResult1" runat="server" CssClass="A_black_NOunderline">&#3585;&#3621;&#3633;&#3610;&#3652;&#3611;&#3627;&#3609;&#3657;&#3634;&#3649;&#3626;&#3604;&#3591;&#3612;&#3621;</asp:hyperlink><a href="search2_result_truck.htm" class="A_black_NOunderline"></a></td>
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.parking3_example_detail_truck_01_p.showMainPic(picNo,picUrl,UrlBack);
		}
		...
		function sendMail(name,email,phone1,question){
			autoonclick.parking3_example_detail_truck_01_p.sendQuestion(name,email,phone1,question,mailBack);
		}
