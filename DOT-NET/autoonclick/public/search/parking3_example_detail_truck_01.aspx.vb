Public Class parking3_example_detail_truck_01
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If myInfo.type = 0 Then
                Response.Redirect("parking3_example_detail_truck_01_p.aspx?curData=" & Request.QueryString("curData") & "&fmp=" & Request.QueryString("fmp") & "&carid=" & Request.QueryString("carid"))
                Response.End()
            End If
        ...
        upPage.Text = showNextPage(Request.QueryString("curData"), Session("allTruck_Parking"))
        downPage.Text = showNextPage(Request.QueryString("curData"), Session("allTruck_Parking"))

        AjaxPro.Utility.RegisterTypeForAjax(GetType(parking3_example_detail_truck_01))
    End Sub
    ...
    Private Function showNextPage(ByVal curData As Integer, ByRef allData As Queue) As String
        ...
        Else
            ...
            x = x & "<td><a href='parking3_example_detail_truck_01.aspx?curData=" & curData - 1 & "&carid=" & carid & "&fmp=" & Session("fmp") & "' class='Font_black'><<</td>"
        End If
