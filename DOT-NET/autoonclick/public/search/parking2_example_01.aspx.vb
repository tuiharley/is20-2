Public Class parking2_example_01
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim fromPage As String = Session("fromPage")
        Dim newCookie As String
        Dim newCar As Array

        'Dim sContents As String, sErr As String
        'Dim bAns As Boolean
        'sContents = " oldCarNum--> " & oldCarNum & " :oldCarSave-->" & oldCarSave
        ...
        If oldCarNum <> "" Then
            ...
            'sContents = "PASS removeExpireCar --> OK" & vbCrLf
            'bAns = DealerHP.AppendTextToFile(sContents, Server.MapPath("/") & "log.txt", sErr)
            ...
            Else
                Response.Redirect("parking1_intro_01.aspx")
            End If
        Else
            Response.Redirect("parking1_intro_01.aspx")
        End If
    ...
    Function showList(ByVal carid As Integer, ByVal rowid As Integer, ByVal Msg As String, ByVal Cur As Integer) As String
        ...
        sql = sql & "     <td width=""455"" height=""21""><a href='parking3_example_detail_car_01.aspx?curData=" & detailPage & "&fmp=parking_result&carid=" & carid & "&cur_Page=" & Session("CurPage") & "' class=""A_H_bold_white_underline"">" & CarDB.getBrand(carid) & "</a></td>"
        sql = sql & "     <td width=""11"" height=""21""></td>"
        ...
        If InStr(CarDB.getMainPic(carid), "no_image_60x45.gif") Then
        ...
        sql = sql & "       <tr>"
        sql = sql & "         <td><a href='parking3_example_detail_car_01.aspx?curData=" & detailPage & "&fmp=parking_result&carid=" & carid & "&cur_Page=" & Session("CurPage") & "' class=""A80"">รายละเอียด</a></td>"
        sql = sql & "       </tr>"
        sql = sql & "       <tr>"
    ...
    Function showListMoto(ByVal carid As Integer, ByVal rowid As Integer, ByVal Msg As String, ByVal Cur As Integer) As String
        ...
        If InStr(BikeDB.getMainPic(carid), "no_image_60x45.gif") Then
            Pics = "../../images/objects/no_image_80x60.gif"
        Else
    ...
    Function showListTruck(ByVal Truckid As Integer, ByVal rowid As Integer, ByVal Msg As String, ByVal Cur As Integer) As String
        ...
        n = n & " 														<td width=""455"" height=""21""><a href='parking3_example_detail_truck_01.aspx?curData=" & detailPage & "&fmp=result&carid=" & Truckid & "&cur_Page=" & Session("CurPage") & "' class=""A_H_bold_white_underline"">" & TruckDB.getBrand(Truckid) & "</a></td>"
        n = n & " 														<td width=""11"" height=""21""></td>"
        ...
        If InStr(TruckDB.getMainPic(Truckid), "no_image_60x45.gif") Then
            Pics = "../../images/objects/no_image_80x60.gif"
        Else
        ...
        n = n & " 														<td rowspan=""3"" width=""80"" height=""80""><div align=""center""><a href='search3_detail_Truck.aspx?curData=" & detailPage & "&fmp=result&carid=" & Truckid & "&cur_Page=" & Session("CurPage") & "'><img src='" & Pics & "' height='" & imageHeight & "' width='" & imageWidth & "' border=""0""></a></div>"
        n = n & " 														</td>"
        ...
        n = n & " 																<tr>"
        n = n & " 																	<td><a href='parking3_example_detail_truck_01.aspx?curData=" & detailPage & "&fmp=result&carid=" & Truckid & "&cur_Page=" & Session("CurPage") & "' class=""A80"">&#3619;&#3634;&#3618;&#3621;&#3632;&#3648;&#3629;&#3637;&#3618;&#3604;</a></td>"
        n = n & " 																</tr>"
        n = n & " 																<tr>"
        n = n & " 																	<td height=""2""></td>"
        n = n & " 																</tr>"
    ...
    Function showListPart(ByVal PartID As Integer, ByVal rowid As Integer, ByVal Msg As String, ByVal Cur As Integer) As String
        ...
        End If
        n = n & " 														<td width=""455"" height=""21""><a href='parking3_example_detail_part_01.aspx?curData=" & detailPage & "&fmp=result&carid=" & PartID & "&cur_Page=" & Session("CurPage") & "' class=""A_H_bold_white_underline"">" & brands & "</a></td>"
        n = n & " 														<td width=""11"" height=""21""></td>"
        ...
        If InStr(PartsDB.getMainPic(PartID), "no_image_60x45.gif") Then
            Pics = "../../images/objects/no_image_80x60.gif"
        Else
        ...
        n = n & " 														<td rowspan=""3"" width=""80"" height=""80""><div align=""center""><a href='search3_detail_part.aspx?curData=" & detailPage & "&fmp=result&carid=" & PartID & "&cur_Page=" & Session("CurPage") & "'><img src='" & Pics & "' height='" & imageHeight & "' width='" & imageWidth & "' border=""0""></a></div>"
        n = n & " 														</td>"
        n = n & " 														<td width=""11"" rowspan=""3""></td>"
        ...
        n = n & " 														<td width=""100"" rowspan=""3""><table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">"
        n = n & " 																<tr>"
        n = n & " 																	<td><a href='parking3_example_detail_part_01.aspx?curData=" & detailPage & "&fmp=result&carid=" & PartID & "&cur_Page=" & Session("CurPage") & "' class=""A80"">&#3619;&#3634;&#3618;&#3621;&#3632;&#3648;&#3629;&#3637;&#3618;&#3604;</a></td>"
        n = n & " 																</tr>"
        n = n & " 																<tr>"
        n = n & " 																	<td height=""2""></td>"
        n = n & " 																</tr>"
    ...
    Public Function goComparePage(ByVal wComp As String, ByVal cat As String) As String
        ...
        Select Case cat
            Case "car"
                url = "compare/frameset_compare_car_parking.aspx"
            Case "bike"
                url = "compare/frameset_compare_moto_parking.aspx"
            Case "truck"
                url = "compare/frameset_compare_truck_parking.aspx"
            Case "part"
                url = "compare/frameset_compare_part_parking.aspx"
        End Select
