<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_moto_list_search.ascx.vb" Inherits="autoonclick.model_moto_list_search" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
	...
	function brand_list(frm,BrandID){
		...
		c.options[0]= new Option('----------------   ทุกยี่ห้อ   ------------------- ','0');
