<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_truck_list_search.ascx.vb" Inherits="autoonclick.model_truck_list_search" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
