<%@ Page CodeBehind="request1_truck.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.request1_truck" %>
<%@Register TagPrefix="righter" TagName="righter_bar" Src="../search/right_menu/sky1.ascx"%>
<%@Register TagPrefix="model" TagName="model_list" Src="list/model_truck_list_request_search.ascx"%>
...
//-->
	...
	<body onLoad="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif','../../images/buttons/send_01.gif')">
		<form id="form1" name="form1" runat="server">
			<input id="brandIndex" type="hidden" name="brandIndex"> <input id="proinceIndex" type="hidden" name="proinceIndex">
			<input id="districtIndex" type="hidden" name="districtIndex">
							...
							<tr>
								<td><table width="693" border="0" cellpadding="0" cellspacing="0" class="Font_black">
										<tr>
											...
											<td width="20"></td>
											<td width="46" class="Font_brown">&#3619;&#3606;&#3610;&#3619;&#3619;&#3607;&#3640;&#3585;</td>
											<td width="20"></td>
											<td width="128">
												<asp:hyperlink id="reqPart" runat="server" CssClass="A_black_NOunderline">&#3594;&#3636;&#3657;&#3609;&#3626;&#3656;&#3623;&#3609;&#3629;&#3632;&#3652;&#3627;&#3621;&#3656;/&#3611;&#3619;&#3632;&#3604;&#3633;&#3610;&#3618;&#3609;&#3605;&#3660;</asp:hyperlink><a href="request1_part.htm" class="A_black_underline"></a></td>
											<td width="109"></td>
							...
							<tr>
								<td><table width="693" border="0" cellpadding="0" cellspacing="0" background="../../images/table/g_693.gif"
										...
										<tr>
											...
											<td width="10">
												<asp:customvalidator id="BrandValidator" runat="server" Font-Bold="True" ErrorMessage="&#3585;&#3619;&#3640;&#3603;&#3634;&#3648;&#3621;&#3639;&#3629;&#3585;&#3618;&#3637;&#3656;&#3627;&#3657;&#3629;&#3619;&#3606;"
										...
										<tr>
											...
											<td width="88" height="36"><div align="right" class="Font_orange"><strong>&#3619;&#3640;&#3656;&#3609;</strong></div>
											</td>
											<td width="10" height="36"></td>
											<td width="200" height="36">
												<asp:textbox id="model" runat="server" CssClass="Font_black" Width="90%" MaxLength="50"></asp:textbox></td>
											<td width="10" height="36"><FONT face="Tahoma">
													<asp:RequiredFieldValidator id="modelRequire" runat="server" Font-Bold="True" ErrorMessage="&#3585;&#3619;&#3640;&#3603;&#3634;&#3619;&#3632;&#3610;&#3640;&#3619;&#3640;&#3656;&#3609;&#3607;&#3637;&#3656;&#3605;&#3657;&#3629;&#3591;&#3585;&#3634;&#3619;"
														ControlToValidate="model">*</asp:RequiredFieldValidator></FONT></td>
											<td width="86" height="36"><div align="right"><strong>&#3611;&#3637;</strong></div>
											</td>
											<td width="10" height="36"></td>
										...
										<tr>
											...
											<td width="10"></td>
											<td width="200">
												<asp:dropdownlist id="numprao" runat="server" Width="95%" DataValueField="Prao_value" DataTextField="Prao"
													CssClass="Font_black"></asp:dropdownlist></td>
											<td width="10"></td>
										...
										<tr>
											<td width="5"></td>
											<td width="88"><div align="right">&#3609;&#3657;&#3635;&#3627;&#3609;&#3633;&#3585;&#3610;&#3619;&#3619;&#3607;&#3640;&#3585;</div>
											</td>
											<td width="10"></td>
											<td width="200">
												<asp:dropdownlist id="loadtruck" runat="server" Width="95%" DataValueField="loadtruck" DataTextField="loadtruck_name"
													CssClass="Font_black"></asp:dropdownlist></td>
											<td width="10"></td>
										...
										<tr>
											...
											<td width="10"></td>
											<td width="137"><SELECT class="Font_black" id="District" name="District" runat="server">
													<OPTION selected></OPTION>
												</SELECT></td>
											<td width="5"></td>
											<td width="137"></td>
										...
										<tr>
											<td width="5"></td>
											<td width="88"><div align="right">&#3619;&#3606;&#3617;&#3637;&#3611;&#3619;&#3632;&#3585;&#3633;&#3609;</div>
											</td>
											<td width="10"></td>
											<td width="200">
										...
										<tr>
											<td width="5"></td>
											<td width="88"><div align="right">&#3611;&#3619;&#3632;&#3648;&#3616;&#3607;&#3612;&#3641;&#3657;&#3592;&#3635;&#3627;&#3609;&#3656;&#3634;&#3618;</div>
											</td>
											<td width="10"></td>
											<td width="200">
													...
													<TR>
														...
														<TD width="188" height="17">
															<asp:checkboxlist id="accessory2" runat="server" DataValueField="accessory" DataTextField="accessory_name"
																CssClass="Font_black"></asp:checkboxlist></TD>
														<TD width="5" height="17"><FONT face="Tahoma"></FONT></TD>
														<TD width="188" height="17">
								...
								<td height="20"><table width="693" border="0" cellpadding="0" cellspacing="0" background="../../images/table/g_693.gif"
										...
										<tr>
											...
											<td width="200" height="24">
												<asp:textbox id="password" runat="server" Width="95%" CssClass="standard_font" MaxLength="12"
										...
										<tr>
											...
											<td width="10" height="24"></td>
											<td width="200" height="24">
												<asp:textbox id="confirm" runat="server" Width="95%" CssClass="standard_font" MaxLength="12"
													TextMode="Password"></asp:textbox></td>
											<td width="10" height="24">
		...
		<script language="javascript">
			...
			function dupCheck(source, clientside_arguments){
				...
				var res = autoonclick.request1_truck.emailDuplication(document.getElementById("email").value,document.getElementById("password").value);
				if(res.value==true){
