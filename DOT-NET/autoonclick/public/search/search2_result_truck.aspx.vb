...
Public Class search2_result_truck
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(search2_result_truck))
    End Sub
    ...
    Private Function showPages(ByVal curPage As Integer) As String
        ...
        a = a & "<tr><td noWrap width='4%'><a href='search2_result_Truck.aspx?cur_Page=1' class='Font_black'>|<<</a></td>"
        ...
        Else
            numPrev = cur_Page - 1
        End If
        'a = a & "<td  noWrap width='3%'><a href='result_list_Truck.aspx?cur_Page=" & numPrev & "&searchid=" & search_id & "'><<</a></td>"
        a = a & "<td  noWrap width='3%'><a href='search2_result_Truck.aspx?cur_Page=" & numPrev & "' class='Font_black'><<</a></td>"
        ...
        Else
            ...
            If curPage <= change_point Then
                For i = 1 To curPage - 1
                    prevPage = prevPage & "<a href='search2_result_Truck.aspx?cur_Page=" & i & "'>" & i & "</a> "
                Next
                For i = curPage + 1 To lineSize
                    nextPage = nextPage & "<a href='search2_result_Truck.aspx?cur_Page=" & i & "'>" & i & "</a> "
                Next
                nextPage = nextPage & " .."
        ...
        Else
            numNext = cur_Page + 1
        End If
        'a = a & "<td  noWrap width='3%'><a href='result_list_Truck.aspx?cur_Page=" & numNext & "&searchid = " & search_id & "'>>></a></td>"
        a = a & "<td  noWrap width='3%'><a href='search2_result_Truck.aspx?cur_Page=" & numNext & "' class='Font_black'>>></a></td>"
        'a = a & "<td  noWrap width='3%'><font class='Font_black' onclick=""changePage(" & numNext & "," & numNext & ",document.all['want_comp'].value);"">>></font></td>"
        a = a & "<td width='2%'><IMG height='1' src='../../images/objects/no.gif' width='13'></td>"
        a = a & "<td  noWrap width='32%'><a href='search2_result_Truck.aspx?cur_Page=" & total_page & "' class='Font_black'>>>|</a></td>"
    ...
    Private Function showList(ByVal Truckid As Integer, ByVal rowid As Integer, ByVal pageSize As Integer, ByVal curPage As Integer) As String
        ...
        'n = n & " 																<input type=""checkbox"" name='carCheck" & rowid & "' id='carCheck" & rowid & "' value='" & Truckid & "' onClick='getCheckBox(this.checked," & Truckid & "," & Session("CurPage") & ")'>"
        n = n & " 																<input type=""checkbox"" name='carCheck' id='carCheck' value='" & Truckid & "' onClick='getCheckBox(this.checked," & Truckid & "," & Session("CurPage") & ")'>"
        n = n & " 															</div>"
        n = n & " 														</td>"
        n = n & " 														<td width=""5"" height=""21""></td>"
        n = n & " 														<td width=""80"" height=""21""></td>"
        n = n & " 														<td width=""11"" height=""21""></td>"
        n = n & " 														<td width=""455"" height=""21""><a href='search3_detail_truck.aspx?curData=" & detailPage & "&fmp=result&carid=" & Truckid & "&cur_Page=" & Session("CurPage") & "' class=""A_H_bold_white_underline"">" & TruckDB.getBrand(Truckid) & "</a></td>"
        n = n & " 														<td width=""11"" height=""21""></td>"
        ...
        Else
            ...
            Pics = TruckDB.getMainPic(Truckid)
            myTmp = Pics.Split("\")
            myTxt = "<img src='" & picUrl & "/public/test/WebForm10.aspx?custid=" & myTmp.GetValue(4) & "&w=80&h=v'  border=""0""></a></div>"
        End If

        n = n & " 	<td rowspan=""3"" width=""80"" height=""80""><div align=""center""><a href='search3_detail_Truck.aspx?curData=" & detailPage & "&fmp=result&carid=" & Truckid & "&cur_Page=" & Session("CurPage") & "'>"

        'n = n & "<img src='" & Pics & "' height='" & imageHeight & "' width='" & imageWidth & "' border=""0""></a></div>"
        'n = n & "<img src='" & picUrl & "/public/test/WebForm10.aspx?custid=" & myTmp.GetValue(4) & "&w=120&h=v&h2=90'  border=""0""></a></div>"
        n = n & myTxt
        n = n & " 														</td>"
        ...
        n = n & " 																<tr>"
        n = n & " 																	<td><a href='search3_detail_Truck.aspx?curData=" & detailPage & "&fmp=result&carid=" & Truckid & "&cur_Page=" & Session("CurPage") & "' class=""A80"">&#3619;&#3634;&#3618;&#3621;&#3632;&#3648;&#3629;&#3637;&#3618;&#3604;</a></td>"
        n = n & " 																</tr>"
        n = n & " 																<tr>"
        n = n & " 																	<td height=""2""></td>"
        n = n & " 																</tr>"
        n = n & " 																<tr>"
        n = n & " 																	<td ><input id='addCook" & rowid & "' onmouseover=""document.all.addCook" & rowid & ".className='buttonover'"" style=""CURSOR: hand"" onmouseout=""document.all.addCook" & rowid & ".className='button'"" class='button' type='button' value='&#3610;&#3633;&#3609;&#3607;&#3638;&#3585;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;' onClick='saveAdv(" & Truckid & ");'></td>"
        n = n & " 																</tr>"
        n = n & " 															</table>"
        n = n & " 														</td>"
        n = n & " 														<td width=""5"" rowspan=""3""></td>"
        ...
        If TruckDB.getNumPic(Truckid) > 1 Then
            '
            n = n & "<div onClick='picPopUp(" & Truckid & ");' style=""CURSOR: hand""><IMG height='9' src='../../images/objects/moreimages.gif' width='12' border=""0""></div>"
        Else
            n = n & "&nbsp;"
        End If
        If DateDiff(DateInterval.Day, TruckDB.getPostDate(Truckid), Now) + 1 <= 7 Then
    ...
    Private Sub makeList()
        ...
        '===========================Get Total page ==========================================
        da.Fill(ds, "All_Search_Truck")
        all_records = ds.Tables("All_Search_Truck").Rows.Count
        ...
        If all_records <> 0 Then
            ...
            For x = 0 To all_records - 1
                allC.Enqueue(ds.Tables("All_Search_Truck").Rows(x).Item("Truck_ID"))
            Next
            ...
            ds = Paging.GetPagedData(da, curIndex, pageSize, "Searched_Truck")
            ' curIndex = curIndex + pageSize

            dview = ds.Tables("Searched_Truck").DefaultView
            ...
            For Each drowview In dview
                '  Response.Write(drowview.Item("Truck_Id") & " ")
                '  Response.Write(TruckDB.getMainPic(drowview.Item("Truck_Id")))
                carResult.Text = carResult.Text & showList(drowview.Item("Truck_Id"), n, pageSize, cur_Page)
                n = n + 1
            Next
        ...
        Else    '============Else Not Found Data===============================
            'TruckResult.Text = "<tr><td><center>ไม่พบข้อมูล</center></td></tr>"
            Session("notFound") = True
            Response.Redirect("search1_Truck2.aspx")
        End If
    ...
    Public Function goComparePage(ByVal wComp) As String
        ...
        Return "compare/frameset_compare_truck.aspx?cur_Page=" & CurrentPage
        'Return wComp
    End Function
    ...
    Private Sub change_orderby_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles change_orderby.Click
        ...
        Response.Redirect("search2_result_Truck.aspx?cur_Page=" & cur_Page)
    End Sub
    Function checkOrderBy(ByVal orderby As Integer) As String
        ...
        Select Case orderby
            ...
            Case 1
                Order_By_Condition = " ORDER BY Truck_Year_Ord DESC"
                KeyOrder_By = "Truck_Year_Ord DESC"
            Case 2
