Public Class search3_detail_moto
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If myInfo.type = 0 Then
                Response.Redirect("search3_detail_moto_p.aspx?curData=" & Request.QueryString("curData") & "&fmp=" & Request.QueryString("fmp") & "&carid=" & Request.QueryString("carid"))
                Response.End()
            End If
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(search3_detail_moto))
    End Sub
    ...
    Private Function showNextPage(ByVal curData As Integer, ByRef allData As Queue) As String
        ...
        Else
            ...
            x = x & "<td><a href='search3_detail_moto.aspx?curData=" & curData - 1 & "&carid=" & carid & "&fmp=" & Session("fmp") & "' class='Font_black'><<</td>"
        End If
