...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents image4 As System.Web.UI.WebControls.ImageButton
    Protected WithEvents image5 As System.Web.UI.WebControls.ImageButton
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        pics = TruckDB.getAllPic(carid)
        showPic(pics)
        carBrand = TruckDB.getBrand(carid).Split(",")
        txt_model.Text = carBrand.GetValue(0)
        txt_price.Text = "THB " & FormatNumber(TruckDB.getPrice(carid))
    ...
    Private Sub showPic(ByVal pics As Array)
        ...
        If pics.GetValue(4) = "noimage3.gif" Then
            image4.ImageUrl = "../../../images/objects/no_image_60x45.gif"
        Else
            a = New Bitmap(Server.MapPath(pics.GetValue(4)))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 60)
            image4.ImageUrl = pics.GetValue(4)
            image4.Width = Unit.Pixel(imageWidth)
            image4.Height = Unit.Pixel(imageHeight)
        End If

        If pics.GetValue(5) = "noimage3.gif" Then
            image5.ImageUrl = "../../../images/objects/no_image_60x45.gif"
        Else
            a = New Bitmap(Server.MapPath(pics.GetValue(5)))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 60)
            image5.ImageUrl = pics.GetValue(5)
    ...
    Private Sub image4_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles image4.Click
        Dim a As Bitmap
        Dim imageWidth As Integer
        Dim imageHeight As Integer
        'image1.ImageUrl = "../../../images/objects/no_image_250x188.gif"

        If image4.ImageUrl = "../../../images/objects/no_image_60x45.gif" Then
            a = New Bitmap(Server.MapPath("../../../images/objects/no_image_250x188.gif"))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 327)
            image1.ImageUrl = "../../../images/objects/no_image_250x188.gif"
            image1.Width = Unit.Pixel(imageWidth)
            image1.Height = Unit.Pixel(imageHeight)
        Else
            a = New Bitmap(Server.MapPath(image4.ImageUrl))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 327)
    ...
    Private Sub image5_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles image5.Click
        Dim a As Bitmap
        Dim imageWidth As Integer
        Dim imageHeight As Integer
        'image1.ImageUrl = "../../../images/objects/no_image_250x188.gif"

        If image5.ImageUrl = "../../../images/objects/no_image_60x45.gif" Then
            a = New Bitmap(Server.MapPath("../../../images/objects/no_image_250x188.gif"))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 327)
            image1.ImageUrl = "../../../images/objects/no_image_250x188.gif"
            image1.Width = Unit.Pixel(imageWidth)
            image1.Height = Unit.Pixel(imageHeight)
        Else
            a = New Bitmap(Server.MapPath(image5.ImageUrl))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 327)
            image1.ImageUrl = image5.ImageUrl
            image1.Width = Unit.Pixel(imageWidth)
            image1.Height = Unit.Pixel(imageHeight)
        End If
    End Sub
