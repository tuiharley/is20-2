<%@Register TagPrefix="model" TagName="model_list" Src="list/model_list_search.ascx"%>
...
<%@ Page CodeBehind="search1_car2.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.search1_car2" %>
				...
				<tr>
					...
					<td vAlign="top" width="693">
						<table cellSpacing="0" cellPadding="0" width="693" border="0">
							<tr>
								<td width="693">
									<table class="H1_white" height="21" cellSpacing="0" cellPadding="0" width="693" background="../../images/header/m_h_b.gif"
										...
										<tr>
											<td width="25"></td>
											<td width="663">&#3588;&#3657;&#3609;&#3627;&#3634;&#3619;&#3606;&#3618;&#3609;&#3605;&#3660;&#3629;&#3618;&#3656;&#3634;&#3591;&#3621;&#3632;&#3648;&#3629;&#3637;&#3618;&#3604;</td>
											<td width="5"></td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td>
									<table class="Font_black" cellSpacing="0" cellPadding="0" width="693" background="../../images/photos/detail_car_search.jpg"
										border="0">
										<TBODY>
											<tr>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><asp:dropdownlist id="enginetype" runat="server" CssClass="Font_black" DataTextField="enginetype_name"
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><asp:dropdownlist id="gear" runat="server" CssClass="Font_black" DataTextField="gear_name" DataValueField="gear"
										Width="95%"></asp:dropdownlist></td>
								<td width="10"></td>
								<td width="86">
