...
<%@ Page CodeBehind="search2_result_part.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.search2_result_part" %>
...
<table cellSpacing=0 cellPadding=0 width=693 border=0><logo:logo_login id=logo_login runat="server"></logo:logo_login>
  ...
  <tr>
                ...
                <td>
                  ...
                  >
                    <tr>
                      ...
                      <td width=301 height=17 rowSpan=2 
                            ...
                            <td noWrap height=21>
                              ...
                              border=0>
                                ...
                                <td>&#3648;&#3619;&#3637;&#3618;&#3591;&#3621;&#3635;&#3604;&#3633;&#3610;&#3650;&#3604;&#3618;&nbsp; <asp:dropdownlist id=Order_By runat="server" CssClass="Font_black">
																							...
																							<asp:ListItem Value="1">&#3629;&#3634;&#3618;&#3640;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</asp:ListItem>
																						</asp:dropdownlist></td>
                                <td width=4></td>
                                <td><asp:button class=button id=change_orderby onmouseover="document.all.change_orderby.className='buttonover'" style="CURSOR: hand" onmouseout="document.all.change_orderby.className='button'" runat="server" Text="&#3649;&#3626;&#3604;&#3591;&#3612;&#3621;" name="change_orderby" CausesValidation="False"></asp:button></td></tr></table></div></td></tr></table></td></tr></table></td>
                <td></td></tr>
              <tr>
                <td colSpan=3 height=5><FONT face=Tahoma 
    ...
    </tr><footer:footer_bar id=footer_bar runat="server"></footer:footer_bar></table></form>
...
<script language=javascript>
		...
		function picPopUp(carid){
			var winWidth = 360;
			var winHeight = 660;
			var url = 'pic_popup/show_pics_moto.aspx?carid='+carid+'&cat=2';
		...
		function compare(comp){
			if(comp==''){
			  ...
			  autoonclick.search2_result_part.goComparePage(comp,UrlBack);
			}
