Public Class search3_detail_moto_p
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(search3_detail_moto_p))
    End Sub
    ...
    Private Function showNextPage(ByVal curData As Integer, ByRef allData As Queue) As String
        ...
        Else
            ...
            x = x & "<td><a href='search3_detail_moto_p.aspx?curData=" & curData - 1 & "&carid=" & carid & "&fmp=" & Session("fmp") & "' class='Font_black'><<</td>"
        End If
    ...
    Private Sub showPictures(ByRef car As Bike, ByRef myinfo As A_Customer)
        ...
        'Response.Write(NoticeDB.getImgPath(myinfo.id, car.id, 2))
