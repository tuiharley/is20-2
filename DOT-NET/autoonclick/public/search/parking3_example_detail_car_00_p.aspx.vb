...
Public Class parking3_example_detail_car_00_p
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(parking3_example_detail_car_00_p))
    End Sub
    ...
    Private Function showNextPage(ByVal curData As Integer, ByRef allData As Queue) As String
        ...
        Else
            ...
            x = x & "<td><a href='parking3_example_detail_car_00_p.aspx?curData=" & curData - 1 & "&carid=" & carid & "&fmp=" & Session("fmp") & "' class='Font_black'><<</td>"
        End If
