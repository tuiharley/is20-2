Public Class dealer_business_web_inventory_bikedetail
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(dealer_business_web_inventory_bikedetail))
    End Sub
    ...
    Private Function showNextPage(ByVal curData As Integer, ByRef allData As Queue) As String
        ...
        Else
            ...
            x = x & "<td><a href='dealer_business_web_inventory_bikedetail.aspx?curData=" & curData - 1 & "&carid=" & carid & "' class='Font_black'><<</td>"
        End If
