<%@ Page CodeBehind="dealer_business_web_start.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.dealer_business_web_start" %>
...
<HTML>
	...
	<body>
		<table cellSpacing="0" cellPadding="0" width="693" align="center" border="0">
			...
			<asp:label id="MainBuzDetail" runat="server"></asp:label>
			<asp:label id="SubBuzDetail" runat="server"></asp:label>
			<tr>
