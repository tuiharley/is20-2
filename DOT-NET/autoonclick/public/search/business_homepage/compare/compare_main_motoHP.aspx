<%@ Page CodeBehind="compare_main_motoHP.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_main_motoHP" %>
				...
				function removeCompare(commandid,carid,curData,fmp,curPage){
					switch (commandid){
						case '0':
							...
							break;
						case '1':
							//window.open('../dealer_business_web_inventory_bike.aspx?carid='+carid);
							return targetopener('../dealer_business_web_inventory_bikedetail.aspx?curData='+curData+'&carid='+carid+'&cur_Page='+curPage);
							break;
						case '2':
							if(noDup(carid)){
								if(getCarNum()<20){
						...
						case '3':
							...
							if(tmpString.length==3){
								...
								url = 'compare_main_motoHP.aspx?sort_by=<%=Request.QueryString("sort_by")%>&want_comp='+tmpString2.substr(1,tmpString2.length-1);
