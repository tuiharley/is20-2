Public Class compare_main_partHP
...
#End Region
    ...
    Private Function showCompare(ByRef cars As Array) As String
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "<a href='../dealer_business_web_inventory_partdetail.aspx?curData=" & i & "&carid=" & cars(i).id & "&cur_Page=" & Session("CurPage") & "' onClick=""return targetopener(this)"" class=""A_H_bold_white_underline"">" & cars(i).Brand & "/" & cars(i).Model & "</a></div></td>"
