<%@ Page CodeBehind="compare_top_vehicleHP.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_top_vehicleHP" %>
...
BODY { BACKGROUND-IMAGE: none; MARGIN: 5px 0px 0px; BACKGROUND-COLOR: #ff9900 }
	...
	<body>
		...
		function doSend(sort_condition){
				...
				top.mainFrame.location.href='compare_main_carHP.aspx?sort_by=' + document.all['Order_By'].value;
		}
		function back(){
				top.document.location.href='../dealer_business_web_inventory.aspx?cur_Page=<%'=cur_Page%>';
		}
			</script>
	</body>
</HTML>