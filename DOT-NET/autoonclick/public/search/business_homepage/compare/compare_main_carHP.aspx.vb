Public Class compare_main_carHP
...
#End Region
    ...
    Private Function showCompare(ByRef cars As Array) As String
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "<a href='../dealer_business_web_inventory_detail.aspx?curData=" & i & "&carid=" & cars(i).id & "&cur_Page=" & Session("CurPage") & "' onClick=""return targetopener(this)"" class=""A_H_bold_white_underline"">" & BrandDB.getBrandName(cars(i).Brand) & " " & ModelDB.getModelName(cars(i).model) & " " & cars(i).submodel & "</a></div></td>"
