<%@ Page CodeBehind="dealer_business_web_inventory_partdetail.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.dealer_business_web_inventory_partdetail" %>
...
<HTML>
	...
	<body>
				...
				<tr>
					<td><table border="0" cellpadding="0" cellspacing="0" class="Font_black">
							<tr>
								...
								<td background="../../../images/objects/sub_navi_blue_c.gif"><a href="dealer_business_web_inventory_part.aspx" class="A_black_NOunderline">&#3585;&#3621;&#3633;&#3610;&#3652;&#3611;&#3627;&#3609;&#3657;&#3634;&#3619;&#3634;&#3618;&#3585;&#3634;&#3619;</a></td>
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.dealer_business_web_inventory_partdetail.showMainPic(picNo,picUrl,UrlBack);
		}
		...
		function sendMail(name,email,phone1,question){
			autoonclick.dealer_business_web_inventory_partdetail.sendQuestion(name,email,phone1,question,mailBack);
		}
