...
Public Class dealer_business_web_map
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents de_map As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim dealer_id As Integer = Request.QueryString("dealer_id")
    ...
    Private Function showMap(ByVal myCust As A_Customer) As String
        Dim a As Bitmap
        Dim imageWidth As Integer
        Dim imageHeight As Integer
        Dim IUrl As String
        ...
        If myCust.map_txt <> "" Then
            a = New Bitmap(Server.MapPath("/userData/" & myCust.username & "/map/" & myCust.map_txt))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 500)
            IUrl = "/userData/" & myCust.username & "/map/" & myCust.map_txt
        Else
            a = New Bitmap(Server.MapPath("../../../images/objects/no_image_250x188.gif"))
            resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 250)
