...
Public Class dealer_business_web_inventory_bike
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(dealer_business_web_inventory_bike))
    End Sub
    ...
    Private Sub makeList(ByVal cust_id As Integer)
        ...
        sql = "SELECT     Bike.*"
        sql = sql & " FROM  Bike INNER JOIN"
        sql = sql & " NoticeDetail ON Bike.Bike_Id = NoticeDetail.NoticeDetail_DataId INNER JOIN"
        ...
        sql = sql & " WHERE  (Notice.Notice_Category = 2) AND (Notice.Notice_Show = 1) "
        ...
        If all_records <> 0 Then
            ...
            For x = 0 To all_records - 1
                allC.Enqueue(ds.Tables("All_Search_Car").Rows(x).Item("Bike_ID"))
            Next
        ...
        Else    '============Else Not Found Data===============================
            ...
            'carResult.Text = "<tr><td >ไม่พบข้อมูล</td></tr>"
    ...
    Private Function showList(ByVal Bikeid As Integer, ByVal rowid As Integer, ByVal pageSize As Integer, ByVal curPage As Integer) As String
        ...
        n = n & " 														<td width=""455"" height=""21""><a href='dealer_business_web_inventory_bikedetail.aspx?curData=" & detailPage & "&carid=" & Bikeid & "&cur_Page=" & Session("CurPage") & "' class=""A_H_bold_white_underline"">" & BikeDB.getBrand(Bikeid) & "</a></td>"
        n = n & " 														<td width=""11"" height=""21""></td>"
        ...
        Else
            Pics = BikeDB.getMainPic2(Bikeid)
        End If

        a = New Bitmap(Server.MapPath(Pics))
        resize.doResize(a.Width, a.Height, imageWidth, imageHeight, 80)

        'n = n & " 														<td width=""80"" rowspan=""3""><div align=""center""><img src='" & Pics & "' height='" & imageHeight & "' width='" & imageWidth & "' onclick='picPopUp(" & Bikeid & ");'></div>"
        n = n & " 														<td rowspan=""3"" width=""80"" height=""80""><div align=""center""><a href='dealer_business_web_inventory_bikedetail.aspx?curData=" & detailPage & "&carid=" & Bikeid & "&cur_Page=" & Session("CurPage") & "'><img src='" & Pics & "' height='" & imageHeight & "' width='" & imageWidth & "' border=""0""></a></div>"
        n = n & " 														</td>"
        ...
        n = n & " 																<tr>"
        n = n & " 																	<td><a href='dealer_business_web_inventory_bikedetail.aspx?curData=" & detailPage & "&carid=" & Bikeid & "&cur_Page=" & Session("CurPage") & "' class=""A80"">&#3619;&#3634;&#3618;&#3621;&#3632;&#3648;&#3629;&#3637;&#3618;&#3604;</a></td>"
        n = n & " 																</tr>"
        n = n & " 																<tr>"
        n = n & " 																	<td height=""2""></td>"
        n = n & " 																</tr>"
    ...
    Private Function showPages(ByVal curPage As Integer) As String
        ...
        a = a & "<tr><td noWrap width='4%'><a href='dealer_business_web_inventory_bike.aspx?cur_Page=1' class='Font_black'>|<<</a></td>"
        ...
        a = a & "<td  noWrap width='3%'><a href='dealer_business_web_inventory_bike.aspx?cur_Page=" & numPrev & "' class='Font_black'><<</a></td>"
        ...
        Else
            ...
            If curPage <= change_point Then
                For i = 1 To curPage - 1
                    prevPage = prevPage & "<a href='dealer_business_web_inventory_bike.aspx?cur_Page=" & i & "'>" & i & "</a> "
                Next
                For i = curPage + 1 To lineSize
                    nextPage = nextPage & "<a href='dealer_business_web_inventory_bike.aspx?cur_Page=" & i & "'>" & i & "</a> "
                Next
                nextPage = nextPage & " .."
        ...
        a = a & "<td  noWrap width='3%'><a href='dealer_business_web_inventory_bike.aspx?cur_Page=" & numNext & "' class='Font_black' >>></a></td>"
        'a = a & "<td  noWrap width='3%'><font class='Font_black' onclick=""changePage(" & numNext & "," & numNext & ",document.all['want_comp'].value);"">>></font></td>"
        a = a & "<td width='2%'><IMG height='1' src='../../../images/objects/no.gif' width='13'></td>"
        a = a & "<td  noWrap width='32%'><a href='dealer_business_web_inventory_bike.aspx?cur_Page=" & total_page & "' class='Font_black'>>>|</a></td>"
    ...
    Public Function goComparePage(ByVal wComp) As String
        ...
        Return "compare/frameset_compare_motoHP.aspx?cur_Page=" & CurrentPage
        'Return wComp
    End Function
    ...
    Private Sub change_orderby_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles change_orderby.Click
        ...
        Response.Redirect("dealer_business_web_inventory_bike.aspx?cur_Page=" & cur_Page)
    End Sub
End Class
