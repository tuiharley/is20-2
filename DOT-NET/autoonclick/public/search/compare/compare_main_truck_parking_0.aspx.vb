Public Class compare_main_truck_parking_0
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Next
        Session.Add("allTruck_Parking", allC)
        '============================================
    ...
    Private Function showCompare(ByRef cars As Array) As String
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "<a href='../parking3_example_detail_truck_00.aspx?curData=" & i & "&fmp=result&carid=" & cars(i).id & "&cur_Page=" & Session("CurPage") & "' onClick=""return targetopener(this)"" class=""A_H_bold_white_underline"">" & BrandDB.getBrandName(cars(i).Brand) & " " & cars(i).model & " " & cars(i).submodel & "</a></div></td>"
