<%@ Page CodeBehind="compare_main_moto_parking.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_main_moto_parking" %>
				...
				function removeCompare(commandid,carid,curData,fmp){
					switch (commandid){
						...
						case '1':
							...
							return targetopener('../parking3_example_detail_moto_01.aspx?curData='+curData+'&fmp=result&carid='+carid);
							break;
						case '2':
							var tmpArray;
							var tmpString2='';
							...
							if(tmpString.length==3){
								...
								url = 'compare_main_moto_parking.aspx?sort_by=<%=Request.QueryString("sort_by")%>&want_comp='+tmpString2.substr(1,tmpString2.length-1);
