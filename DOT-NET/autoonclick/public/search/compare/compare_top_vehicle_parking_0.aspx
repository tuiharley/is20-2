<%@ Page CodeBehind="compare_top_vehicle_parking_0.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_top_vehicle_parking_0" %>
...
BODY { BACKGROUND-IMAGE: none; MARGIN: 5px 0px 0px; BACKGROUND-COLOR: #ff9900 }
	...
	<body>
		...
		function doSend(sort_condition){
				...
				top.mainFrame.location.href='compare_main_car_parking_0.aspx?sort_by=' + document.all['Order_By'].value;
		}
		function back(){
