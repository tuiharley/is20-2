<%@ Page CodeBehind="compare_top_vehicle_parking.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_top_vehicle_parking" %>
...
BODY { BACKGROUND-IMAGE: none; MARGIN: 5px 0px 0px; BACKGROUND-COLOR: #ff9900 }
	...
	<body>
											...
											<td height="21" nowrap><div align="center">
													<table border="0" cellpadding="0" cellspacing="0" class="H1_white">
														<tr>
															...
															onClick='doSend();' name='sort' value='&#3649;&#3626;&#3604;&#3591;&#3612;&#3621;'> 
															</a>
															</td>
														</tr>
													</table>
		...
		function doSend(sort_condition){
				...
				top.mainFrame.location.href='compare_main_car_parking.aspx?sort_by=' + document.all['Order_By'].value;
		}
		function back(){
				top.document.location.href='../../../result_lists/result_list_car.aspx?cur_Page=<%'=cur_Page%>';
		}
			</script>
	</body>
</HTML>