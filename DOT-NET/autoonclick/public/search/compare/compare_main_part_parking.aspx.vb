Public Class compare_main_part_parking
...
#End Region
    ...
    Private Function showCompare(ByRef cars As Array) As String
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "<a href='../parking3_example_detail_part_01.aspx?curData=" & i & "&fmp=result&carid=" & cars(i).id & "&cur_Page=" & Session("CurPage") & "' onClick=""return targetopener(this)"" class=""A_H_bold_white_underline"">" & cars(i).Brand & "/" & cars(i).Model & "</a></div></td>"
