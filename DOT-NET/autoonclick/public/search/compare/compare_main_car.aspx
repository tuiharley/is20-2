<%@ Page CodeBehind="compare_main_car.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_main_car" %>
				...
				function removeCompare(commandid,carid,curData,fmp,curPage){
					switch (commandid){
						...
						case '1':
							...
							return targetopener('../search3_detail_car.aspx?curData='+curData+'&fmp=result&carid='+carid+'&cur_Page='+curPage);
							break;
						case '2':
							if(noDup2(carid)){
								if(getCarNum()<20){
						...
						case '3':
							...
							if(tmpString.length==3){
								...
								url = 'compare_main_car.aspx?sort_by=<%=Request.QueryString("sort_by")%>&want_comp='+tmpString2.substr(1,tmpString2.length-1);
