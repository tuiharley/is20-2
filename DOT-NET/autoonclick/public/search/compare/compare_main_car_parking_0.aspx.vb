Public Class compare_main_car_parking_0
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Response.Write(Session("want_comp"))
        ...
        showCars = CarDB.getCars(Session("want_comp").replace(":", ","), Compare_Cars.OrderBY(KeyOrderBy))
    ...
    Private Function showCompare(ByRef cars As Array) As String
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "<a href='../parking3_example_detail_car_00.aspx?curData=" & i & "&fmp=result&carid=" & cars(i).id & "&cur_Page=" & Session("CurPage") & "' onClick=""return targetopener(this)"" class=""A_H_bold_white_underline"">" & BrandDB.getBrandName(cars(i).Brand) & " " & ModelDB.getModelName(cars(i).model) & " " & cars(i).submodel & "</a></div></td>"
        ...
        For i = 1 To n - 1
            If CarDB.getMainPic(cars(i).id) = "no_image_60x45.gif" Then
                Pics = "../../images/objects/no_image_250x188.gif"
            Else
                Pics = CarDB.getMainPic(cars(i).id)
            End If
            'If i = 2 Then
            '    Response.Write(Pics)
            '    Response.End()
            ...
            If CarDB.getNumPic(cars(i).id) > 1 Then
                sql = sql & "         <td height=""250""><div align=""center"" onClick='picPopUp(" & cars(i).id & ",1);' style=""CURSOR: hand""><img src='" & Pics & "' height='" & imageHeight & "' width='" & imageWidth & "' border=""0""></div></td>"
            Else
        ...
        For i = 1 To n - 1
            ...
            If CarDB.getNumPic(cars(i).id) > 1 Then
                sql = sql & "<div align='right' onClick='picPopUp(" & cars(i).id & ",1);' style=""CURSOR: hand""><IMG height='9' src='../../../images/objects/moreimages.gif' width='12' border=""0""></div>"
            Else
                sql = sql & "&nbsp;"
            End If
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "           <tr>"
            sql = sql & "             <td height=""17""><div align='center'>" & CarTypeDB.getStatusName(cars(i).Type, 1) & "</div></td>"
            sql = sql & "           </tr>"
            sql = sql & "           <tr>"
            ...
            If cars(i).FuelConsume = 0 Then
                fuelconsume = "-  km/≈‘µ√"
            Else
                fuelconsume = cars(i).FuelConsume & "  km/≈‘µ√"
            End If
        ...
        sql = sql & "         <td  bgcolor=""#ebf2ff""></td>"
        For i = 1 To n - 1
            sql = sql & "         <td  height=""51"" valign=""top""><div align='center'>" & CarDB.getAccesory(cars(i).id) & "</div></td>"
        Next
        sql = sql & "       </tr>"
        '---------------------®∫ row  13 ----------------------------
        sql = sql & "       <tr>"
        ...
        For i = 1 To n - 1
            sql = sql & "         <td  height=""51"" valign=""top""><div align='center'>" & getCustomerContact(cars(i).id, 1) & "</div></td>"
        Next
        sql = sql & "       </tr>"
        ''---------------------®∫ row  21 ----------------------------
        sql = sql & "       <tr>"
        ...
        For i = 1 To n - 1
            ...
            sql = sql & "               <option value=""2"">&#3621;&#3610;</option>"
            sql = sql & "             </SELECT></td>"
            ...
            sql = sql & "              onClick=""removeCompare(document.form1.commands" & cars(i).id & ".value," & cars(i).id & "," & i & ",'result');"">"
            sql = sql & "             </td>"
            sql = sql & "           </tr>"
            sql = sql & "         </table></td>"
        Next
