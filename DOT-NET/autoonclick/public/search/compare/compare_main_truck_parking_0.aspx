<%@ Page CodeBehind="compare_main_truck_parking_0.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.compare_main_truck_parking_0" %>
		...
		<FORM id="form1" name="form1" runat="server">
			...
			<script language="javascript">
				function removeCompare(commandid,carid,curData,fmp){
					switch (commandid){
						...
						case '1':
							...
							return targetopener('../parking3_example_detail_truck_00.aspx?curData='+curData+'&fmp=result&carid='+carid);
							break;
						case '2':
							var tmpArray;
							var tmpString2='';
							...
							if(tmpString.length==3){
								...
								url = 'compare_main_truck_parking_0.aspx?sort_by=<%=Request.QueryString("sort_by")%>&want_comp='+tmpString2.substr(1,tmpString2.length-1);
				...
				function picPopUp(carid,cat){
					var winWidth = 360;
					var winHeight = 660;
					var url = '../pic_popup/show_pics_truck.aspx?carid='+carid+'&cat='+cat;
