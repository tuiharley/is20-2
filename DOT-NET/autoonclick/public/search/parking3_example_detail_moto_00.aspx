<%@ Page CodeBehind="parking3_example_detail_moto_00.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.parking3_example_detail_moto_00" %>
...
//-->
	...
	<body onLoad="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif')">
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.parking3_example_detail_moto_00.showMainPic(picNo,picUrl,UrlBack);
		}
		...
		function sendMail(name,email,phone1,question){
			autoonclick.parking3_example_detail_moto_00.sendQuestion(name,email,phone1,question,mailBack);
		}
