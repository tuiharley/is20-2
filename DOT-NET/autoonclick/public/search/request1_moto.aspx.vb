...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(request1_moto))
    End Sub
    ...
    Function checkAcc() As String
        ...
        For i = 0 To accessory1.Items.Count - 1
            If accessory1.Items(i).Selected Then
                ...
                'Session("SearchCond") = Session("SearchCond") & AccesoryDB.getBIKEAccessName(accessory1.Items(i).Value, 1) & "; "
                v_count = v_count + 1
        ...
        For i = 0 To accessory2.Items.Count - 1
            If accessory2.Items(i).Selected Then
                ...
                'Session("SearchCond") = Session("SearchCond") & AccesoryDB.getBIKEAccessName(accessory2.Items(i).Value, 2) & "; "
                v_count = v_count + 1
        ...
        For i = 0 To accessory3.Items.Count - 1
            If accessory3.Items(i).Selected Then
                ...
                'Session("SearchCond") = Session("SearchCond") & AccesoryDB.getBIKEAccessName(accessory3.Items(i).Value, 3) & "; "
                v_count = v_count + 1
    ...
    Private Sub doSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles doSearch.Click
        ...
        Response.Redirect("request2_response_saved.aspx?cat=2")
        'Response.Write(sql)
    End Sub
