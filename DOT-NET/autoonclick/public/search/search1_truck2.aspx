<%@Register TagPrefix="model" TagName="model_list" Src="list/model_truck_list_search.ascx"%>
<%@Register TagPrefix="province" TagName="province_list" Src="list/province_list_search.ascx"%>
<%@ Page CodeBehind="search1_truck2.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.search1_truck2" %>
...
//-->
	...
	<body onload="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif')">
		<form id="form1" name="form1" runat="server">
				...
				<tr>
					...
					<td vAlign="top" width="693">
						<table cellSpacing="0" cellPadding="0" width="693" border="0">
							<tr>
								<td width="693">
									<table class="H1_white" height="21" cellSpacing="0" cellPadding="0" width="693" background="../../images/header/m_h_b.gif"
										...
										<tr>
											<td width="25"></td>
											<td width="663">&#3588;&#3657;&#3609;&#3627;&#3634;&#3619;&#3606;&#3610;&#3619;&#3619;&#3607;&#3640;&#3585;&#3618;&#3656;&#3634;&#3591;&#3621;&#3632;&#3648;&#3629;&#3637;&#3618;&#3604;</td>
											<td width="5"></td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td>
									<table class="Font_black" cellSpacing="0" cellPadding="0" width="693" background="../../images/photos/detail_truck_search.jpg"
										border="0">
										<TBODY>
											<tr>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><SELECT class="Font_black" id="Brands" onchange="setBrandIndex('brandIndex',this.selectedIndex);"
								...
								<td width="10"></td>
								<td width="137"><asp:dropdownlist id="Price1" runat="server" CssClass="Font_black" DataTextField="Price1" DataValueField="Price1_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
								<td width="137"><asp:dropdownlist id="Price2" runat="server" CssClass="Font_black" DataTextField="Price2" DataValueField="Price2_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="200"><FONT face="Tahoma">
										<asp:textbox id="model" runat="server" CssClass="Font_black" Width="90%" MaxLength="50"></asp:textbox></FONT></td>
								<td width="10"></td>
								<td width="86">
									<div align="right"><strong>&#3611;&#3637;</strong></div>
								</td>
								<td width="10"></td>
								<td width="137"><asp:dropdownlist id="Year1" runat="server" CssClass="Font_black" DataTextField="LYEAR" DataValueField="Lyear_value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
								<td width="137"><asp:dropdownlist id="Year2" runat="server" CssClass="Font_black" DataTextField="RYEAR" DataValueField="RYear_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><asp:dropdownlist id="status" runat="server" CssClass="Font_black" DataTextField="status_name" DataValueField="status"
								...
								<td width="10"></td>
								<td width="137"><asp:dropdownlist id="CC1" runat="server" CssClass="Font_black" DataTextField="LCC" DataValueField="LCC_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
								<td width="137"><asp:dropdownlist id="CC2" runat="server" CssClass="Font_black" DataTextField="RCC" DataValueField="RCC_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><asp:dropdownlist id="cartype" runat="server" CssClass="Font_black" DataTextField="cartype_name" DataValueField="cartype"
										Width="95%"></asp:dropdownlist></td>
								<td width="10"></td>
								<td width="86">
								...
								<td width="10"></td>
								<td width="137"><asp:dropdownlist id="power1" runat="server" CssClass="Font_black" DataTextField="LPower" DataValueField="LPower_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
								<td width="137"><asp:dropdownlist id="power2" runat="server" CssClass="Font_black" DataTextField="RPower" DataValueField="RPower_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><asp:dropdownlist id="numprao" runat="server" CssClass="Font_black" DataTextField="Prao" DataValueField="Prao_value"
										Width="95%"></asp:dropdownlist></td>
								<td width="10"></td>
								<td width="86">
								...
								<td width="10"></td>
								<td width="137"><asp:dropdownlist id="mile1" runat="server" CssClass="Font_black" DataTextField="LMile" DataValueField="LMile_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
								<td width="137"><asp:dropdownlist id="mile2" runat="server" CssClass="Font_black" DataTextField="RMile" DataValueField="RMile_Value"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="200"><asp:dropdownlist id="loadtruck" runat="server" CssClass="Font_black" DataTextField="Load_Desc" DataValueField="id"
										Width="95%"></asp:dropdownlist></td>
								<td width="10"></td>
								<td width="86">
								...
								<td width="10"></td>
								<td width="137"><asp:dropdownlist id="color" runat="server" CssClass="Font_black" DataTextField="color_name" DataValueField="color"
										Width="100%"></asp:dropdownlist></td>
								<td width="5"></td>
							...
							<tr>
								...
								<td></td>
								<td><asp:dropdownlist id="enginetype" runat="server" CssClass="Font_black" DataTextField="enginetype_name"
							...
							<tr>
								...
								<td></td>
								<td><asp:dropdownlist id="gear" runat="server" CssClass="Font_black" DataTextField="gear_name" DataValueField="gear"
										Width="95%"></asp:dropdownlist></td>
								<td></td>
								<td>&nbsp;</td>
								<td></td>
							...
							<tr>
								...
								<td width="10"></td>
								<td width="137"><SELECT class="Font_black" id="District" name="District" runat="server" onchange="setBrandIndex('districtIndex',this.selectedIndex);">
										<OPTION selected></OPTION>
									</SELECT></td>
								<td width="5"></td>
								<td width="137"></td>
							...
							<tr>
								...
								<td></td>
								<td width="200"><asp:dropdownlist id="Insurrance" runat="server" CssClass="Font_black" Width="159px">
								...
								<td></td>
								<td width="137"><asp:dropdownlist id="accident" runat="server" CssClass="Font_black" Width="137px">
							...
							<tr>
								...
								<td></td>
								<td width="200"><asp:dropdownlist id="showPic" runat="server" CssClass="Font_black" Width="159px">
										<asp:ListItem Value="0">&#3649;&#3626;&#3604;&#3591;&#3612;&#3621;&#3607;&#3633;&#3657;&#3591;&#3627;&#3617;&#3604;</asp:ListItem>
								...
								<td></td>
								<td width="137"><asp:dropdownlist id="showPrice" runat="server" CssClass="Font_black" Width="137px">
										<asp:ListItem Value="0">&#3649;&#3626;&#3604;&#3591;&#3612;&#3621;&#3607;&#3633;&#3657;&#3591;&#3627;&#3617;&#3604;</asp:ListItem>
							...
							<tr>
								...
								<td></td>
								<td width="200"><asp:dropdownlist id="SaleType" runat="server" CssClass="Font_black" Width="160px">
										<asp:ListItem Value="0">&#3649;&#3626;&#3604;&#3591;&#3612;&#3621;&#3607;&#3633;&#3657;&#3591;&#3627;&#3617;&#3604;</asp:ListItem>
								...
								<td></td>
								<td width="137"><asp:dropdownlist id="order_by" runat="server" CssClass="Font_black" Width="137px">
								...
								<td width="137">
									<div align="right">&nbsp;
										<asp:button class="button" id="doSearch" onmouseover="document.all.doSearch.className='buttonover'"
											...
											Text="&#3588;&#3657;&#3609;&#3627;&#3634;" name="doSearch"></asp:button></div>
								</td>
								<td></td>
							</tr>
							<tr>
			...
			</TR><footer:footer_bar id="footer_bar" runat="server"></footer:footer_bar></TBODY></TABLE></form>
