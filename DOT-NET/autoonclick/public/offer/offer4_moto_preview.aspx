<%@ Page CodeBehind="offer4_moto_preview.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.offer4_moto_preview" %>
								...
								<td><table width="693" height="31" border="0" cellpadding="0" cellspacing="0" background="../../images/table/f_line2.gif"
										...
										<tr>
											...
											<td width="123" height="20"><div align="center">
													<asp:HyperLink id="editMotoData" runat="server" Font-Underline="True" ForeColor="Black">&#3649;&#3585;&#3657;&#3652;&#3586;&#3586;&#3657;&#3629;&#3617;&#3641;&#3621;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</asp:HyperLink></div>
											</td>
											...
											<td width="295"><FONT face="Tahoma"></FONT></td>
										</tr>
										<tr>
							...
							<tr>
								<td><table width="693" height="21" border="0" cellpadding="0" cellspacing="0" background="../../images/header/h_b_693+ar.gif"
										...
										<tr>
											<td width="25"></td>
											<td width="526">
												<asp:Label id="motoBrand" CssClass="H1_white" runat="server" ForeColor="Transparent"></asp:Label></td>
											<td width="10"></td>
											<td width="127">
												<div align="right">
													&#3647;&nbsp;
													...
													<tr>
														<td><table width="339" border="0" cellpadding="0" cellspacing="0" background="../../images/table/dtl_vehicle.gif"
																...
																<tr>
																	...
																	<td width="114" valign="top" height="16"><div align="right">&#3626;&#3637;</div>
																	</td>
																...
																<tr>
																	...
																	<td width="204"><FONT face="Tahoma">
																			<asp:label id="Drive" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
																	<td></td>
																</tr>
																<tr>
																	<td colspan="5"><img src="../../images/dividers/dtl_vehicle.gif" width="339" height="3"></td>
																...
																<tr>
																	<td colspan="5" height="5"><img src="../../images/dividers/dtl_vehicle.gif" width="339" height="3"></td>
																</tr>
																<tr>
																	<td width="5"></td>
																...
																<tr>
																	...
																	<td width="11"></td>
																	<td width="204"><FONT face="Tahoma">
																			<asp:label id="accident" CssClass="Font_black_LH_17px" runat="server"></asp:label></FONT></td>
																	<td></td>
																</tr>
																<tr>
																	<td colspan="5"><img src="../../images/dividers/dtl_vehicle.gif" width="339" height="3"></td>
											...
											<td width="339" valign="top"><table width="339" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td><table width="339" border="0" cellpadding="0" cellspacing="0" background="../../images/table/dtl_con.gif"
																class="Font_black_LH_17px">
																<tr>
																	<td height="3" colspan="5"><FONT face="Tahoma"></FONT></td>
																</tr>
																<tr>
