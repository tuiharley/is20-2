...
#End Region
    ...
    '            acc1 = "1" & acc1
    '            If check Then
    '                accessory_name = accessory_name & accessory1.Items(i).Text
    '                check = False
    '            Else
    '                accessory_name = accessory_name & ", " & accessory1.Items(i).Text
    '            End If
    ...
    '            acc2 = "1" & acc2
    '            If check Then
    '                accessory_name = accessory_name & accessory2.Items(i).Text
    '                check = False
    '            Else
    '                accessory_name = accessory_name & ", " & accessory2.Items(i).Text
    '            End If
    ...
    '            acc3 = "1" & acc3
    '            If check Then
    '                accessory_name = accessory_name & accessory3.Items(i).Text
    '                check = False
    '            Else
    '                accessory_name = accessory_name & ", " & accessory3.Items(i).Text
    '            End If
    ...
    Private Sub addSession(ByVal cat As Integer)
        ...
        'Session.Add("acc1", acc1)
        'Session.Add("acc2", acc2)
        'Session.Add("acc3", acc3)
        'Session.Add("accessory", acc3 & acc2 & acc1)
        'Session.Add("accessory_name", accessory_name)
