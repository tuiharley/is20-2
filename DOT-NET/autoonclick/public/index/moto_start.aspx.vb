...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(moto_start))
    ...
    <AjaxPro.AjaxMethod()> _
        ...
        Try
            'Car
            totalRow = myDS.Tables("Bike").Rows.Count
            If totalRow > 0 Then
                ...
                For i = 1 To 5
                    For n = 1 To 2
                        If cnt <= totalRow Then
                            ...
                            myAds.id = myDS.Tables("Bike").Rows(xResult - 1).Item("Car_Id")
                            ...
                            Else
                                myAds.Status = "ปี " & checkNullDBstr(myDS.Tables("Bike").Rows(xResult - 1).Item("Car_Year_Ord"))
                            End If

                            myAds.Price = FormatNumber(checkNullDBPrice(myDS.Tables("Bike").Rows(xResult - 1).Item("Car_Price")), 2, , , TriState.True)
                            myAds.Image1 = checkNullDBstr(myDS.Tables("Bike").Rows(xResult - 1).Item("Car_Image1"))
        ...
        txt &= "	<caption>""รถจักรยานยนต์"" ลงประกาศเมื่อเร็วๆนี้ บน AUTO-ONCLICK</caption>"
