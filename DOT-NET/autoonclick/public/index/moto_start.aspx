...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<div id="inner_box">
					...
					<div id="randomShow">
						<table class="index_ads" cellspacing="0">
							<!--Example Ads-->
							<caption>
								"รถจักรยานยนต์" ลงประกาศเมื่อเร็วๆนี้ บน AUTO-ONCLICK</caption>
							<tfoot>
								<tr>
									<th>
										<span>
						...
						<div>
							<form class="cmxform" id="form1" name="form1" action="#" runat="server">
								<fieldset>
									<ol>
										<li>
											<label style="display: -moz-inline-box;" for="#">
												<span>
											...
											<select class="full" id="cat" onchange="showBrands(this.value);" name="cat">
												...
												<option value="2" selected>รถจักรยานยนต์</option>
		...
		function startSponsor(){
			autoonclick.moto_start.showRamDom(txtBack);
		}
		...
		function startRandom(){
			autoonclick.moto_start.showRamDom(txtRandom);
		}
