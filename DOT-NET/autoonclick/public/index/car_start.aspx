...
<%@ Page CodeBehind="car_start.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.car_start" %>
...
<HTML>
	...
	<body>
				...
				<div id="inner_box">
					...
					<div id="randomShow">
						<table class="index_ads" cellSpacing="0">
							<!--Example Ads-->
							<caption>
								"รถยนต์" ลงประกาศเมื่อเร็วๆนี้ บน AUTO-ONCLICK</caption>
							<tfoot>
								<tr>
									<th>
										<span>
									...
									<td><span><A href="#"><IMG alt="" src="../scripts+pics/images/pic_80x60.gif"></A></span>
										<p><A href="#">BMW 3, ปี 1994, ฿ 200,000</A></p>
									</td>
									<td><span><A href="#"><IMG alt="" src="../scripts+pics/images/pic_80x60.gif"></A></span>
										<p><A href="#">Make Model,
					...
					<div id="news">
						<!--Magazine-->
						<h1>AUTO-ONCLICKS แมกกะซีน: Tips, News, Comparison Tests and Community</h1>
						<ul>
							<!--Magazine: Categories-->
							<li class="left">
								<ul>
		...
		function startSponsor(){
			autoonclick.car_start.showRamDom(txtBack);
		}
		...
		function startRandom(){
			autoonclick.car_start.showRamDom(txtRandom);
		}
