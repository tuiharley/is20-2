<%@ Control Language="vb" AutoEventWireup="false" Codebehind="province_list.ascx.vb" Inherits="autoonclick.province_list" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
