...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents cust_name As System.Web.UI.WebControls.Label
    Protected WithEvents date_log As System.Web.UI.WebControls.Label
    Protected WithEvents payment_notify As System.Web.UI.WebControls.HyperLink
    Protected WithEvents payment_list As System.Web.UI.WebControls.HyperLink
    Protected WithEvents changePass As System.Web.UI.WebControls.HyperLink
...
#End Region
    ...
    Private Sub setLink(ByVal cust_id As Integer)
        ...
        msgBox.NavigateUrl = "inboxP.aspx"

    End Sub

    Private Sub showHead(ByVal cust_id As Integer)
        cust_name.Text = CustomerDB.getCustName(cust_id)
        date_log.Text = FormatDateTime(Now, DateFormat.ShortDate)
    End Sub
    ...
    Private Sub showCar(ByRef notice As noticeS, ByRef car As Car, ByVal cust_id As Integer)
        ...
        If car.Image1 <> "" Then
            '" & picUrl & "/public/test/WebForm10.aspx?custid=" & myTmp.GetValue(4) & "&w=80&h=v
            myArr = NoticeDB.getImgPath(cust_id, car.id, notice.category).Split("/")
            picStr = picUrl & "/public/test/WebForm10.aspx?custid=" & myArr.GetValue(1) & "&w=60&h=v&h2=45"
        ...
        cardata.Text = cardata.Text & "                   <td rowspan=""2""><div align=""center""><a href='detail_car.aspx?notice_id=" & notice.id & "'>"
        cardata.Text = cardata.Text & "<img src='" & picStr & "'  border=""0""></a></div></td>"
    ...
    Private Sub showBike(ByRef notice As noticeS, ByRef bike As Bike, ByVal cust_id As Integer)
        ...
        If bike.Image1 <> "" Then
            myArr = NoticeDB.getImgPath(cust_id, bike.id, notice.category).Split("/")
            picStr = picUrl & "/public/test/WebForm10.aspx?custid=" & myArr.GetValue(1) & "&w=60&h=v&h2=45"
        ...
        cardata.Text = cardata.Text & "             </tr>"
    End Sub
    Private Sub showTruck(ByRef notice As noticeS, ByRef truck As Truck, ByVal cust_id As Integer)
        Dim notice_status As Array
        Dim txtBrand As String
        Dim tmpBrand As Array
        Dim picStr As String
        ...
        If truck.Image1 <> "" Then
            myArr = NoticeDB.getImgPath(cust_id, truck.id, notice.category).Split("/")
            picStr = picUrl & "/public/test/WebForm10.aspx?custid=" & myArr.GetValue(1) & "&w=60&h=v&h2=45"
    ...
    Private Sub showPart(ByRef notice As noticeS, ByRef part As Part, ByVal cust_id As Integer)
        ...
        If part.Image <> "" Then
            myArr = NoticeDB.getImgPath(cust_id, part.id, notice.category).Split("/")
            picStr = picUrl & "/public/test/WebForm10.aspx?custid=" & myArr.GetValue(1) & "&w=60&h=v&h2=45"
