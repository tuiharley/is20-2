...
#End Region
    ...
    Private Sub setLink(ByVal show As String, ByVal noticeid As Integer, ByVal carid As Integer)
        ...
        edit_ad.NavigateUrl = "edit1_part_datas.aspx?car=" & carid
    ...
    Private Sub carBrandLabel(ByVal b As Integer, ByVal m As String, ByVal n As String, ByVal price As Double, ByVal post As DateTime)
        ...
        notice.Text = CategoryDB.getCategoryName(b) & " : " & m & " / " & n
        notice.ForeColor = Color.White
        notice.CssClass = "H1_white"

        date_post.Text = post.ToString("dd-MM-yyyy")
    ...
    Private Sub showData(ByVal car_id As Integer, ByVal myinfo As A_Customer, ByVal noticeid As Integer)
        ...
        carBrandLabel(myCar.Category, myCar.Brand, myCar.Model, myCar.Price, myCar.Post)
