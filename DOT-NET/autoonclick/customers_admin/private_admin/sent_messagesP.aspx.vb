...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        setLink()
        AjaxPro.Utility.RegisterTypeForAjax(GetType(sent_messagesP))
    End Sub
    ...
    Private Sub showSent(ByVal cust_id As Integer, ByVal curPage As Integer)
        ...
        For Each myInbox In myQ
            If i >= ((curPage - 1) * pageSize) + 1 And i <= (curPage * pageSize) Then
                ...
                myTxt = myTxt & "</td>"
                myTxt = myTxt & "<td width='5'></td>"
                myTxt = myTxt & "<td width='507'><div align='center'><a href='read_sent_messageP.aspx?box=" & myInbox.Inbox_Id & "' class='A_black_underline'>" & myInbox.Topic_Msg & "</a></div>"
                myTxt = myTxt & "</td>"
                myTxt = myTxt & "<td width='3'></td>"
                myTxt = myTxt & "</tr>"
                myTxt = myTxt & "<tr>"
