Public Class offer4_truck_preview_puadmin
...
#End Region
    ...
    Private Sub initLink()
        editTruckData.NavigateUrl = "offer1_truck_datas_puadmin.aspx?edit=edit&package_id=" & Session("package_id")
        editContact.NavigateUrl = "offer3_contact_datas_puadmin.aspx?from=offer4_truck_preview_puadmin"
    End Sub
