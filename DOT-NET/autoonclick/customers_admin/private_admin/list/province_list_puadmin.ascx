<%@ Control Language="vb" AutoEventWireup="false" Codebehind="province_list_puadmin.ascx.vb" Inherits="autoonclick.province_list_puadmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
