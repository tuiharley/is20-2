<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_truck2_list_puadmin.ascx.vb" Inherits="autoonclick.model_truck_list_puadmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
