<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_moto_list_puadmin.ascx.vb" Inherits="autoonclick.model_moto_list_puadmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
