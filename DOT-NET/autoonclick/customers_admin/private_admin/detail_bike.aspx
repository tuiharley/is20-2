...
<%@ Page CodeBehind="detail_bike.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.detail_bike" %>
			...
			<tr>
				...
				<td vAlign="top" width="693">
					<table cellSpacing="0" cellPadding="0" width="693" border="0">
						<tr>
							<td width="693">
								<table class="Font_white" height="21" cellSpacing="0" cellPadding="0" width="693" 
								background="<%=tbl_background%>"
									border="0">
									<tr>
										<td width="25"></td>
										<td width="526"><strong>&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;&#3619;&#3606;&#3592;&#3633;&#3585;&#3619;&#3618;&#3634;&#3609;&#3618;&#3609;&#3605;&#3660;:
									...
									<tr>
										...
										<td width="113" height="20">
											<div align="center"><FONT face="Tahoma"></FONT>
												<asp:HyperLink id="show_ad" runat="server" ForeColor="Black" Font-Underline="True">&#3648;&#3611;&#3636;&#3604;/&#3611;&#3636;&#3604; &#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</asp:HyperLink><A class="A_black_underline" href="#"></A></div>
										</td>
							...
							<td>
								<table class="H1_white" height="21" cellSpacing="0" cellPadding="0" width="693" background="../../images/header/h_b_693+ar.gif"
									...
									<tr>
										...
										<td width="526">
											<asp:label id="motoBrand" ForeColor="Transparent" runat="server" CssClass="H1_white"></asp:label></td>
										<td width="10"></td>
										<td width="127">
											<div align="right">&#3647;&nbsp;
												<asp:label id="head_price" ForeColor="Transparent" runat="server" CssClass="H1_white"></asp:label></div>
											<DIV></DIV>
										</td>
										<td width="5"></td>
									</tr>
													...
													<td>
														<table class="Font_black_LH_17px" cellSpacing="0" cellPadding="0" width="339" background="../../images/table/dtl_vehicle.gif"
															...
															<tr>
																...
																<td width="204" height="16"><asp:label id="colors" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
																<td height="16"></td>
															</tr>
															<tr>
																<td colSpan="5"><IMG height="3" src="../../images/dividers/dtl_vehicle.gif" width="339"></td>
															...
															<tr>
																...
																<td width="11"></td>
																<td width="204"><FONT face="Tahoma"><asp:label id="Drive" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
																<td></td>
															</tr>
															<tr>
																<td colSpan="5"><IMG height="3" src="../../images/dividers/dtl_vehicle.gif" width="339"></td>
															...
															<tr>
																<td colSpan="5" height="5"><IMG height="3" src="../../images/dividers/dtl_vehicle.gif" width="339"></td>
															</tr>
															<tr>
																<td width="5"></td>
																<td vAlign="top" width="114">
															...
															<tr>
																...
																<td width="11"></td>
																<td width="204"><FONT face="Tahoma"><asp:label id="accident" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
																<td></td>
															</tr>
															<tr>
																<td colSpan="5"><IMG height="3" src="../../images/dividers/dtl_vehicle.gif" width="339"></td>
												...
												<tr>
													<td>
														<table class="Font_black_LH_17px" cellSpacing="0" cellPadding="0" width="339" background="../../images/table/dtl_con.gif"
															border="0">
															<tr>
																<td colSpan="5" height="3"><FONT face="Tahoma"></FONT></td>
															</tr>
															<tr>
