<%@ Page CodeBehind="detail_truck.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.detail_truck" %>
				...
				<td width="693" valign="top"><table width="693" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							background="<%=tbl_background%>"
									...
									<tr>
										<td width="25"></td>
										<td width="526"><strong>&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;&#3619;&#3606;&#3610;&#3619;&#3619;&#3607;&#3640;&#3585;:
												<asp:label id="notice" ForeColor="Transparent" runat="server" CssClass="H1_white"></asp:label>&nbsp; 
												&#3623;&#3633;&#3609;&#3607;&#3637;&#3656;&#3621;&#3591;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;:
												<asp:label id="date_post" ForeColor="Transparent" runat="server" CssClass="H1_white"></asp:label></strong></td>
										<td width="10"></td>
						...
						<tr>
							<td><table width="693" height="31" border="0" cellpadding="0" cellspacing="0" background="../../images/table/f_line.gif"
									...
									<tr>
										...
										<td width="118" height="20"><div align="center"><FONT face="Tahoma"></FONT>
													...
													<td><table width="339" border="0" cellpadding="0" cellspacing="0" background="../../images/table/dtl_vehicle.gif"
															...
															<tr>
																...
																<td width="204"><FONT face="Tahoma">
																		<asp:label id="yearcar" CssClass="Font_black_LH_17px" runat="server"></asp:label>
																	</FONT>
																</td>
																<td width="5"></td>
															</tr>
															...
															<tr>
																...
																<td width="11"></td>
																<td width="204"><FONT face="Tahoma">
																		<asp:label id="miles" CssClass="Font_black_LH_17px" runat="server"></asp:label>
																	</FONT>
																</td>
																<td width="5"></td>
															</tr>
															...
															<tr>
																...
																<td width="11"></td>
																<td width="204"><FONT face="Tahoma">
																		<asp:label id="praoDrive" CssClass="Font_black_LH_17px" runat="server"></asp:label>
																	</FONT>
																</td>
																<td width="5"></td>
															</tr>
															...
															<tr>
																...
																<td width="11"></td>
																<td width="204"><FONT face="Tahoma">
																		<asp:label id="loadTruck" CssClass="Font_black_LH_17px" runat="server"></asp:label>
																	</FONT>
																</td>
																<td width="5"></td>
															</tr>
