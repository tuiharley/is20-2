...
#End Region
    ...
    Private Sub setLink(ByVal show As String, ByVal noticeid As Integer, ByVal carid As Integer)
        ...
        edit_ad.NavigateUrl = "edit1_truck_datas.aspx?car=" & carid
    ...
    End Sub
    Private Sub carBrandLabel(ByVal b As String, ByVal m As String, ByVal sm As String, ByVal price As Double, ByVal postDate As DateTime)
        ...
        notice.Text = truckBrand.Text
        notice.ForeColor = Color.White
        notice.CssClass = "H1_white"
        date_post.Text = postDate.ToString("dd-MM-yyyy")
    ...
    Private Sub showData(ByVal car_id As Integer, ByVal myinfo As A_Customer, ByVal noticeid As Integer)
        ...
        carBrandLabel(BrandDB.getBrandName(myCar.Brand), myCar.Model, myCar.SubModel, myCar.Price, myCar.Post)
    ...
    End Sub
    Private Sub showPictures(ByVal car As Truck, ByVal myinfo As A_Customer)
