Public Class job2_offer2_preview
...
#End Region
    ...
    Private Sub initLink()
        editCarData.NavigateUrl = "job2_offer1_datas.aspx?verb=edit"
    ...
    Private Sub saveData(ByVal myJob As Job)
        ...
        jobID = addNewJOB(myJob)

        noticeid = NoticeDB.addNewNotice(6, packageID, 1, Session("cust_id"), 0, 2, getStopDate(packageID))
