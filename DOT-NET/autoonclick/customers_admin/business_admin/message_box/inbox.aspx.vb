        ...
        For Each myInbox In myQ
            ...
            If i >= ((curPage - 1) * pageSize) + 1 And i <= (curPage * pageSize) Then
                ...
                Else
                    stCode = "read"
                End If
                myTxt = myTxt & "<td width='123'><div align='center'><a href='read_message.aspx?box=" & myInbox.Inbox_Id & "' class='A_black_underline'>" & stCode & "</a></div>"
                myTxt = myTxt & "</td>"
                myTxt = myTxt & "<td width='5'></td>"
                myTxt = myTxt & "<td width='150'><div align='center'>" & myInbox.Send_Date.ToString("dd-MM-yyyy") & "</div>"
                myTxt = myTxt & "</td>"
                myTxt = myTxt & "<td width='5'></td>"
                myTxt = myTxt & "<td width='379'><div align='center'><a href='read_message.aspx?box=" & myInbox.Inbox_Id & "' class='A_black_underline' >"
