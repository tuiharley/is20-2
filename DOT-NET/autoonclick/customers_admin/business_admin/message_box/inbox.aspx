<%@ Page CodeBehind="inbox.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.inbox" %>
...
//-->
	...
	<body onload="MM_preloadImages('../../../images/main_table/offer_01.gif','../../../images/main_table/search_01.gif','../../../images/main_table/special_offer_01.gif','../../../images/main_table/dealer_01.gif','../../../images/main_table/company_01.gif','../../../images/main_table/login_01_3.gif')">
		...
		function delMsg(){
			...
			//alert(MsgSel);
			if(MsgSel!=""){
				autoonclick.inbox.deleteMessage(MsgSel,urlBack);
			}
			
		}
		function urlBack(response){window.location.href='inbox.aspx';}
		function goPage(pageno){
						window.location.href='inbox.aspx?curPage='+pageno;
					}
		</script>
	</body>
</HTML>