...
Public Class package4_edit_moto_datas
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not IsPostBack Then
                ...
                myBike = BikeDB.getBike(Session("carid"))
                setValue(myBike, myInfo, Session("notice_id"), Session("detailid"))
    ...
    Private Sub setValue(ByVal myBike As Bike, ByRef myInfo As A_Customer, ByVal noticeid As Integer, ByVal detailid As Integer)
        Dim year As Array
        ...
        Else
            Image1.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myBike.Image1
        End If

        If (myBike.Image2 = "") Then
            Image2.ImageUrl = "../../../../images/objects/no_image_80x60.gif"
        Else
            Image2.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myBike.Image2
        End If

        If (myBike.Image3 = "") Then
            Image3.ImageUrl = "../../../../images/objects/no_image_80x60.gif"
        Else
            Image3.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myBike.Image3
        End If
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("package3_list_moto_term_new.aspx?noticeid=" & Session("notice_id"))
        Else
            Response.Redirect("package4_detail_bike.aspx?carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("notice_id"))
        End If
        Session("notice_id") = ""
        Session("carid") = ""
        Session("detailid") = ""
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("package3_list_moto_term_new.aspx?noticeid=" & Session("notice_id"))
        Else
            Response.Redirect("package4_detail_bike.aspx?carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("notice_id") & "&curData=" & Session("curData"))
        End If
        Session("notice_id") = ""
        Session("carid") = ""
        Session("detailid") = ""
