...
<%@ Page CodeBehind="package4_detail_bike.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.package4_detail_bike" %>
...
//-->
	...
	<body onLoad="MM_preloadImages('../../../../images/main_table/offer_01.gif','../../../../images/main_table/search_01.gif','../../../../images/main_table/special_offer_01.gif','../../../../images/main_table/dealer_01.gif','../../../../images/main_table/company_01.gif','../../../../images/main_table/login_01_3.gif')">
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.package4_detail_bike.showMainPic(picNo,picUrl,UrlBack);
		}
		function UrlBack(res){
			...
			img1.innerHTML = res.value;
				...
				function getOpenCl(){
					autoonclick.package4_detail_bike.getOpTxt(txtBack);
				}
				function openClose(){
					autoonclick.package4_detail_bike.openAd(txtBack);
				}
				...
				function deleteAds(){
					...
					autoonclick.package4_detail_bike.deleteAdsAJX(urlBack);
					}
				}
				function urlBack(res){
