Public Class orderdetail_d_confirmed
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not IsPostBack Then
                If Request.QueryString("invType") = "P" Then
                    invType = 2
                    header.Text = "รายการขอต่ออายุ"
                Else
                    invType = 3
                    header.Text = "รายการเปลี่ยนแพคเกจ"

                End If
                invoices = InvoiceDB.getProlongInvoices(Session("cust_id"), Request.QueryString("noticeid"), invType)
    ...
    Private Sub prolongList(ByVal prolong As invoice)
        ...
        prolongs.Text = prolongs.Text & "             <td width=""65"" height=""26""><div align=""center"">" & PackageDB.getPackageName(prolong.packageid) & "/" & PackageDB.getPackageWeek(prolong.packageid) & "M</div></td>"
        prolongs.Text = prolongs.Text & "             <td width=""5"" height=""26""></td>"
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        ProlongDB.setExpire(Session("invoiceid"))
        ChangeDB.setExpire(Session("invoiceid"))
        Session("invoiceid") = ""
