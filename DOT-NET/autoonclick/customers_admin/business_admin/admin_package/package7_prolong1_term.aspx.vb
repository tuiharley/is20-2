Public Class package7_prolong1_term
...
#End Region
    ...
    Private Sub listPackage(ByVal packageid As Integer, ByVal cat As Integer, ByVal packType As Integer)
        ...
        package.Text = package.Text & showPack(PackageDB.getPackages(cat, packType, myPackName))
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        Response.Redirect("package7_prolong2_conclusion.aspx?rdNewPack=" & Request.Form("rdNewPack"))
    End Sub
End Class
