<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_parts_list_deadmin.ascx.vb" Inherits="autoonclick.model_parts_list_puadmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
