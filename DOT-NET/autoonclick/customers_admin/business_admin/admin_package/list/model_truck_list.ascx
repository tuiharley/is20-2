<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_truck_list.ascx.vb" Inherits="autoonclick.model_truck_list" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
