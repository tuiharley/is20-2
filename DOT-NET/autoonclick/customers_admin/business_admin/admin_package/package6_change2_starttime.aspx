<%@ Page CodeBehind="package6_change2_starttime.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.package6_change2_starttime" %>
...
function goNext(){
		...
		if(newPack!=-1){
			autoonclick.package6_change2_starttime.setStartDate(newPack,urlBack);	
		}
		
	}
	function urlBack(response){
	var url="package6_change3_conclusion.aspx";
		if(response.value==1){
							...
							<tr>
								<td>
									<table border="0" align="left" cellpadding="0" cellspacing="0">
										<tr>
											<td><a href="#" class="A80">ย้อนกลับ</a></td>
											...
											<td width="4"><FONT face="Tahoma"></FONT></td>
											<td><a href="#" class="A80">ยกเลิก</a></td>
										</tr>
									</table>
								</td>
							</tr>
