<%@ Page CodeBehind="package4_detail_truck.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.package4_detail_truck" %>
		...
		<form id="form1" name="form1" runat="server">
			...
			<script language="javascript">
				...
				function changeMainPic(picNo,picUrl){
					autoonclick.package4_detail_truck.showMainPic(picNo,picUrl,UrlBack);
				}
				...
				function getOpenCl(){
					autoonclick.package4_detail_truck.getOpTxt(txtBack);
				}
				function openClose(){
					autoonclick.package4_detail_truck.openAd(txtBack);
				}
				...
				function deleteAds(){
					...
					autoonclick.package4_detail_truck.deleteAdsAJX(urlBack);
					}
				}
				function urlBack(res){
