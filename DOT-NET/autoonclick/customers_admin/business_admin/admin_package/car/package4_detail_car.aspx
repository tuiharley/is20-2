<%@ Page CodeBehind="package4_detail_car.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.package4_detail_car" %>
...
//-->
	...
	<body onload="MM_preloadImages('../../../../images/main_table/offer_01.gif','../../../../images/main_table/search_01.gif','../../../../images/main_table/special_offer_01.gif','../../../../images/main_table/dealer_01.gif','../../../../images/main_table/company_01.gif','../../../../images/main_table/login_01_3.gif')">
									...
									<table class="Font_black" cellSpacing="0" cellPadding="0" border="0">
										<tr>
											...
											<td background="../../../../images/objects/sub_navi_blue_c.gif">
												<asp:hyperlink class="A_black_NOunderline" id="packList" runat="server">รายการแพคเกจ</asp:hyperlink></td>
											...
											<td><IMG height="16" src="../../../../images/objects/sub_navi_blue_s.gif" width="21"></td>
											<td background="../../../../images/objects/sub_navi_blue_c.gif"><A class="A_black_NOunderline" href="../../admin_job/job1_list.aspx">รายการตำแหน่งงาน</A></td>
		...
		function changeMainPic(picNo,picUrl){
			autoonclick.package4_detail_car.showMainPic(picNo,picUrl,UrlBack);
		}
		function UrlBack(res){
			...
			img1.innerHTML = res.value;
				...
				function getOpenCl(){
					autoonclick.package4_detail_car.getOpTxt(txtBack);
				}
				function openClose(){
					autoonclick.package4_detail_car.openAd(txtBack);
				}
				...
				function deleteAds(){
					...
					autoonclick.package4_detail_car.deleteAdsAJX(urlBack);
					}
				}
				function urlBack(res){
