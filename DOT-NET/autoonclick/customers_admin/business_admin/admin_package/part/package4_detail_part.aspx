...
<%@ Page CodeBehind="package4_detail_part.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="autoonclick.package4_detail_part" %>
...
//-->
	...
	<body onLoad="MM_preloadImages('../../../../images/main_table/offer_01.gif','../../../../images/main_table/search_01.gif','../../../../images/main_table/special_offer_01.gif','../../../../images/main_table/dealer_01.gif','../../../../images/main_table/company_01.gif','../../../../images/main_table/login_01_3.gif')">
								...
								<td><table width="693" height="31" border="0" cellpadding="0" cellspacing="0" background="../../../../images/table/f_line.gif"
										...
										<tr>
											...
											<td width="84" height="20"><div align="center"><font class="fontBl" id="delAd" onmouseover="document.all.delAd.className='fontBl1'" style="CURSOR: hand"
														onclick="deleteAds();" onmouseout="document.all.delAd.className='fontBl'">ลบประกาศ</font></div>
											</td>
		...
		//alert(picNo+"<-->"+picUrl);
			autoonclick.package4_detail_part.showMainPic(picNo,picUrl,UrlBack);
		}
		function UrlBack(res){
			...
			img1.innerHTML = res.value;
				...
				function getOpenCl(){
				//alert('1');
					autoonclick.package4_detail_part.getOpTxt(txtBack);
					//alert('2');
				}
				function openClose(){
					autoonclick.package4_detail_part.openAd(txtBack);
				}
				...
				function deleteAds(){
					...
					autoonclick.package4_detail_part.deleteAdsAJX(urlBack);
					}
				}
				function urlBack(res){
