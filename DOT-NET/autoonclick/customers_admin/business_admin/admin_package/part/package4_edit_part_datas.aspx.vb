...
Public Class package4_edit_part_datas
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Not IsPostBack Then
                ...
                myPart = PartsDB.getPart(Session("carid"))

                setValue(myPart, myInfo, Session("notice_id"), Session("detailid"))
    ...
    Private Sub setValue(ByVal myPart As Part, ByRef myInfo As A_Customer, ByVal noticeid As Integer, ByVal detailid As Integer)
        ...
        Else
            Image1.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myPart.Image
        End If
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("package3_list_part_term_new.aspx?noticeid=" & Session("notice_id"))
        Else
            Response.Redirect("package4_detail_part.aspx?carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("notice_id"))
        End If
        Session("notice_id") = ""
        Session("carid") = ""
        Session("detailid") = ""
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("package3_list_part_term_new.aspx?noticeid=" & Session("notice_id"))
        Else
            Response.Redirect("package4_detail_part.aspx?carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("notice_id") & "&curData=" & Session("curData"))
        End If
        Session("notice_id") = ""
        Session("carid") = ""
        Session("detailid") = ""
