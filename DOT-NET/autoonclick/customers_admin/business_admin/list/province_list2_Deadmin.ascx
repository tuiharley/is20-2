<%@ Control Language="vb" AutoEventWireup="false" Codebehind="province_list2_Deadmin.ascx.vb" Inherits="autoonclick.province_list2_Deadmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
