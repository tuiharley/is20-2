<%@ Page CodeBehind="read_message.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.read_message" %>
		...
		<form id="Form1" runat="server">
			<table width="983" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
							...
							<tr>
								<td><table border="0" cellpadding="0" cellspacing="0" background="../../images/table/g_693.gif"
										...
										<tr>
											<td width="25"></td>
											<td width="643"><strong>
													<asp:Label id="compName" runat="server"></asp:Label></strong></td>
											<td width="25"></td>
										</tr>
										<tr>
											<td width="25" height="5"><asp:hyperlink id="repy" runat="server" CssClass="A_black_underline">Reply</asp:hyperlink></td>
											<td width="643" height="5"></td>
											<td width="25" height="5"></td>
										</tr>
									</table>
					...
					<td width="120" valign="top" height="600"><FONT face="Tahoma"></FONT></td>
					<td></td>
				</tr>
			</table>
		</form>
