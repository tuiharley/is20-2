<%@ Page CodeBehind="sent_messages.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.sent_messages" %>
...
<HTML>
  <HEAD>
		...
		<link href="../../css/style.css" rel="stylesheet" type="text/css">
			<style type="text/css"> BODY { MARGIN: 50px 50px 10px; BACKGROUND-COLOR: #ffffff } A:active { TEXT-DECORATION: none } A:link { TEXT-DECORATION: none } A:visited { TEXT-DECORATION: none } A:hover { TEXT-DECORATION: none } </style>
...
//-->
	...
	<body onLoad="MM_preloadImages('../../images/main_table/offer_01.gif','../../images/main_table/search_01.gif','../../images/main_table/special_offer_01.gif','../../images/main_table/dealer_01.gif','../../images/main_table/company_01.gif','../../images/main_table/login_01_3.gif')">
							...
							<tr>
								<td><table border="0" cellpadding="0" cellspacing="0" class="Font_black">
										<tr>
											...
											<td width="20"></td>
											<td class="Font_brown">&#3586;&#3657;&#3629;&#3588;&#3623;&#3634;&#3617;&#3607;&#3637;&#3656;&#3626;&#3656;&#3591;&#3649;&#3621;&#3657;&#3623;</td>
											<td width="20"></td>
											<td ></td>
										</tr>
									</table>
		...
		function delMsg(){
			...
			//alert(MsgSel);
			if(MsgSel!=""){
				manage.sent_messages.deleteMessage(MsgSel,urlBack);
			}
			
		}
		function urlBack(response){
			var tmpTxt;
			tmpTxt = response.value.split(':');
			
			window.location.href='sent_messages.aspx?curPage='+tmpTxt[0]+'&fromid='+tmpTxt[1];
		}
		function goPage(pageno,fromid){
						window.location.href='sent_messages.aspx?curPage='+pageno+'&fromid='+fromid;
					}
		</script>
	</body>
</HTML>