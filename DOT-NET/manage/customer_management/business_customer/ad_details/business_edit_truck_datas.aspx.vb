...
Public Class business_edit_truck_datas
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            setValue(myTruck, myInfo, Session("noticeid"), Session("detailid"))
    ...
    Private Sub setValue(ByVal myTruck As TruckSt, ByRef myInfo As A_Customer, ByVal noticeid As Integer, ByVal detailid As Integer)
        Dim year As Array
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("package3_list_truck_term_new.aspx?noticeid=" & Session("noticeid"))
        Else
            Response.Redirect("business_truck_detail.aspx?cust_id=" & Session("cust_id") & "&curPos=" & Session("curPos") & "&carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("noticeid"))
        End If
        Session("noticeid") = ""
        Session("carid") = ""
        Session("detailid") = ""
