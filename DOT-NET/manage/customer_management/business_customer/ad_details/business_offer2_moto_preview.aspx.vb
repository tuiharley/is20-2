...
Imports System.IO
Public Class business_offer2_moto_preview
...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents editMotoData As System.Web.UI.WebControls.HyperLink
    ...
    Protected WithEvents workDay As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Put user code to initialize the page here   Response.Expires = 0
        ...
        Session("pagename") = "business_offer2_moto_preview.aspx"
        cust_id = Session("cust_id")
        noticeid = Session("noticeid")
        'If Session("cust_id") = 0 Then
        '    Response.Redirect("../../../public/login/login.aspx")
        'Else
        initLink(cust_id, noticeid)
        carBrandLabel()
        showData(cust_id)
        showpictures()
        'End If
    End Sub
    Private Sub initLink(ByVal cust_id As Integer, ByVal noticeid As Integer)
        editMotoData.NavigateUrl = "business_offer1_moto_datas.aspx?edit=edit&noticeid=" & noticeid & "&cust_id=" & cust_id
        editContact.NavigateUrl = "../personal_datas/buz_change_contact_datas.aspx"
    End Sub
    Private Sub carBrandLabel()
        motoBrand.Text = BrandDB.getBrandName(Session("sBrands")) & " / " & ModelDB.getModelName(Session("sModel"))
        If Session("submodel") <> "" Then
            motoBrand.Text = motoBrand.Text & " / " & Session("submodel")
        End If
    ...
    Private Sub showData(ByVal cust_id As Integer)
        category.Text = CarTypeDB.getStatusName(Session("cartype"), 2)
        ...
        If Session("Drive") = "0" Then
            Drive.Text = "-"
        Else
            Drive.Text = DriveDB.getDriveName(Session("Drive"))
        End If
        ...
        myInfo = CustomerDB.getA_customer(cust_id)
        ...
        If myInfo.dateStart <> 0 Then
            workDay.Text = Utilities.getDateName(myInfo.dateStart) & " - " & Utilities.getDateName(myInfo.dateStop)
        Else
            workDay.Text = "-"
        End If
    ...
    Private Sub clearSession()
        ...
        Session.Add("edit", "")
    End Sub
    Private Sub saveCarDatabase(ByVal noticeid As Integer, ByVal cust_id As Integer)
        ...
        '----------------Upload Files------------------------
        Dim usrName As String = CustomerDB.getUserName(cust_id)
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        ...
        saveCarDatabase(noticeid, cust_id)
        clearSession()
