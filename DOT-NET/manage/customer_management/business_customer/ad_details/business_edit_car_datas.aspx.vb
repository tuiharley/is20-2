...
Public Class business_edit_car_datas
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            Session("curPos") = Request.QueryString("curPos")
            Session("cust_id") = cust_id

            myCar = CarDB.getCar(Session("carid"))
            setValue(myCar, myInfo, Session("noticeid"), Session("detailid"))
    ...
    Private Sub setValue(ByVal myCar As Car, ByRef myInfo As A_Customer, ByVal noticeid As Integer, ByVal detailid As Integer)
        Dim year As Array
        ...
        Else
            Image1.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myCar.Image1
        End If

        If (myCar.Image2 = "") Then
            Image2.ImageUrl = "../../../images/objects/no_image_80x60.gif"
        Else
            Image2.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myCar.Image2
        End If

        If (myCar.Image3 = "") Then
            Image3.ImageUrl = "../../../images/objects/no_image_80x60.gif"
        Else
            Image3.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myCar.Image3
        End If

        If (myCar.Image4 = "") Then
            Image4.ImageUrl = "../../../images/objects/no_image_80x60.gif"
        Else
            Image4.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myCar.Image4
        End If

        If (myCar.Image5 = "") Then
            Image5.ImageUrl = "../../../images/objects/no_image_80x60.gif"
        Else
            Image5.ImageUrl = "/userData/" & myInfo.username & "/" & noticeid & "/" & detailid & "/" & myCar.Image5
        End If
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        Else
            Response.Redirect("business_vehicle_detail.aspx?cust_id=" & Session("cust_id") & "&curPos=" & Session("curPos") & "&carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("noticeid"))
        End If
        Session("noticeid") = ""
        Session("carid") = ""
        Session("detailid") = ""
