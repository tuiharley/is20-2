...
Public Class business_offer1_truck_datas
...
#End Region
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        ...
        If IsValid() Then
            ...
            If Session("edit") = "True" Then
                Session("edit") = "False"
            End If
            Response.Redirect("business_offer2_truck_preview.aspx")
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("pagename") = "business_ad_list_of_package.aspx" Then
            clearSession()
            Session("noticeid") = ""
            Session("cust_id") = ""
            pageNa = "../lists/" & Session("pagename") & "?cust_id=" & cust_id & "&noticeid=" & noticeid
        Else
