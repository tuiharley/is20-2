Public Class business_vehicle_detail
...
#End Region
    ...
    Private Sub setLink(ByVal show As String, ByVal noticeid As Integer, ByVal cust_id As Integer, ByVal curPos As Integer, ByVal detailid As Integer, ByVal carId As Integer)
        ...
        editAd.NavigateUrl = "business_edit_car_datas.aspx?from=view&noticeid=" & noticeid & "&cust_id=" & cust_id & "&curPos=" & curPos & "&detailid=" & detailid & "&carid=" & carId
        del_ad.NavigateUrl = "business_vehicle_detail.aspx?del=yes&cust_id=" & cust_id & "&noticeid=" & noticeid & "&detailid=" & detailid & "&carid=" & carId & "&curPos=" & curPos


        '--------------------- form_internal_status_changing_of_ad_or_pack.aspx?page=car&noticeid=" & noticeid & "&showNotice=OFF" & "&curPos=" & curPos & "&cust_id=" & cust_id)
        show_ad.NavigateUrl = "form_internal_status_changing_of_ad.aspx?page=car&showNotice=" & tmp2 & "&cust_id=" & cust_id & "&noticeid=" & noticeid & "&detailid=" & detailid & "&carid=" & carId & "&curPos=" & curPos
