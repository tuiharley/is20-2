...
Imports System.IO
Public Class business_offer2_truck_preview
...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents editTruckData As System.Web.UI.WebControls.HyperLink
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Session("pagename") = "business_offer2_truck_preview.aspx"
    ...
    Private Sub initLink(ByVal cust_id As Integer, ByVal noticeid As Integer)
        editTruckData.NavigateUrl = "business_offer1_truck_datas.aspx?edit=edit&noticeid=" & noticeid & "&cust_id=" & cust_id
        editContact.NavigateUrl = "../personal_datas/buz_change_contact_datas.aspx"


    End Sub
    Private Sub carBrandLabel()
        truckBrand.Text = BrandDB.getBrandName(Session("sBrands")) & " / " & Session("sModel")
        If Session("submodel") <> "" Then
            truckBrand.Text = truckBrand.Text & " / " & Session("submodel")
        End If
    ...
    Private Sub showData(ByVal cust_id As Integer)
        category.Text = CarTypeDB.getStatusName(Session("cartype"), 3)
        ...
        If Session("numprao") = "" Then
            Prao.Text = "-"
        Else
            Prao.Text = Session("numprao")
        End If
        If Session("numpraodrive") = "" Then
            praoDrive.Text = "-"
        Else
            praoDrive.Text = Session("numpraodrive")
        End If
        If Session("numweigthload") = "" Then
            loadTruck.Text = "-"
        Else
            loadTruck.Text = Session("numweigthload")
        End If
        If Session("numweigth") = "" Then
            weightTruck.Text = "-"
        Else
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        ...
        saveTruckDatabase(noticeid, cust_id)
        clearSession()
        Response.Redirect("../lists/business_ad_list_of_package.aspx?cust_id=" & cust_id & "&noticeid=" & noticeid)
    End Sub
    Private Sub saveTruckDatabase(ByVal noticeid As Integer, ByVal cust_id As Integer)
