...
Imports System.IO
Public Class business_offer2_part_preview
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Session("pagename") = "business_offer2_part_preview.aspx"
    ...
    Private Sub initLink(ByVal cust_id, ByVal noticeid)
        editPartData.NavigateUrl = "business_offer1_part_datas.aspx?edit=edit&noticeid=" & noticeid & "&cust_id=" & cust_id
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        ...
        savePartDatabase(noticeid, cust_id)
        clearSession()
        Response.Redirect("../lists/business_ad_list_of_package.aspx?cust_id=" & cust_id & "&noticeid=" & noticeid)
    End Sub
    Private Sub savePartDatabase(ByVal noticeid As Integer, ByVal cust_id As Integer)
