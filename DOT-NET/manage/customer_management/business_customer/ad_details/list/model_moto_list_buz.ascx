<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_moto_list_buz.ascx.vb" Inherits="manage.adminP_model_moto_list_buz" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
