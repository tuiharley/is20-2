<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_truck_list_business.ascx.vb" Inherits="manage.model_truck_list_business" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
