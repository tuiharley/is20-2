<%@ Control Language="vb" AutoEventWireup="false" Codebehind="model_list_business.ascx.vb" Inherits="manage.adminP_model_list_business" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
	...
	<%if isNothing(session("brandIndex")) then%>
		brand_list('Brands','');
		model_list('Model',0,'');
	<%else%>
