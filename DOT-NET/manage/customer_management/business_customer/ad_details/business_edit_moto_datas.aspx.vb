...
Public Class business_edit_moto_datas
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            setValue(myBike, myInfo, Session("noticeid"), Session("detailid"))
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("package3_list_moto_term_new.aspx?noticeid=" & Session("noticeid"))
        Else
            Response.Redirect("business_moto_detail.aspx?cust_id=" & Session("cust_id") & "&curPos=" & Session("curPos") & "&carid=" & Session("carid") & "&detailid=" & Session("detailid") & "&noticeid=" & Session("noticeid"))
        End If
        Session("noticeid") = ""
        Session("carid") = ""
        Session("detailid") = ""
