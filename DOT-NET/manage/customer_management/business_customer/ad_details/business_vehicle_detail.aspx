<%@ Page CodeBehind="business_vehicle_detail.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.business_vehicle_detail" %>
	...
	<body>
        ...
        // -->
					...
					<td class="bdubbelborder" noWrap>
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td noWrap width="202"><span class="Stil16"><u>Ad Detail of Vehicle Ad:</u></span></td>
								<td width="10" rowSpan="2"><IMG height="1" src="../../../pics/objects/no.gif" width="10"></td>
							...
							<tr>
								...
								<td vAlign="top"><asp:label id="sta_com" runat="server"></asp:label></td>
							</tr>
							<tr>
			...
			<table class="standard_font" cellSpacing="0" cellPadding="0" width="585" align="center"
				border="0">
				<tr bgColor="#d9d9ff">
					<td bgColor="#d9d9ff"><asp:label id="numUp" runat="server"></asp:label></td>
				</tr>
				<tr>
					<td height="15"></td>
				</tr>
			...
			<table class="standard_font" cellSpacing="1" cellPadding="3" width="585" align="center"
				...
				<tr>
					<td bgColor="#d9d9ff">
						<div align="center"><strong><asp:label id="brand" runat="server"></asp:label></strong></div>
					</td>
				</tr>
				<tr>
					<td height="15"></td>
						...
						<table cellSpacing="0" cellPadding="0" width="285" border="0">
							<tr>
								<td><!--<table width="100%" border="0" cellspacing="1" cellpadding="3">
									<tr>
										<td colspan="2" bgcolor="#d9d9ff"><strong>Vehicle Datas </strong>
										</td>
									</tr>
									<tr>
										<td width="50%" bgcolor="#f4f4f4">&nbsp;</td>
										<td width="50%" bgcolor="#e6e6e6">&nbsp;</td>
									</tr>
									<tr>
										<td width="50%" bgcolor="#f4f4f4">&nbsp;</td>
										<td width="50%" bgcolor="#e6e6e6">&nbsp;</td>
									...
									<tr>
										<td colspan="2" bgcolor="#d9d9ff"><strong>Equipment</strong></td>
									</tr>
									<tr>
										<td height="100" colspan="2" bgcolor="#f4f4f4">&nbsp;</td>
									</tr>
									<tr>
										<td colspan="2" bgcolor="#d9d9ff"><strong>More Information </strong>
										</td>
									</tr>
									<tr>
										<td height="100" colspan="2" bgcolor="#f4f4f4">&nbsp;</td>
									...
									<table class="Font_black_LH_17px" cellSpacing="0" cellPadding="0" width="100%" background="../../../images/table/dtl_vehicle.gif"
										border="0">
										<tr>
											<td width="292" colSpan="5" height="3"></td>
										</tr>
										<tr>
											<td width="1%"></td>
										...
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										</tr>
										<tr>
											<td></td>
											<td vAlign="top">
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="colors" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td width="2"></td>
										</tr>
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="numdoor" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td width="2"></td>
										</tr>
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="numseat" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td width="2"></td>
										</tr>
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="fuelconsume" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td width="2"></td>
										</tr>
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="fueltank" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td width="2"></td>
										</tr>
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="accident" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td width="2"></td>
										</tr>
										<tr>
											<td width="292" colSpan="5"><IMG height="3" src="../../../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											<td width="292" bgColor="#d9d9ff" colSpan="5"><strong>Equipment</strong></td>
										</tr>
										<tr>
											<td width="292" bgColor="#f4f4f4" colSpan="5" height="100"><asp:label id="accessory" runat="server" CssClass="Font_black_LH_17px" Width="240px" Height="70px"></asp:label></td>
										</tr>
										<tr>
											<td width="292" bgColor="#d9d9ff" colSpan="5"><strong>More Information </strong>
											</td>
										</tr>
										<tr>
											<td width="292" bgColor="#f4f4f4" colSpan="5" height="100"><asp:label id="description" runat="server" CssClass="Font_black_LH_17px" Width="232px" Height="70px"></asp:label></td>
										</tr>
									</table>
								</td>
							</tr>
										...
										<tr>
											...
											<td>
												<table height="45" cellSpacing="1" cellPadding="3" width="60" align="center" border="0">
													<tr>
														<td bgColor="#e6e6e6">
															<div align="center"><asp:image id="Image4" runat="server"></asp:image></div>
														</td>
													</tr>
												</table>
											</td>
											<td>
												<table height="45" cellSpacing="1" cellPadding="3" width="60" align="center" border="0">
													<tr>
														<td bgColor="#e6e6e6">
															<div align="center"><asp:image id="Image5" runat="server"></asp:image></div>
														</td>
													</tr>
												</table>
											</td>
								...
								<td>
									<table cellSpacing="1" cellPadding="3" width="100%" border="0">
										...
										<tr bgColor="#f4f4f4">
											...
											<td noWrap width="76%" bgColor="#e6e6e6"><u><asp:hyperlink id="editAd" runat="server">Edit</asp:hyperlink></u></td>
										</tr>
										<tr bgColor="#f4f4f4">
											<td noWrap>
												<div align="center"><IMG height="16" src="../../../pics/icons/change_internal_status_16x16.gif" width="16"></div>
											</td>
											<td noWrap bgColor="#e6e6e6"><asp:hyperlink id="show_ad" runat="server" ForeColor="Black" Font-Underline="True">Change int. Status</asp:hyperlink><FONT face="Tahoma">&nbsp;</FONT>
												<asp:label id="st" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
										</tr>
										<tr bgColor="#f4f4f4">
											<td noWrap>
												<div align="center"><IMG height="16" src="../../../pics/icons/delete_16x16.gif" width="16"></div>
											</td>
											<td noWrap bgColor="#e6e6e6"><u><asp:hyperlink id="del_ad" runat="server" ForeColor="Black" Font-Underline="True">Delete</asp:hyperlink></u></td>
										</tr>
										<tr bgColor="#f4f4f4">
			...
			<table class="standard_font" cellSpacing="0" cellPadding="0" width="585" align="center"
				...
				<tr bgColor="#d9d9ff">
					<td width="51%"><asp:label id="numDown" runat="server"></asp:label></td>
				</tr>
			</table>
			<table class="Bborder" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
