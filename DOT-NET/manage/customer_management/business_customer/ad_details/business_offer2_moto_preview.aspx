<%@ Page CodeBehind="business_offer2_moto_preview.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.business_offer2_moto_preview" %>
								...
								<td>
									<table class="H1_white" height="21" cellSpacing="0" cellPadding="0" width="693" background="../../../images/header/h_b_693+ar.gif"
										...
										<tr>
											<td width="25"></td>
											<td width="526">
												<asp:Label id="motoBrand" runat="server" ForeColor="Transparent" CssClass="H1_white"></asp:Label></td>
