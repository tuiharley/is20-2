Public Class business_prolong1_term
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            Dim myInv As invoice
            Dim myNotice As noticeS
            myInv = InvoiceDB.getInvoiceInfo(Request.QueryString("invoiceid"))
            myNotice = NoticeDB.getNoticesInfoD(myInv.noticeid)

            listPackage(myInv.packageid, myNotice.category, 2)
            Session("packageid") = myInv.packageid
            Session("noticeid") = myInv.noticeid
            Session("invoiceid") = myInv.id
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        Response.Redirect("business_prolong_package.aspx?cust_id=" & cust_id & "&noticeid=" & noticeid)
    End Sub

    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        Response.Redirect("business_prolong2_conclusion.aspx?rdNewPack=" & Request.Form("rdNewPack"))
    End Sub
End Class
