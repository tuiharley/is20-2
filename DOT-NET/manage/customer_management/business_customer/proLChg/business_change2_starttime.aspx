<%@ Page CodeBehind="business_change2_starttime.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.business_change2_starttime" %>
...
function goNext(){
		...
		if(newPack!=-1){
			manage.business_change2_starttime.setStartDate(newPack,urlBack);	
		}
		
	}
	function urlBack(response){
	var url="business_change3_conclusion.aspx";
		if(response.value==1){
							...
							<tr>
								<td>
									<table border="0" align="left" cellpadding="0" cellspacing="0">
										<tr>
											<td><asp:button class="button" id="back1" onmouseover="document.all.back1.className='buttonover'"
													style="CURSOR: hand" onmouseout="document.all.back1.className='button'" runat="server" CausesValidation="False"
													Text="ย้อนกลับ" name="back1"></asp:button></td>
