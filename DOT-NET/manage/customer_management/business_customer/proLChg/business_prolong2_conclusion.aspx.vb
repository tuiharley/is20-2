...
Public Class business_prolong2_conclusion
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            UpdInv(Session("invoiceid"), packageid, maxdate, price2)
    ...
    '    Return ans
    'End Function
    Private Sub UpdInv(ByVal invoiceid As Integer, ByVal packageid As Integer, ByVal startDate As DateTime, ByVal price As Double)
        Dim myInvoice As invoice

        myInvoice.id = invoiceid
        myInvoice.packageid = packageid
        myInvoice.week = PackageDB.getPackageWeek(packageid)
        myInvoice.price = price
        myInvoice.startDate = startDate

        InvoiceDB.updateProlongChg(myInvoice)
