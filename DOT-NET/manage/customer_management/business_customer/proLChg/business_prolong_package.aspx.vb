Public Class business_prolong_package
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents ProLg As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        showInfo(cust_id)
        showProlong(cust_id, noticeid)


        AjaxPro.Utility.RegisterTypeForAjax(GetType(business_prolong_package))
    End Sub
    ...
    End Sub
    Private Sub showProlong(ByVal cust_id As Integer, ByVal noticeid As Integer)
        Dim myTxt As String
        ...
        invoices = InvoiceDB.getProlongInvoices(cust_id, noticeid, 2)
        ...
        Else
            tmpTxt = "disabled"
        End If
        myTxt = myTxt & "<input name='ChgTerm' type='button' " & tmpTxt & " onClick='goTerm(" & invoices.id & "," & cust_id & ");' class='standard_font' value='Change Term'> <input name='del' id='del' type='button' onClick='doDel(" & invoices.id & "," & tmpPayId.Id & ");' class='standard_font' value='Delete'>"
        myTxt = myTxt & "</div>"
        myTxt = myTxt & "</td>"
        myTxt = myTxt & "</tr>"
    ...
    Public Function delPrLg(ByVal invoiceid As Integer, ByVal tmppayid As Integer) As Integer
        ...
        invoice = InvoiceDB.getInvoiceInfo(invoiceid)
        DeleteProlong(invoice.noticeid, invoiceid, tmppayid)
