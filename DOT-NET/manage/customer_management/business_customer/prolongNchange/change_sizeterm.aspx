<%@ Page CodeBehind="change_sizeterm.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.change_sizeterm" %>
...
// my Script ----//
	...
	function goNext(){
		...
		if(newPack!=-1){
			manage.change_sizeterm.setNewPackage(newPack,urlBack);	
		}else{
