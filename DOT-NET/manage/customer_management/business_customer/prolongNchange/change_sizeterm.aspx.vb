...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            myNotice = NoticeDB.getNoticesInfoD(Request.QueryString("noticeid"))
            Session("noticeid") = myNotice.id

            Session("packageid") = myNotice.pacakgeId
            Session("cat") = myNotice.category
            Session("Ccust_id") = myNotice.memberId
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(change_sizeterm))
    End Sub
