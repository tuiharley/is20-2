...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents back_but As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            Else ' --------------  notice ยังเป็น Offline อยู่
                ...
                Response.Redirect("change_conclusion.aspx")
            End If

        End If

        AjaxPro.Utility.RegisterTypeForAjax(GetType(change_starttime))
    End Sub
    ...
    Private Sub back_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles back_but.Click
        Dim noticeid As Integer = Session("noticeid")
        Session.Remove("noticeid")

        Response.Redirect("change_sizeterm.aspx?noticeid=" & noticeid)
    End Sub
End Class
