<%@ Control Language="vb" AutoEventWireup="false" Codebehind="private_model_moto_list_puadmin.ascx.vb" Inherits="manage.private_model_moto_list_puadmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
