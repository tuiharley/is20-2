...
Public Class private_edit1_part_datas
...
#End Region
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("private_part_detail.aspx?cust_id=" & cust_id & "&noticeid=" & notice_id & "&curPos=" & curPos)
        Else
            Response.Redirect("detail_part.aspx?noticeid=" & Session("notice_id"))
        End If
