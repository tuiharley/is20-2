...
Public Class private_edit1_moto_datas
...
#End Region
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            ...
            Response.Redirect("private_moto_detail.aspx?cust_id=" & cust_id & "&noticeid=" & notice_id & "&curPos=" & curPos)
        Else
            Response.Redirect("detail_bike.aspx?noticeid=" & Session("notice_id"))
        End If
