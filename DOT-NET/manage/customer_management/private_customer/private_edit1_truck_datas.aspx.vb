...
Public Class private_edit1_truck_datas
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            myTruck = TruckDB.getTruck(carid)

            setValue(myTruck, myInfo)
    ...
    Private Sub setValue(ByVal myTruck As TruckSt, ByRef myInfo As A_Customer)
        Dim year As Array
        Dim lastCheck As Array
        year = Split(myTruck.Year, "/")
        lastCheck = Split(myTruck.LastCheck, "/")

        'Brands.Value = BrandDB.getBrandName(myTruck.Brand)
        'Model.Value = ModelDB.getModelName(myTruck.Model)
        ...
        ' submodel.Text = myTruck.SubModel
        ...
        Else
            Image1.ImageUrl = "/userData/" & myInfo.username & "/" & NoticeDB.getImgPath(myInfo.id, myTruck.id, 3) & "/" & myTruck.Image1
        End If

        If (myTruck.Image2 = "") Then
            Image2.ImageUrl = "../../images/objects/no_image_80x60.gif"
        Else
            Image2.ImageUrl = "/userData/" & myInfo.username & "/" & NoticeDB.getImgPath(myInfo.id, myTruck.id, 3) & "/" & myTruck.Image2
        End If

        If (myTruck.Image3 = "") Then
            Image3.ImageUrl = "../../images/objects/no_image_80x60.gif"
        Else
            Image3.ImageUrl = "/userData/" & myInfo.username & "/" & NoticeDB.getImgPath(myInfo.id, myTruck.id, 3) & "/" & myTruck.Image3
        End If

        If (myTruck.Image4 = "") Then
            Image4.ImageUrl = "../../images/objects/no_image_80x60.gif"
        Else
            Image4.ImageUrl = "/userData/" & myInfo.username & "/" & NoticeDB.getImgPath(myInfo.id, myTruck.id, 3) & "/" & myTruck.Image4
        End If

        If (myTruck.Image5 = "") Then
            Image5.ImageUrl = "../../images/objects/no_image_80x60.gif"
        Else
            Image5.ImageUrl = "/userData/" & myInfo.username & "/" & NoticeDB.getImgPath(myInfo.id, myTruck.id, 3) & "/" & myTruck.Image5
        End If
    ...
    Private Sub saveValue()
        Dim editedCar As TruckSt
        Dim oldCar As TruckSt
    ...
    Private Sub cancel_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cancel_but.Click
        ...
        If Session("from") <> "view" Then
            Response.Redirect("private_truck_detail.aspx?cust_id=" & cust_id & "&noticeid=" & notice_id & "&curPos=" & curPos)
        Else
            Response.Redirect("detail_truck.aspx?noticeid=" & Session("notice_id"))
        End If

        'Response.Redirect("detail_truck.aspx?notice_id=" & Session("notice_id"))
    End Sub
