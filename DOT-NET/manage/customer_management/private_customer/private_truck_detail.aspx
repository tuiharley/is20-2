<%@ Page CodeBehind="private_truck_detail.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.private_truck_detail" %>
	...
	<body>
        ...
        // -->
			...
			<table class="Bborder" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr>
					<td vAlign="top" noWrap>
						<table class="small_standard_font" cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td><IMG height="7" src="../../pics/objects2/arrow-filled.gif" width="8"> <A href="private_personal_data.htm" target="_blank">
										Personal Datas</A>&nbsp;&nbsp;</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td noWrap colSpan="2"><IMG height="16" src="../../pics/icons/customer_16x16.gif" width="16" align="absMiddle">&nbsp;
						<span class="standard_font">
							<strong>
								<asp:label id="custName" runat="server"></asp:label></strong></span><strong><br>
							<IMG height="16" src="../../pics/icons/email_16x16.gif" width="16" align="absMiddle">&nbsp;
					...
					<td class="bdubbelborder" noWrap>
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td noWrap width="202"><span class="Stil16"><u>Ad Detail of&nbsp;Truck Ad:</u></span></td>
								<td width="10" rowSpan="2"><IMG height="1" src="../../pics/objects/no.gif" width="10"></td>
								...
								<td><!--<table width="100%" border="0" cellspacing="1" cellpadding="3">
									...
									<table class="Font_black_LH_17px" cellSpacing="0" cellPadding="0" width="100%" background="../images/table/dtl_vehicle.gif"
										...
										<tr>
											...
											<td></td>
											<td><FONT face="Tahoma"><asp:label id="yearcar" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
											<td></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><FONT face="Tahoma"><asp:label id="miles" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
											<td></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="Prao" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><FONT face="Tahoma"><asp:label id="praoDrive" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
											<td></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><FONT face="Tahoma"><asp:label id="loadTruck" runat="server" CssClass="Font_black_LH_17px"></asp:label></FONT></td>
											<td></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td></td>
											<td><asp:label id="weightTruck" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
										...
										<tr>
											...
											<td height="16"></td>
											<td height="16"><asp:label id="insurrunce" runat="server" CssClass="Font_black_LH_17px"></asp:label></td>
											<td height="16"></td>
										</tr>
										<tr>
											<td colSpan="5"><IMG height="3" src="../images/dividers/dtl_vehicle.gif"></td>
