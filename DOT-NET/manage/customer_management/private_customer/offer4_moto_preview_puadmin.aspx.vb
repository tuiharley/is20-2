Public Class offer4_moto_preview_puadmin
...
#End Region
    ...
    Private Sub initLink()
        editMotoData.NavigateUrl = "offer1_moto_datas_puadmin.aspx?edit=edit&package_id=" & Session("package_id")
        'editContact.NavigateUrl = "offer3_contact_datas_puadmin.aspx?from=offer4_moto_preview_puadmin"
    End Sub
