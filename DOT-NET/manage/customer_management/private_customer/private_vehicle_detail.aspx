<%@ Page CodeBehind="private_vehicle_detail.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.private_vehicle_detail" %>
									...
									<table cellSpacing="1" cellPadding="3" width="100%" border="0">
										...
										<tr bgColor="#f4f4f4">
											...
											<td noWrap bgColor="#e6e6e6">
												<asp:HyperLink id="show_ad" runat="server" ForeColor="Black" Font-Underline="True">Change int. Status</asp:HyperLink><FONT face="Tahoma">&nbsp;</FONT>
										...
										<tr bgColor="#f4f4f4">
											...
											<td noWrap bgColor="#e6e6e6"><u>
													<asp:HyperLink id="del_ad" runat="server" Font-Underline="True" ForeColor="Black">Delete</asp:HyperLink></u></td>
										</tr>
										<tr bgColor="#f4f4f4">
