...
#End Region
    ...
    Private Sub showTmpPay(ByRef tmpPayment_list As Array)
        ...
        For i = 1 To tmpPayment_list.Length - 1
            ...
            tmpPay.Text = tmpPay.Text & "             <td><table width=""693"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../../images/table/pay_conf_g.gif"" class=""Font_black_LH_15px"">"
            tmpPay.Text = tmpPay.Text & "           <tr>"
            ...
            tmpPay.Text = tmpPay.Text & "             <td width=""82""><div align=""center"">" & tmpPayment_list(i).PayDate & "</div></td>"
            tmpPay.Text = tmpPay.Text & "             <td width=""5""></td>"
