...
Public Class Utilities
    ...
    Public Shared Function getFileName(ByVal Fileupload As Object) As String
        ...
        End If
    End Function
    Public Shared Function UploadFile(ByVal Fileupload As Object, ByVal temppath As String, ByVal FileName As String) As String
        'Dim FileFullName As String = Fileupload.PostedFile.FileName
        ...
        Return "'" & FileName & "'"
    End Function
    Public Shared Function UploadFile2(ByVal Fileupload As Object, ByVal temppath As String) As String
        Dim FileFullName As String = Fileupload.PostedFile.FileName
    ...
    Public Shared Function getDateName(ByVal date_id As Integer) As String
        ...
        Return myDate
    End Function
    Public Shared Function getCatName(ByVal cat As Integer) As String
        Dim myDate As String
