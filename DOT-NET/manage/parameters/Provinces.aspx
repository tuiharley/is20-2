...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Provinces.aspx.vb" Inherits="manage.Provinces" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" style="Z-INDEX: 105; LEFT: 424px; WIDTH: 392px; POSITION: absolute; TOP: 160px; HEIGHT: 104px"
				...
				<TR>
					<TD style="WIDTH: 73px"><FONT face="Tahoma">จังหวัด</FONT></TD>
					<TD><asp:textbox id="txtprovince" runat="server" Height="24px" Width="176px"></asp:textbox></TD>
				</TR>
			</TABLE>
			<asp:datagrid id="Datagrid1" runat="server" Width="360" OnPageIndexChanged="MyDataGrid_Paging"
				...
				OnCancelCommand="CancelBook" OnEditCommand="EditBook" DataKeyField="Province">
				...
				<Columns>
					...
					<asp:BoundColumn HeaderText="จังหวัด" DataField="Province_Name" />
				</Columns>
