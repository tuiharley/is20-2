...
#End Region
    ...
    Private Sub Bind()
        strsql = "SELECT Color , Color_Name from Color"
        da = New OleDbDataAdapter(strsql, myconn)
        da.Fill(ds, "Color")
        Datagrid1.DataSource = ds.Tables("Color")
        Datagrid1.DataBind()
        myconn.Close()
    End Sub
    ...
    Public Sub UpdateBook(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        strsql = "Update Color Set Color_Name = '" & title.Text & "' Where Color = " & Datagrid1.DataKeys.Item(E.Item.ItemIndex)
    ...
    Private Function getNewColor() As Integer
        ...
        strsql = "SELECT Max(Color) as Color FROM Color"
        ...
        If BUZ_ID.Read Then
            If Not BUZ_ID.IsDBNull(0) Then
                businessid = BUZ_ID.Item("Color") + 1
            Else
                businessid = 1
            End If
        End If
    ...
    Private Sub AddBTN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddBTN.Click
        If IsPostBack Then
            If txtcolor.Text <> "" Then
                ...
                strsql = "Insert into Color Values(" & getNewColor() & ",'" & txtcolor.Text & "') "
                mycommand = New OleDbCommand(strsql, myconn)
                myconn.Open()
                mycommand.ExecuteNonQuery()
                myconn.Close()
