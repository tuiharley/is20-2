...
#End Region
    ...
    Private Sub Bind()
        strsql = "SELECT Bike_Accessory.* FROM Bike_Accessory"
        da = New OleDbDataAdapter(strsql, myconn)
        da.Fill(ds, "Bike_Accessory")
        Datagrid1.DataSource = ds.Tables("Bike_Accessory")
        Datagrid1.DataBind()
        myconn.Close()
    End Sub
    ...
    Public Sub UpdateBook(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        strsql = "Update Bike_Accessory Set Accessory_Name = '" & title.Text & "' Where Accessory = " & Datagrid1.DataKeys.Item(E.Item.ItemIndex)
    ...
    Private Function getNewAccessory() As Integer
        ...
        strsql = "SELECT Max(Accessory) as Accessory FROM Bike_Accessory"
    ...
    Private Sub AddBTN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddBTN.Click
        If IsPostBack Then
            If txt_name.Text <> "" Then
                ...
                strsql = "Insert into Bike_Accessory Values(" & getNewAccessory() & ",'" & txt_name.Text & "') "
                mycommand = New OleDbCommand(strsql, myconn)
                myconn.Open()
                mycommand.ExecuteNonQuery()
                myconn.Close()
