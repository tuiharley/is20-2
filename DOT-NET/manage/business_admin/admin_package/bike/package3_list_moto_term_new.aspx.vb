...
Public Class package3_list_moto_term_new
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(package3_list_moto_term_new))
        Response.Expires = 0
    ...
    Private Function showEmpty(ByVal myNoticeDealer As numNoticeDealer, ByVal noticeStatus As Integer) As String
        ...
        Else
            sql = sql & "<a href='package5_offer1_moto_datas.aspx?noticeid=" & myNoticeDealer.noticeId & "' class='A80'>"
        End If
        sql = sql & "&#3621;&#3591;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</a>"
        sql = sql & "</div>"
        sql = sql & "</td>"
    ...
    Public Function showTerm(ByVal cat As Integer) As String
        ...
        sql = sql & " 											<td width=""526""><strong>รายการรถจักรยานยนต์:"
    ...
    Private Function showButton1(ByVal myNoticeDealer As numNoticeDealer) As String
        ...
        If myNoticeDealer.rowNum < myNoticeDealer.totalNum And myNoticeDealer.status <> 5 Then
            sql = sql & "<A class=A80 href='package5_offer1_moto_datas.aspx?noticeid=" & myNoticeDealer.noticeId & "' >&#3621;&#3591;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</A>"
        Else
    ...
    Private Function showCars(ByVal myDetail As noticeDetail, ByVal n As Integer) As String
        ...
        myCar = BikeDB.getBike(myDetail.DataId)
        ' =====================  Start ==========================
        sql = sql & "<table cellSpacing=0 cellPadding=0 width=693 border=0 >"
        sql = sql & "<tr>"
        ...
        sql = sql & "                       <td width=83>"
        sql = sql & "                         <div align=center>"
        sql = sql & CarTypeDB.getStatusName(myCar.Type, 2)
        sql = sql & "</div></td>"
        sql = sql & "                       <td width=5 "
        sql = sql & "                       background=../../../images/separator/g_5.gif> "
        sql = sql & "                       </td>"
        ...
        sql = sql & "                       <td width=41>"
        '=========== small pic ==========================
        sql = sql & "                         <div align=center><A  href='package4_detail_bike.aspx?carid=" & myDetail.DataId & "&detailid=" & myDetail.id & "&noticeid=" & myDetail.NoticeId & "&curData=" & n & "' >"
        ...
        sql = sql & "                       background=../../../images/separator/g_5.gif> "
        sql = sql & "                       </td>"
        sql = sql & "                       <td width=60><A class=A60 href=""package4_edit_moto_datas.aspx?from=list&car=" & myDetail.DataId & "&detailid=" & myDetail.id & "&notice_id=" & myDetail.NoticeId & "&curData=" & n & """ >&#3649;&#3585;&#3657;&#3652;&#3586;</A></td>"
        sql = sql & "                       <td width=3></td></tr>"
        sql = sql & "                     <tr>"
        ...
        If myCar.Image1 <> "" Then
            sql = sql & "/userData/" & CustomerDB.getUserName(Session("cust_id")) & "/" & NoticeDB.getImgPath(Session("cust_id"), myCar.id, 2) & "/" & myCar.Image1
        Else
   ...
   Public Function saveRemark(ByVal carid As Integer, ByVal remark As String) As String
        ...
        If remark <> "ข้อความของคุณ..." Then
            BikeDB.editBikeRemark(carid, remark)
            result = "ok"
        Else
            result = "not"
        End If
   ...
   Public Function setDetailDelete(ByVal detailid As Integer) As String
    ...
    Public Function showB1() As String
        ...
        Dim myNoticeDealer As numNoticeDealer
        myNoticeDealer = NoticeDB.countDealerNotices(Session("cust_id"), 2)
