...
Imports System.IO
Public Class package5_offer2_truck_preview
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Session("pagename") = "package5_offer2_truck_preview.aspx"
    ...
    Private Sub initLink()
        editTruckData.NavigateUrl = "package5_offer1_truck_datas.aspx?edit=edit&noticeid=" & Session("noticeid")
    ...
    Private Sub next_page_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles next_page.Click
        saveTruckDatabase(Session("noticeid"))
        clearSession()
        Response.Redirect("../../startpage/startpage_example_with_package.aspx?cust_id=" & Session("cust_id"))
    End Sub
    Private Sub saveTruckDatabase(ByVal noticeid As Integer)
