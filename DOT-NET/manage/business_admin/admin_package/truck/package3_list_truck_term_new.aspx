<%@ Page CodeBehind="package3_list_truck_term_new.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.package3_list_truck_term_new" %>
		...
		<form id="form1" name="form1" runat="server">
			...
			<script language="javascript">
					...
					function changeMainPic(cat){
						...
						manage.package3_list_truck_term_new.showTerm(cat,UrlBack);	
					...
					function setModel(brand){
						//manage.showBrands.showModels(brand,1,showModel);
					...
					function editRemark(carid,remark){
						manage.package3_list_truck_term_new.saveRemark(carid,remark,urlBack);
					}
					...
					function showCar(detailid){
						manage.package3_list_truck_term_new.setDetailShow(detailid,delAdv);
					}
					...
					function deleteDetail(){
						...
						if(maxCheckB==null){
								if(checkB.checked){
									manage.package3_list_truck_term_new.setDetailDelete(checkB.value);
								}
						}else{
							for(var i=0;i<maxCheckB;i++){
								if(checkB[i].checked){
								  manage.package3_list_truck_term_new.setDetailDelete(checkB[i].value);
					...
					function showNewList(response){
						if(response=="ok"){
							manage.package3_list_truck_term_new.showC(newList);
							manage.package3_list_truck_term_new.showB1(newButton1);
							manage.package3_list_truck_term_new.showB2(newButton2);
						}
					}
					...
					function doSearch(){
						...
						//alert(orderBy.value);
						manage.package3_list_truck_term_new.showSelectedC(brand.value,status.value,model.value,yearst.value,yearend.value,carType.value,pricest.value,priceend.value,orderBy.value,showSearchList);
						manage.package3_list_truck_term_new.selectedNum(1,newNum1);
					}
					...
					function goPage(pageno){
						manage.package3_list_truck_term_new.showSelectedPage(pageno,showSearchList);
						manage.package3_list_truck_term_new.selectedNum(pageno,newNum1);
					}
			</script>
		</form>
	</body>
