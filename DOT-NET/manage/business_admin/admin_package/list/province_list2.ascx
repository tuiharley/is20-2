<%@ Control Language="vb" AutoEventWireup="false" Codebehind="province_list2.ascx.vb" Inherits="manage.adminP_province_list2" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
