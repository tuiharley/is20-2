...
Public Class package3_list_part_term_new
...
#End Region
    ...
    Const category As Integer = 4

    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Put user code to initialize the page here
        AjaxPro.Utility.RegisterTypeForAjax(GetType(showBrands))
        AjaxPro.Utility.RegisterTypeForAjax(GetType(package3_list_part_term_new))
        Response.Expires = 0
    ...
    Private Function showEmpty(ByVal myNoticeDealer As numNoticeDealer, ByVal noticeStatus As Integer) As String
        ...
        Else
            sql = sql & "<a href='package5_offer1_part_datas.aspx?noticeid=" & myNoticeDealer.noticeId & "' class='A80'>"
        End If
        sql = sql & "&#3621;&#3591;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</a>"
        sql = sql & "</div>"
        sql = sql & "</td>"
    ...
    Public Function showTerm(ByVal cat As Integer) As String
        ...
        sql = sql & " 											<td width=""526""><strong>รายการสินค้าและอะไหล่:"
        ...
        If myNoticeDealer.rowNum > 0 Then ' ===========ในกรณีที่มีการลงประกาศไว้แล้ว ===============
            ...
            sql = sql & " <select class='Font_black' style='WIDTH: 295px' name='cate' id='cate' onChange='doPartType(this.value)'> "
            sql = sql & "   <option value='0' >แสดงทุกหมวดหมู่อะไหล่</option> "
            sql = sql & " </select>"

            sql = sql & "               </td>"
            sql = sql & "                 <td width=10 rowSpan=2></td>"
            ...
            sql = sql & "                 </td>"
            sql = sql & "                 <td width=5 rowSpan=2></td></tr>"
            sql = sql & "               <tr>"
            sql = sql & "                 <td width=79 height=26></td>"
            sql = sql & "                 <td width=295 height=26>"

            sql = sql & "  <select class='Font_black' style='WIDTH: 294px' name='partType' id='partType'> "
            sql = sql & "   <option  value='0' selected>แสดงทุกประเภทอะไหล่</option> "
            sql = sql & " </select>"
            sql = sql & " </td>"
            sql = sql & "                 <td width=294>"
    ...
    Private Function showButton1(ByVal myNoticeDealer As numNoticeDealer) As String
        ...
        If myNoticeDealer.rowNum < myNoticeDealer.totalNum And myNoticeDealer.status <> 5 Then
            sql = sql & "<A class=A80 href='package5_offer1_part_datas.aspx?noticeid=" & myNoticeDealer.noticeId & "' >&#3621;&#3591;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</A>"
        Else
    ...
    Private Function showList(ByVal myNoticeDealer As numNoticeDealer) As String
        ...
        sql = sql & "         <tr>"
        sql = sql & "<td><table width='693' height='21' border='0' cellpadding='0' cellspacing='0' background='../../../images/header/part_b_li.gif' class='Font_white'>"
        sql = sql & "<tr>"
        sql = sql & "<td width='3'></td>"
        sql = sql & "<td width='20'><div align='center'>X</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='60'><div align='center'>&#3619;&#3627;&#3633;&#3626;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='74'><div align='center'>&#3623;&#3633;&#3609;&#3607;&#3637;&#3656;&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='89'><div align='center'>&#3627;&#3617;&#3623;&#3604;&#3627;&#3617;&#3641;&#3656;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='223'><div align='center'>&#3611;&#3619;&#3632;&#3648;&#3616;&#3607;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='34'><div align='center'>&#3611;&#3637;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='41'><div align='center'>&#3649;&#3626;&#3604;&#3591;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='46'><div align='center'>&#3648;&#3611;&#3636;&#3604;/&#3611;&#3636;&#3604;</div></td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td width='60'><div align='center'>&#3588;&#3635;&#3626;&#3633;&#3656;&#3591;</div></td>"
        sql = sql & "<td width='3'></td>"
        sql = sql & "</tr>"
        sql = sql & "</table></td>"
        sql = sql & "</tr>"
        ...
        sql = sql & "                 ><A class=A_black_NOunderline href=""../car/package2_list.aspx"" >&#3619;&#3634;&#3618;&#3585;&#3634;&#3619;&#3649;&#3614;&#3588;&#3648;&#3585;&#3592;</A></td>"
        sql = sql & "                 <td><IMG height=16 src=""../../../images/objects/sub_navi_blue_s.gif"" width=21 ></td>"
        sql = sql & "                 <td background=../../../images/objects/sub_navi_blue_c.gif "
        sql = sql & "                 ><A class=A_black_NOunderline href=""#"" >&#3619;&#3634;&#3618;&#3585;&#3634;&#3619;&#3650;&#3590;&#3625;&#3603;&#3634;&#3614;&#3636;&#3648;&#3624;&#3625;</A></td>"
        sql = sql & "                 <td><IMG height=16 src=""../../../images/objects/sub_navi_blue_s.gif"" width=21 ></td>"
        sql = sql & "                 <td background=../../../images/objects/sub_navi_blue_c.gif "
        sql = sql & "                 ><A class=A_black_NOunderline href=""#"" >&#3619;&#3634;&#3618;&#3585;&#3634;&#3619;&#3605;&#3635;&#3649;&#3627;&#3609;&#3656;&#3591;&#3591;&#3634;&#3609;</A></td>"
    ...
    Private Function showCars(ByVal myDetail As noticeDetail, ByVal n As Integer) As String
        ...
        myCar = PartsDB.getPart(myDetail.DataId)
        ' =====================  Start ==========================
        sql = sql & "<table cellSpacing=0 cellPadding=0 width=693 border=0 >"
        sql = sql & "<tr>"
        ...
        sql = sql & "<tr>"
        sql = sql & "<td width='3'></td>"
        sql = sql & "<td width='20'><div align='center'>"
        sql = sql & "<input name='noticeDe' id='noticeDe' type='checkbox' class='Font_black' value='" & myDetail.id & "'>"
        sql = sql & "</div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='60'><div align='center'>NDD" & myDetail.id & "</div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='74'><div align='center'>" & myCar.Post.ToString("dd-MM-yyyy") & "</div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='89'><div align='center'>" & CategoryDB.getCategoryName(myCar.Category) & "</div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        Dim pType As String
        pType = PartsTypeDB.getPartTypeName(myCar.Type)
        If myCar.Name <> "" Then
            pType = pType & " - " & myCar.Name
        End If
        sql = sql & "<td width='223'><div align='center'>" & pType & "</div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='34'><div align='center'>1999</div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='41'><div align='center'><a  href='package4_detail_part.aspx?carid=" & myDetail.DataId & "&detailid=" & myDetail.id & "&noticeid=" & myDetail.NoticeId & "&curData=" & n & "'><img src='../../../images/icons/small/detail_16x16.gif' width='16' height='16' border='0' align='texttop'></a></div></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        ...
        sql = sql & "</div></u></td>"
        sql = sql & "<td width='5' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='60'><a href='package4_edit_part_datas.aspx?from=list&car=" & myDetail.DataId & "&detailid=" & myDetail.id & "&notice_id=" & myDetail.NoticeId & "&curData=" & n & "' class='A60'>&#3649;&#3585;&#3657;&#3652;&#3586;</a></td>"
        sql = sql & "<td width='3'></td>"
        sql = sql & "</tr>"
        ...
        sql = sql & "<tr>"
        sql = sql & "<td width='3' rowspan='2'></td>"
        sql = sql & "<td width='20' rowspan='2'></td>"
        sql = sql & "<td width='5' rowspan='2' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='60' rowspan='2'>"

        sql = sql & "      <div align=center><A href='package4_detail_part.aspx?carid=" & myDetail.DataId & "&detailid=" & myDetail.id & "&noticeid=" & myDetail.NoticeId & "&curData=" & n & "' >"
        sql = sql & "<img src='"

        ' ========================= car Pic ==========================
        If myCar.Image <> "" Then
            sql = sql & "/userData/" & CustomerDB.getUserName(Session("cust_id")) & "/" & NoticeDB.getImgPath(Session("cust_id"), myCar.id, 4) & "/" & myCar.Image
        Else
            sql = sql & "../../../images/objects/no_image_60x45.gif"
        End If

        sql = sql & "' width='60' height='45' border='0'></a></div></td>"
        sql = sql & "<td width='5' rowspan='2' background='../../../images/separator/g_5.gif'></td>"
        Dim brandsName As String
        If myCar.Brand = "" Then
            brandsName = myCar.Model
        ElseIf myCar.Model = "" Then
            brandsName = myCar.Brand
        Else
            brandsName = myCar.Brand & "/ " & myCar.Model
        End If
        sql = sql & "<td colspan='7' class='Font_black_bold' valign='bottom'>" & brandsName & "/&#3619;&#3640;&#3656;&#3609;</td>"
        sql = sql & "<td width='5'></td>"
        sql = sql & "<td colspan='3' valign='bottom'><div align='right'>&#3647; " & myCar.Price.ToString("#,###.##") & " </div></td>"
        sql = sql & "<td width='5' rowspan='2' background='../../../images/separator/g_5.gif'></td>"
        sql = sql & "<td width='60'></td>"
        sql = sql & "<td width='3' rowspan='2'></td>"
        sql = sql & "</tr>"
        sql = sql & "<tr>"
        sql = sql & "<td colspan='11' valign='top' class='Padding_T_4px'>"

        ''===============  remark ข้อความ ==========================================
        sql = sql & "                         <input class=Font_black style=""WIDTH: 526px"" type='text' "
        ...
        sql = sql & "</td>"
        sql = sql & "<td width='60' valign='top' class='Padding_T_4px'>"

        '=============== button บันทึก remark ==========================
        sql = sql & "<input class='button60' id='saveRemark" & myCar.id & "' name='saveRemark" & myCar.id & "' "
   ...
   Public Function saveRemark(ByVal carid As Integer, ByVal remark As String) As String
        ...
        If remark <> "ข้อความของคุณ..." Then
            PartsDB.editPartRemark(carid, remark)
            result = "ok"
        Else
            result = "not"
        End If
   ...
   Public Function setDetailDelete(ByVal detailid As Integer) As String
    ...
    Function checkYear(ByVal y1 As Double, ByVal y2 As Double) As String
        ...
        ElseIf y1 <> 0 And y2 = 0 Then
            ...
            year_condition = " And (Part_Year_Ord <= " & y1 & ") "
        ...
        ElseIf y1 = 0 And y2 <> 0 Then
            ...
            Else
                year_condition = " And (Part_Year_Ord <= " & y2 & ") "
        ...
        ElseIf y1 <> 0 And y2 <> 0 Then
            ...
            If (y1 <= y2) Then
                If isMax(y1, 4) Then
                    ...
                    'Session("SearchCond") = Session("SearchCond") & "<= " & y2 & "; "
                Else
                    year_condition = " And (Part_Year_Ord between " & y1 & " and " & y2 & ") "
            ...
            Else
                If isMax(y1, 3) Then
                    '   txt_err.Text = "กรุณาเลือกปีที่จะค้นหาใหม่"
                Else
                    year_condition = " And (Part_Year_Ord between " & y2 & " and " & y1 & ") "
    ...
    Function checkCarType(ByVal car_type As Integer) As String
        ...
        If car_type <> 0 Then
            car_type_condition = " And (Part_Type = " & car_type & ") "
    ...
    Function checkPrice(ByVal p1 As Double, ByVal p2 As Double) As String
        ...
        ElseIf (p1 <> 0) And (p2 = 0) Then
            ...
            If isMax(p1, 2) Then
                price_condition = " And (Part_Price <= " & p1 + 1 & ") "
                'Session("SearchCond") = Session("SearchCond") & "<= ฿" & p1 + 1 & "; "
            Else
                price_condition = " And (Part_Price >= " & p1 & ") "
        ...
        ElseIf (p1 = 0) And (p2 <> 0) Then
            ...
            If isMax(p2, 1) Then
                price_condition = " And (Part_Price >= " & p2 - 1 & ") "
                'Session("SearchCond") = Session("SearchCond") & ">= ฿" & p2 - 1 & "; "
            Else
                price_condition = " And (Part_Price <= " & p2 & ") "
        ...
        ElseIf (p1 <> 0) And (p2 <> 0) Then
            ...
            If p1 < p2 Then
                ...
                Else
                    If isMax(p2, 1) Then
                        ...
                        'Session("SearchCond") = Session("SearchCond") & ">= ฿" & p1 & "; "
                    Else
                        price_condition = " And (Part_Price between " & p1 & " and " & p2 & ") "
            ...
            Else
                If isMax(p2, 1) Then
                    ...
                    'Session("SearchCond") = Session("SearchCond") & ">= ฿" & p2 - 1 & "; "
                Else
                    price_condition = " And (Part_Price between " & p2 & " and " & p1 & ") "
    ...
    Function checkOrderBy(ByVal orderby As String) As String
        ...
        Select Case orderby
            Case "price"
                Order_By_Condition = " ORDER BY Parts.Part_Price"
                KeyOrder_By = "Part_Price"
            Case "year"
                Order_By_Condition = " ORDER BY Parts.Part_Year_Ord DESC"
                KeyOrder_By = "Part_Year_Ord DESC"
            Case "brand"
                Order_By_Condition = " ORDER BY Parts.Part_Brand,Part_Model"
                KeyOrder_By = "Part_Brand"
            Case "post"
                Order_By_Condition = " ORDER BY Parts.Part_Post DESC"
                KeyOrder_By = "Part_Post DESC"
            Case "status"
                Order_By_Condition = " ORDER BY NoticeDetail.Detail_show"
                KeyOrder_By = "Detail_show"
            Case "carType"
                Order_By_Condition = " ORDER BY Parts.Part_Type DESC"
                KeyOrder_By = "Part_Type DESC"
            Case "-"
                Order_By_Condition = "-"
                KeyOrder_By = "-"
    ...
    <AjaxPro.AjaxMethod()> _
    Public Function showSelectedC(ByVal brand As Integer, ByVal status As Integer, ByVal model As String, ByVal yearst As Integer, ByVal yearend As Integer, ByVal orderBy As String) As String
        Dim sql As String
    ...
    Public Function showB1() As String
        ...
        Dim myNoticeDealer As numNoticeDealer
        myNoticeDealer = NoticeDB.countDealerNotices(Session("cust_id"), 4)
