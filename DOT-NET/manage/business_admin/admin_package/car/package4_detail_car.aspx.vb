...
Public Class package4_detail_car
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents carList As System.Web.UI.WebControls.HyperLink
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AjaxPro.Utility.RegisterTypeForAjax(GetType(package4_detail_car))
        Response.Expires = 0
    ...
    Private Sub setLink(ByVal carid As Integer, ByVal noticeid As Integer, ByVal detailid As Integer, ByVal n As Integer)
        edit_ad.NavigateUrl = "package4_edit_car_datas.aspx?from=view&car=" & carid & "&detailid=" & detailid & "&notice_id=" & noticeid & "&curData=" & n
        ...
        carList.NavigateUrl = "package3_list_vehicle_term_new.aspx?noticeid=" & noticeid
        carList.Text = "รายการประกาศ"
    End Sub
    ...
    Private Sub showTopic(ByVal show As Boolean, ByVal b As String, ByVal dPost As DateTime)
        ...
        topic = topic & "<td width='526'><strong>ประกาศรถยนต์: "
    ...
    Private Sub showData(ByVal car_id As Integer, ByVal myinfo As A_Customer, ByVal noticeid As Integer)
        ...
        carBrandLabel(brandTxt, ModelDB.getModelName(myCar.Model), myCar.SubModel, myCar.Price, noticeid, myCar.Post, myinfo.type)
    ...
    End Sub
    Private Sub showPictures(ByRef car As Car, ByRef myinfo As A_Customer, ByVal noticeid As Integer, ByVal detailid As Integer)
    ...
    Private Function showNextPage(ByVal curData As Integer, ByRef allData As Queue, ByVal noticeid As Integer) As String
        ...
        Else
            ...
            x = x & "<td><a href='package4_detail_car.aspx?curData=" & curData - 1 & "&carid=" & carid.DataId & "&noticeid=" & noticeid & "&detailid=" & carid.id & "' class='Font_black'><<</td>"
        End If
    ...
    Public Function openAd() As String
        ...
        myCar = CarDB.getCar(Session("CarID1"))
        brandtxt = BrandDB.getBrandName(myCar.Brand)
