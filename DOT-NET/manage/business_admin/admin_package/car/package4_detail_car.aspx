<%@ Page CodeBehind="package4_detail_car.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="manage.package4_detail_car" %>
...
//-->
	...
	<body onload="MM_preloadImages('../../../images/main_table/offer_01.gif','../../../images/main_table/search_01.gif','../../../images/main_table/special_offer_01.gif','../../../images/main_table/dealer_01.gif','../../../images/main_table/company_01.gif','../../../images/main_table/login_01_3.gif')">
								...
								<td width="693">
									<table class="Font_black" cellSpacing="0" cellPadding="0" border="0">
										<tr>
											...
											<td background="../../../images/objects/sub_navi_blue_c.gif"><A class="A_black_NOunderline" href="package2_list.aspx">รายการแพคเกจ</A></td>
											<td><IMG height="16" src="../../../images/objects/sub_navi_blue_s.gif" width="21"></td>
											<td background="../../../images/objects/sub_navi_blue_c.gif"><A class="A_black_NOunderline" href="#">รายการโฆษณาพิเศษ</A></td>
											<td><IMG height="16" src="../../../images/objects/sub_navi_blue_s.gif" width="21"></td>
											<td background="../../../images/objects/sub_navi_blue_c.gif"><A class="A_black_NOunderline" href="#">รายการตำแหน่งงาน</A></td>
									...
									<table class="Font_black" height="31" cellSpacing="0" cellPadding="0" width="693" background="../../../images/table/f_line.gif"
										...
										<tr>
											...
											<td width="98" height="20">
												<div align="center">
													<div align="center"><asp:hyperlink class="A_black_underline" id="edit_ad" runat="server"></asp:hyperlink></div>
												</div>
											</td>
											<td width="118" height="20">
												<div align="center"><asp:hyperlink class="A_black_underline" id="carList" runat="server"></asp:hyperlink></div>
											</td>
											<td width="84" height="20">
												<div align="center"><asp:hyperlink class="A_black_underline" id="printThis" runat="server"></asp:hyperlink></div>
											</td>
											<td width="84" height="20">
												<div align="center"><font class="fontBl" id="delAd" onmouseover="document.all.delAd.className='fontBl1'" style="CURSOR: hand"
														onclick="deleteAds();" onmouseout="document.all.delAd.className='fontBl'">ลบประกาศ</font>
												</div>
											</td>
		...
		function changeMainPic(picNo,picUrl){
			manage.package4_detail_car.showMainPic(picNo,picUrl,UrlBack);
		}
		function UrlBack(res){
			...
			img1.innerHTML = res.value;
				...
				function getOpenCl(){
					manage.package4_detail_car.getOpTxt(txtBack);
				}
				function openClose(){
					manage.package4_detail_car.openAd(txtBack);
				}
				...
				function deleteAds(){
					...
					manage.package4_detail_car.deleteAdsAJX(urlBack);
					}
				}
				function urlBack(res){
					//var openNotice = document.getElementById("delAd");
					//openNotice.innerHTML = res.value;
					window.location.href="package3_list_vehicle_term_new.aspx?noticeid="+res.value;
				}
