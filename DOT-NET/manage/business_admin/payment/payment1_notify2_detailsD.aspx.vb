...
Public Class payment1_notify2_detailsD
...
#End Region
    ...
    Private Sub showInvoice(ByRef invoice As Array)
        ...
        For i = 1 To invoice.Length - 1
            ...
            If i = 1 Then
                ...
                invoiceList.Text = invoiceList.Text & "             <td width=""5"" rowspan='" & invoice.Length - 1 & "'></td>"
                invoiceList.Text = invoiceList.Text & "             <td width=""111"" height=""26""><div align=""center"">&#3647; " & FormatNumber(invoice(i).price, 2, , , TriState.True) & " </div></td>"
                invoiceList.Text = invoiceList.Text & "             <td width=""5"" rowspan='" & invoice.Length - 1 & "'></td>"
            ...
            Else
                ...
                invoiceList.Text = invoiceList.Text & "             <td height=""26""><div align=""center"">" & myDate.ToString("dd/MM/yyyy") & "</div></td>"
                ...
                invoiceList.Text = invoiceList.Text & "             <td height=""26""><div align=""center"">&#3647;  " & FormatNumber(invoice(i).price, 2, , , TriState.True) & " </div></td>"
    ...
    Private Sub prev_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles prev_but.Click
        Response.Redirect("payment1_notify1_selectionD.aspx")
    End Sub
    ...
    Private Sub pay_but_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pay_but.Click
        ...
        myDate = date_paid.Text
        For i = 0 To Session("payment_list").Length - 1
            If Session("payment_list").GetValue(i) <> "0" Then
                TmpPaymentDb.insertTmpPayment(1, CInt(Session("payment_list").GetValue(i)), CInt(Session("cust_id")), myDate.ToString("yyyy-MM-dd"), timepay, CInt(Request.Form("bank")), InvoiceDB.getPrice(CInt(Session("payment_list").GetValue(i))), remark.Text)
                InvoiceDB.updatePaidInvoice2(CInt(Session("payment_list").GetValue(i)))
            End If
        Next
