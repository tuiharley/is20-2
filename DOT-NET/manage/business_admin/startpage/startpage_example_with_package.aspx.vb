...
#End Region
    ...
    Private Sub showLogo(ByVal cust_id As Integer)
        ...
        If myCust.logo_txt <> "" Then
            'sContents = Server.MapPath("/userData/" & myCust.username & "/logo/" & myCust.logo_txt)
    ...
    Private Sub showPackage(ByVal cust_id As Integer)
        ...
        'packNum = NoticeDB.countPackageNotices(cust_id, "(CategoryType.CategoryType = 3)")
        'If packNum <> 0 Then
        '    txt = txt & "<A class='A_black_underline' href='../admin_job/job1_list.aspx?noticeid=" & myNoticeDealer.noticeId & "'>&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;&#3605;&#3635;&#3649;&#3627;&#3609;&#3656;&#3591;&#3591;&#3634;&#3609;: ("
        '    txt = txt & packNum
        '    txt = txt & ")</A>"
        'Else
        '    txt = txt & "<font class='Font_black'>&#3611;&#3619;&#3632;&#3585;&#3634;&#3624;&#3605;&#3635;&#3649;&#3627;&#3609;&#3656;&#3591;&#3591;&#3634;&#3609;: ("
        '    txt = txt & packNum
        '    txt = txt & ")</font>"
        'End If
        ...
        'txt = txt & "<td width='11' height='21'></td>"
        'txt = txt & "<td height='21'>"
        'txt = txt & "	<div align='center'><span class='Font_red_bold'>3T</span><strong>/</strong><span class='Font_orange_bold'>3T</span><strong>/</strong><span class='Font_green_bold'>3T</span></div>"
        'txt = txt & "</td>"
        'txt = txt & "<td width='21' height='21'></td>"
        'txt = txt & "<td height='21'>+ "
