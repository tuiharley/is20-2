...
<table width="792" border="0" cellspacing="0" cellpadding="0" align=center>
  <tr> 
    <td width="780"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <a href="index.php"><td height="120" background="image/banner.gif"></td></a>
        </tr>
      </table>
...
<?php
    //***** COUNT for Next Page *****
    $PageSize = 20;  //**** จำนวน record ต่อหน้า
    $TotalRec = 0;
    $PageTotal = 1;
    if ($page == "") {
      $page = 1;
    ...
    if($row = mysql_fetch_array($result)){
        $TotalRec = $row['I_COUNT'];
    }
    mysql_free_result($result);

    $i = 0;
    $iNo = 0;
    $PageTotal = pageCount ($TotalRec, $PageSize);
    ...
    while($row = mysql_fetch_array($result)){
      $iNo++;
      $i++;
      if( ($i >= (($page-1) * $PageSize) + 1) && ($i <= (($page) * $PageSize)) ){
?>
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
...
?>
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="25%" class="textnormal1">&nbsp;</td>
                                  <td width="2%" class="textnormal1">&nbsp;</td>
                                  <td width="25%" class="textnormal1">&nbsp;</td>
                                  <td width="12%" align="center" class="textnormal1">&nbsp;</td>
                                  <td width="12%" align="center" class="textnormal1">&nbsp;</td>
                                  <td width="12%" align="center" class="textnormal1">&nbsp;</td>
                                  <td width="12%" align="center" class="textnormal1">
<?php
    if($TotalRec > 0){
?>
หน้า :
<?php
        echo pageNavigate($page, 20, $PageTotal, "all_ringtone.php", "page", "");
    }
?>
                                  </td>
                                </tr>
