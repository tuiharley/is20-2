<?php
  ...
  if($Action == "Load"){
    $i = Send_Content($m_culture, "12", $Content_Code);
    if($i == 1){
        $sqlCmd  = "INSERT INTO send_log(send_date, mobile_no, detail) VALUES(now(), '$m_culture', '12" . $Content_Code . "') ";
...
<?php
    ...
    if( !session_is_registered("m_culture") ){
      ...
      if($iCount > 5){
        ...
        $Msg = "<a href='poly.php?Action=Load&Content_Code=" . $Content_Code . "'>โหลดได้เลยคะ</a>";
      }
    }
    mysql_close();
  }
...
<body background="image/background1.gif" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="playsound('song/12/<?php print $Content_Code; ?>.mid');">
  ...
  <tr> 
    <td width="780"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="30" background="image/bk_02.gif" class="Box4"><b>&nbsp;โพลี</b></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
              ...
              <tr>
                ...
                <table id="AutoNumber5" style="border-collapse: collapse" borderColor="#111111" cellSpacing="1" cellPadding="4" width="100%" bgColor="#ffffff" border="1">
                  ...
                  <tr>
                    ...
                    ::</span></font></b></td>
                    <td width="160"><b>
                    <font face="MS Sans Serif" color="#ff6600" size="1">12<?php print $Content_Code; ?></font></b></td>
                  </tr>
                  <tr>
