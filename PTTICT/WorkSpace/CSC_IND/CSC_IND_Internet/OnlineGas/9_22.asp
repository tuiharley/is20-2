...
<html>
<head>
<title>Current Gas Composition (NPC)</title>
<style type="text/css">
<!--
...
function ShowDoc2 () {
	document.clear 
	timerID = setTimeout(document.location='9_22.asp',300000);	  
}
//  -->
</script>
<base target="bottom">
...
<table BORDER="0" CELLPADDING="2" width="832">
  <tr class="head">
	<td bgcolor="#84762B" align="center" colspan="15" ><strong>GAS COMPOSITION FROM ONLINE GC AT NPC - CURRENT</strong></td>
  </tr>
  ...
  <tr class="body1" bgcolor="#FAF9E7" align="right">
	...
	<td align=center>99.880100</td>
	<td align=center>0.000100</td>
	<td align=center>0.000100</td>
	<td align=center></td>
	<td align=center></td>
	<td align=center></td>
