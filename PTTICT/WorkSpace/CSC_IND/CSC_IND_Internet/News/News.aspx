<%@ Page Language="vb" AutoEventWireup="false" Codebehind="News.aspx.vb" Inherits="CSC_IND_Internet.News" %>
...
<HTML>
	<HEAD>
		...
		<LINK href="../css/csc_ind.css" type="text/css" rel="stylesheet">
			...
			function SelectItem(NewsID){
				//document.location.href="News_Detail.aspx?ServerAction=LOAD&AnnID=" + NewsID;
				window.open("News_Detail.aspx?ServerAction=LOAD&AnnID=" + NewsID,"","directories=no,location=no,menubar=no,scrollbars=yes,toolbar=no,resizable=yes,width=450,height=350");
			}
													...
													<tr>
														<td colSpan="2">
															<TABLE height="30" cellSpacing="0" cellPadding="2" width="100%" border="0">
																<TR>
																	<TD colSpan="2">
																		<asp:Image id="Image1" runat="server" ImageUrl="../images/title_news.jpg"></asp:Image></TD>
																</TR>
															</TABLE>
														</td>
													</tr>
													...
													<tr>
														<td colSpan="2" align="center">
															<TABLE class="criTableItem" cellSpacing="0" cellPadding="1" width="90%" border="0">
																...
																<TR>
																	<TD align="right" width="150">หัวข้อข่าว&nbsp;:&nbsp;</TD>
												...
												<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="99%" border="0">
													...
													<TR>
														<TD colSpan="2" height="16"><asp:panel id="pnlResult" runat="server">
																<asp:datagrid id="dgResult" runat="server" Width="100%" DataKeyField="ANNOUNCE_ID" AutoGenerateColumns="False"
																	...
																	<Columns>
																		...
																		<asp:TemplateColumn HeaderText="ประเภท">
																			...
																			<ItemTemplate>
																				<%# DataBinder.Eval(Container.DataItem,"SOURCE_DESC","") %>																			</ItemTemplate>
																		</asp:TemplateColumn>
																	</Columns>
