...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '    Response.Redirect("..\noRight.aspx")
        'End If
        CountVisitPage(35, "pNews", Request.UserHostAddress)
    ...
    Private Sub LoadData()
        Try
            Session("NewsList") = GetDT(LoadAnnounce(0, FormatSearchText(txtTitle.Text), txtStartDate.Text, txtEndDate.Text, 1, " ANN.DISPLAY_FLAG='Y' "))
